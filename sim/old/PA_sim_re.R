...
system.time(fit4 <- stan(model_code = model_com_pot,
            data = list.data1,
            iter = 1,
            warmup = 0,
            thin = 1,
...
system.time(fit5 <- stan(model_code = model_com_opt,
            data = list.data1,
            iter = 1,
            warmup = 0,
            thin = 1,
...
system.time(fit6 <- stan(model_code = model_com_site,
            data = list.data1,
            iter = 1,
            warmup = 0,
            thin = 1,
...
system.time(fit7 <- stan(model_code = model_dif_pot,
            data = list.data1,
            iter = 1,
            warmup = 0,
            thin = 1,
...
system.time(fit8 <- stan(model_code = model_dif_opt,
            data = list.data1,
            iter = 1,
            warmup = 0,
            thin = 1,
...
system.time(fit9 <- stan(model_code = model_dif_site,
            data = list.data1,
            iter = 1,
            warmup = 0,
            thin = 1,
...
system.time(res4 <- stan(fit = fit4,
           data = list.data1,
           iter = n.iter,
           warmup = n.warm,
           thin = n.thin,
...
system.time(res5 <- stan(fit = fit5,
           data = list.data1,
           iter = n.iter,
           warmup = n.warm,
           thin = n.thin,
...
system.time(res6 <- stan(fit = fit6,
           data = list.data1,
           iter = n.iter,
           warmup = n.warm,
           thin = n.thin,
...
system.time(res7 <- stan(fit = fit7,
           data = list.data1,
           iter = n.iter,
           warmup = n.warm,
           thin = n.thin,
...
system.time(res8 <- stan(fit = fit8,
           data = list.data1,
           iter = n.iter,
           warmup = n.warm,
           thin = n.thin,
...
system.time(res9 <- stan(fit = fit9,
           data = list.data1,
           iter = n.iter,
           warmup = n.warm,
           thin = n.thin,
...
m4 <- data.frame(summary(res4)$summary)
m5 <- data.frame(summary(res5)$summary)
m6 <- data.frame(summary(res6)$summary)
m7 <- data.frame(summary(res7)$summary)
m8 <- data.frame(summary(res8)$summary)
m9 <- data.frame(summary(res9)$summary)

# save.image("~/Dropbox/LES/negative_cov_model2.RData")

save.image("~/Dropbox/LES/PA_sim_re.RData")
