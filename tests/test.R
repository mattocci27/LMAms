library(cmdstanr)
set_cmdstan_path("/opt/cmdstan/cmdstan-2.27.0")
...
if (obs == "obs") {
  ...
  /tmp/RtmpKJ2Mdz/model-1c631ea899d.stan
...
if (obs == "rand") {
  ...
  #            thin = 1,
  #            chains = 1))
  model_cl <- cmdstan_model("model/GL_Aps_LLs.stan",
