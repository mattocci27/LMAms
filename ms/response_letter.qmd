...
Instead of summarizing the results, we now focus on the physiological basis of low LMAs in unclassified species, which includes herbaceous species like grasses and forbs (lines 392-419; see our response to Reviewer 1).
We also more directly state how the LMAm–LMAs partitioning can motivate new research, such as integrating this partitioning with nutrient cycling models (lines 516-528).
