...
%DIF DEL LMAms_SI_old.tex   Mon Aug 19 13:54:28 2024
%DIF ADD LMAms_SI.tex       Mon Aug 19 13:30:19 2024
...
\section{Appendix S4: \DIFdelbegin \DIFdel{Understanding relationships between photosynthetic
capacity and
LMA}\DIFdelend \DIFaddbegin \DIFadd{Variance
partitioning}\DIFaddend }\DIFdelbegin %DIFDELCMD < \label{appendix-s4-understanding-relationships-between-photosynthetic-capacity-and-lma}
%DIFDELCMD < %%%
...
LMAm and LMAs for Panama shade leaves (see Appendix \DIFdelbegin \DIFdel{S5}\DIFdelend \DIFaddbegin \DIFadd{S6}\DIFaddend ). Therefore, we
...
\section{Appendix \DIFdelbegin \DIFdel{S5}\DIFdelend \DIFaddbegin \DIFadd{S6}\DIFaddend : Simulated datasets to study relationships between
photosynthetic capacity and
LMA}\DIFdelbegin %DIFDELCMD < \label{appendix-s5-simulated-datasets-to-study-relationships-between-photosynthetic-capacity-and-lma}
%DIFDELCMD < %%%
...
\DIFdelbegin \section{\DIFdel{Appendix S6: Variance
partitioning}}%DIFAUXCMD
\addtocounter{section}{-1}%DIFAUXCMD
%DIFDELCMD < \label{appendix-s6-variance-partitioning}
%DIFDELCMD < 
...
(Table 1) and Appendix \DIFdelbegin \DIFdel{S5}\DIFdelend \DIFaddbegin \DIFadd{S6}\DIFaddend : \(\alpha_0\) = 1.77, \(\mu_m\) = 56.4,
...
the best Panama model (Table 1) and Appendix \DIFdelbegin \DIFdel{S5}\DIFdelend \DIFaddbegin \DIFadd{S6}\DIFaddend : \(\alpha_0\) = 0.34,
