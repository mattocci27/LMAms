...
%DIF DEL LMAms_SI_old.tex   Tue Mar  5 02:40:45 2024
%DIF ADD LMAms_SI.tex       Mon Mar  4 16:09:35 2024
...
\includegraphics{/home/rstudio/LMAms/figs/coef_sim_gl.png}
...
\includegraphics{/home/rstudio/LMAms/figs/coef_sim_pa.png}
...
%DIFDELCMD < \includegraphics{/home/rstudio/LMAms/figs/box_inter.png}
%DIFDELCMD < %%%
...
\DIFdelbegin %DIFDELCMD < \includegraphics{/home/rstudio/LMAms/figs/box_frac_de.png}
%DIFDELCMD < %%%
...
\DIFdelbegin %DIFDELCMD < \includegraphics{/home/rstudio/LMAms/figs/box_frac_pa.png}
%DIFDELCMD < %%%
...
\includegraphics{/home/rstudio/LMAms/figs/box_inter.png}
...
\DIFdelend \DIFaddbegin \DIFadd{sun and shade}\DIFaddend ) \DIFdelbegin \DIFdel{\(\times\) LMA. Boxplot symbols as in Fig. }\DIFdelend \DIFaddbegin \DIFadd{in Panama. The results shown here
include all leaves in the Panama dataset, whereas Figs. 6- 7 in the main
text only include Panama species for which both sun and shade leaves
were available. Boxplot symbols as in Figs. 6- }\DIFaddend 7. \DIFdelbegin \DIFdel{Groups sharing
the same letters are not significantly different (P }\DIFdelend \DIFaddbegin \DIFadd{Groups sharing the
same letters are not significantly different (P }\DIFaddend \textgreater{} 0.05;
...
\includegraphics{/home/rstudio/LMAms/figs/box_frac_de.png}
...
%DIFDELCMD < \captionsetup{labelsep=none}\includegraphics{/home/rstudio/LMAms/figs/mass_prop_sim.png}
%DIFDELCMD < 
...
\includegraphics{/home/rstudio/LMAms/figs/box_frac_pa.png}
...
and Appendix S3: \(\alpha_0\) = 1.77, \(\mu_m\) = 56.5, \(\mu_s\) =
...
\includegraphics{/home/rstudio/LMAms/figs/mass_prop_sim.png}
...
(Table 1) and Appendix S5: \(\alpha_0\) = 1.77, \(\mu_m\) = 56.5,
\(\mu_s\) = 61.2, and \(\sigma_m\) = 0.83.}}
...
\DIFdelbegin %DIFDELCMD < \includegraphics{/home/rstudio/LMAms/figs/mass_prop_comp.png}
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \centering{

\includegraphics{/home/rstudio/LMAms/figs/mass_prop_comp.png}
...
\(\alpha_m\) = 0.56, \(\alpha_s\) = 0, \(\mu_m\) = 7.6, \(\mu_s\) =
26.7, \(\sigma_m\) = 1.95, and \(\rho\) = -0.47.}}
...
\DIFdelbegin %DIFDELCMD < \includegraphics{/home/rstudio/LMAms/figs/gl_point_np2.png}
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \centering{

\includegraphics{/home/rstudio/LMAms/figs/gl_point_np2.png}
...
\DIFdelbegin %DIFDELCMD < \includegraphics{/home/rstudio/LMAms/figs/pa_point_npc_par.png}
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \centering{

\includegraphics{/home/rstudio/LMAms/figs/pa_point_npc_par.png}
...
\DIFdelbegin %DIFDELCMD < \includegraphics{/home/rstudio/LMAms/figs/ps_point.png}
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \centering{

\includegraphics{/home/rstudio/LMAms/figs/ps_point.png}
