...
%DIF DEL LMAms_SI_old.tex   Wed Aug 21 07:18:02 2024
%DIF ADD LMAms_SI.tex       Wed Aug 21 07:17:45 2024
...
\section{\DIFdelbegin \DIFdel{Supplementary Section 1}\DIFdelend \DIFaddbegin \DIFadd{Appendix S1}\DIFaddend : Prior
information}\DIFdelbegin %DIFDELCMD < \label{supplementary-section-1-prior-information}
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \label{appendix-s1-prior-information}
\DIFaddend 
...
\section{\DIFdelbegin \DIFdel{Supplementary Section 2}\DIFdelend \DIFaddbegin \DIFadd{Appendix S2}\DIFaddend : Model
constraints}\DIFdelbegin %DIFDELCMD < \label{supplementary-section-2-model-constraints}
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \label{appendix-s2-model-constraints}
\DIFaddend 
...
\section{\DIFdelbegin \DIFdel{Supplementary Section 3}\DIFdelend \DIFaddbegin \DIFadd{Appendix S3}\DIFaddend : Model tests with randomized data (including Table
AS1 and Figure
AS1)}\DIFdelbegin %DIFDELCMD < \label{supplementary-section-3-model-tests-with-randomized-data-including-table-as1-and-figure-as1}
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \label{appendix-s3-model-tests-with-randomized-data-including-table-as1-and-figure-as1}
\DIFaddend 
...
did not converge or showed divergent transitions (\DIFdelbegin \DIFdel{Supplementary Section
3}\DIFdelend \DIFaddbegin \DIFadd{Appendix S3}\DIFaddend ),
indicating that models fit to randomized data do not provide reliable
inferences (\citeproc{ref-Betancourt2016}{Betancourt, 2016}).
...
\includegraphics{../figs/coef_sim_gl.png}
...
\includegraphics{../figs/coef_sim_pa.png}

\newpage

\section{\DIFdelbegin \DIFdel{Supplementary Section 4}\DIFdelend \DIFaddbegin \DIFadd{Appendix S4}\DIFaddend : \DIFdelbegin \DIFdel{Understanding relationships between
photosynthetic capacity and
LMA}\DIFdelend \DIFaddbegin \DIFadd{Variance
partitioning}\DIFaddend }\DIFdelbegin %DIFDELCMD < \label{supplementary-section-4-understanding-relationships-between-photosynthetic-capacity-and-lma}
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \label{appendix-s4-variance-partitioning}
...
\[
\DIFadd{\mathrm{Var}(Y = X1 + X2) = \mathrm{Cov}(Y, X1+X2) = \mathrm{Cov}(Y,X1) + \mathrm{Cov}(Y,X2) \qquad(\mathrm{S}4)
}\]
...
\section{\DIFadd{Appendix S5: Understanding relationships between photosynthetic
capacity and
LMA}}\label{appendix-s5-understanding-relationships-between-photosynthetic-capacity-and-lma}
\DIFaddend 
...
\[
A_{\mathrm{area} \, i} = c (LMA_i)^{b}\epsilon_i \qquad(\mathrm{S}\DIFdelbegin \DIFdel{4}\DIFdelend \DIFaddbegin \DIFadd{5}\DIFaddend )
\]
...
(\citeproc{ref-Osnas2018}{Osnas et al., 2018}). Note that applying Eq.
S4 to either mass- or area-normalized \emph{A}\textsubscript{max} yields
...
LMAm and LMAs for Panama shade leaves (see \DIFdelbegin \DIFdel{Supplementary Section 5}\DIFdelend \DIFaddbegin \DIFadd{Appendix S6}\DIFaddend ). Therefore, we
...
\section{\DIFdelbegin \DIFdel{Supplementary Section 5}\DIFdelend \DIFaddbegin \DIFadd{Appendix S6}\DIFaddend : Simulated datasets to study relationships between
photosynthetic capacity and
...
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \label{appendix-s6-simulated-datasets-to-study-relationships-between-photosynthetic-capacity-and-lma}
\DIFaddend 
...
\[
\mathrm{ln}(\mathrm{LMAm}) \sim \mathrm{N}(\mathrm{ln}(\mu_m), \sigma_m) \qquad(\mathrm{S}\DIFdelbegin \DIFdel{5.1}\DIFdelend \DIFaddbegin \DIFadd{6.1}\DIFaddend )
\]

\[
\mathrm{ln}(\mathrm{LMAs}) \sim \mathrm{N}(\mathrm{ln}(\mu_s), \sigma_s) \qquad(\mathrm{S}\DIFdelbegin \DIFdel{5.2}\DIFdelend \DIFaddbegin \DIFadd{6.2}\DIFaddend )
\]
...
\end{matrix},
\boldsymbol{\Sigma}
\right] \qquad(\mathrm{S}\DIFdelbegin \DIFdel{5.3}\DIFdelend \DIFaddbegin \DIFadd{6.3}\DIFaddend )
\]
...
\end{bmatrix} \qquad(\mathrm{S}\DIFdelbegin \DIFdel{5.4}\DIFdelend \DIFaddbegin \DIFadd{6.4}\DIFaddend )
\]
...
\includegraphics{../figs/box_inter.png}
...
\includegraphics{../figs/box_frac_de.png}
...
\includegraphics{../figs/box_frac_pa.png}
...
\includegraphics{../figs/mass_prop_sim.png}
...
(Table 1) and \DIFdelbegin \DIFdel{Supplementary Section 5}\DIFdelend \DIFaddbegin \DIFadd{Appendix S6}\DIFaddend : \(\alpha_0\) = 1.77, \(\mu_m\) = 56.4,
...
\includegraphics{../figs/mass_prop_comp.png}
...
the best Panama model (Table 1) and \DIFdelbegin \DIFdel{Supplementary Section 5}\DIFdelend \DIFaddbegin \DIFadd{Appendix S6}\DIFaddend : \(\alpha_0\) = 0.34,
...
\includegraphics{../figs/pa_point_npc_par.png}
...
\section{\DIFdelbegin \DIFdel{Supplementary Section 7}\DIFdelend \DIFaddbegin \DIFadd{Appendix S7}\DIFaddend : Stan code}\DIFdelbegin %DIFDELCMD < \label{supplementary-section-7-stan-code}
%DIFDELCMD < %%%
