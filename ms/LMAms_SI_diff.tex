...
%DIF DEL LMAms_SI_old.tex   Fri Oct 25 06:26:00 2024
%DIF ADD LMAms_SI.tex       Fri Oct 25 06:25:13 2024
...
\mbox{%DIFAUXCMD
\citeproc{ref-Alvarez2014}{Alvarez et al. 2014}}\hspace{0pt}%DIFAUXCMD
}\DIFaddend ). A prior for \textbf{L}
was specified as \DIFdelbegin \DIFdel{a so-called }\DIFdelend \DIFaddbegin \DIFadd{an }\DIFaddend LKJ distribution with \DIFdelbegin \DIFdel{shape
parameter }\DIFdelend \DIFaddbegin \DIFadd{a shape parameter of }\DIFaddend 2
(\DIFdelbegin \DIFdel{\mbox{%DIFAUXCMD
\citeproc{ref-Lewandowski2009}{Lewandowski et al., 2009}}\hspace{0pt}%DIFAUXCMD
}\DIFdelend \DIFaddbegin \DIFadd{\mbox{%DIFAUXCMD
\citeproc{ref-Lewandowski2009}{Lewandowski et al. 2009}}\hspace{0pt}%DIFAUXCMD
...
\section{\DIFdelbegin \DIFdel{Supplementary Section 7: }\DIFdelend Stan code}\DIFdelbegin %DIFDELCMD < \label{supplementary-section-7-stan-code}
%DIFDELCMD < %%%
...
}\emph{\DIFadd{A}}\DIFadd{\textsubscript{max} is primarily mass-dependent if }\emph{\DIFadd{b}}
\DIFadd{\textgreater{} 0.5, and primarily area-dependent if 0.5 \textgreater{}
}\emph{\DIFadd{b}} \DIFadd{\textgreater{} 0 (\mbox{%DIFAUXCMD
\citeproc{ref-Osnas2018}{Osnas et al. 2018}}\hspace{0pt}%DIFAUXCMD
).
Parameter values are based on the best GLOPNET model (Table 1) and
Supplementary Section 7: \(\alpha_0\) = 1.77, \(\mu_m\) = 56.4,
...
simulated datasets generated from a normal distribution (N) vs.~a
multivariate normal distribution (MVN). Parameter values are based on
the best Panama model (Table 1) and Supplementary Section 7:
\(\alpha_0\) = 0.34, \(\alpha_m\) = 0.56, \(\alpha_s\) = 0, \(\mu_m\) =
7.7, \(\mu_s\) = 26.6, \(\sigma_m\) = 1.95, and \(\rho\) = -0.47.}}
...
Alvarez \DIFdelbegin \DIFdel{, I., Niemi, J., Simpson, M. , 2014. }\DIFdelend \DIFaddbegin \DIFadd{et al. (2014) }\DIFaddend Bayesian inference for a covariance matrix. arXiv
preprint arXiv:1408.4050v2\DIFaddbegin \DIFadd{:}\DIFaddend 1--12.
\url{https://doi.org/10.1214/aos/1176348885}\DIFaddbegin \DIFadd{.
}\DIFaddend 

\bibitem[\citeproctext]{ref-Betancourt2016}
Betancourt \DIFdelbegin \DIFdel{, M., 2016. }\DIFdelend \DIFaddbegin \DIFadd{(2016) }\DIFaddend Diagnosing {Suboptimal Cotangent Disintegrations} in
...
Blonder \DIFdelbegin \DIFdel{, B., Violle, C., Bentley, L.P., Enquist, B.J. , 2011. }\DIFdelend \DIFaddbegin \DIFadd{et al. (2011) }\DIFaddend Venation networks and the origin of the leaf
economics spectrum. Ecology \DIFdelbegin \DIFdel{Letters
...
Gelman \DIFdelbegin \DIFdel{, A., Jakulin, A., Pittau, M.G., Su, Y.S. , 2008. }\DIFdelend \DIFaddbegin \DIFadd{et al. (2008) }\DIFaddend A weakly informative default prior distribution for
logistic and other regression models. Annals of Applied
\DIFdelbegin \DIFdel{Statistics 2, }\DIFdelend \DIFaddbegin \DIFadd{Statistics2:}\DIFaddend 1360--1383. \url{https://doi.org/10.1214/08-AOAS191}\DIFaddbegin \DIFadd{.
}\DIFaddend 
...
Lewandowski \DIFdelbegin \DIFdel{, D., Kurowicka, D., Joe, H. , 2009. }\DIFdelend \DIFaddbegin \DIFadd{et al. (2009) }\DIFaddend Generating random correlation matrices based
on vines and extended onion method. Journal of Multivariate
\DIFdelbegin \DIFdel{Analysis 100, }\DIFdelend \DIFaddbegin \DIFadd{Analysis100:}\DIFaddend 1989--2001.
...
\DIFdel{Osnas, J.L.
D., Lichstein, J.W., Reich, P.B., Pacala, S.W., 2013. Global
...
Shipley \DIFdelbegin \DIFdel{, B., Lechowicz, M.J., Wright, I., Reich, P.B. , 2006. }\DIFdelend \DIFaddbegin \DIFadd{et al. (2006) }\DIFaddend Fundamental trade-offs generating the worldwide
leaf economics spectrum. \DIFdelbegin \DIFdel{Ecology 87,
}\DIFdelend \DIFaddbegin \DIFadd{Ecology87:}\DIFaddend 535--541.
\url{https://doi.org/10.1890/05-1051}\DIFaddbegin \DIFadd{.
}\DIFaddend 

\bibitem[\citeproctext]{ref-Westoby2013}
Westoby \DIFdelbegin \DIFdel{, M., Reich, P.B., Wright, I.J. , 2013. }\DIFdelend \DIFaddbegin \DIFadd{et al. (2013) }\DIFaddend Understanding ecological variation across species:
{Area-based} vs mass-based expression of leaf traits. New
\DIFdelbegin \DIFdel{Phytologist 199, }\DIFdelend \DIFaddbegin \DIFadd{Phytologist199:}\DIFaddend 322--323. \url{https://doi.org/10.1111/nph.12345}\DIFaddbegin \DIFadd{.
}\DIFaddend 

\bibitem[\citeproctext]{ref-Wright2004a}
Wright \DIFdelbegin \DIFdel{, I.J., Reich, P.B., Westoby, M., Ackerly, D.D., Baruch, Z.,
...
Veneklaas, E.J., Villar, R. , 2004. }\DIFdelend \DIFaddbegin \DIFadd{et al. (2004) }\DIFaddend The worldwide leaf economics spectrum.
