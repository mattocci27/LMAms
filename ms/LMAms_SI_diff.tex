...
%DIF DEL LMAms_SI_old.tex   Thu Aug 22 02:34:43 2024
%DIF ADD LMAms_SI.tex       Thu Aug 22 02:34:24 2024
...
\section{\DIFadd{Understanding relationships between photosynthetic capacity and
...
following Osnas et al. (\citeproc{ref-Osnas2018}{2018}):
...
reported estiamtes \DIFdelbegin \DIFdel{being }\DIFdelend \DIFaddbegin \DIFadd{ranging }\DIFaddend between 0 and 1
...
LMAm and LMAs for Panama shade leaves (see Supplementary Section \DIFdelbegin \DIFdel{5}\DIFdelend \DIFaddbegin \DIFadd{6}\DIFaddend ).
...
of 100 leaves. For each simulated dataset, we used Eq.\DIFdelbegin \DIFdel{5 }\DIFdelend \DIFaddbegin \DIFadd{~\ref{eq-mass} }\DIFaddend to
quantify the relationship between \emph{A}\textsubscript{area} and LMA.

\section{\DIFdelbegin \DIFdel{Supplementary Section 5: }\DIFdelend Simulated datasets to study relationships between
photosynthetic capacity and
LMA}\DIFdelbegin %DIFDELCMD < \label{supplementary-section-5-simulated-datasets-to-study-relationships-between-photosynthetic-capacity-and-lma}
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \label{simulated-datasets-to-study-relationships-between-photosynthetic-capacity-and-lma}
\DIFaddend 
