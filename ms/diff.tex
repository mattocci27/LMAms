...
%DIF DEL LMAms_main_old.tex   Mon Aug 23 17:03:41 2021
%DIF ADD LMAms_main.tex       Mon Aug 23 18:11:45 2021
...
\DIFdel{, Osnas et al. }\DIFdelend \DIFaddbegin \hyperlink{ref-Osnas2013}{Osnas et al. 2013}\DIFadd{, }\DIFaddend \protect\DIFdelbegin %DIFDELCMD < \hyperlink{ref-Osnas2013}{2013}%%%
\DIFdel{).
Thus, although }\DIFdelend \DIFaddbegin \hyperlink{ref-Lloyd103}{\textbf{Lloyd103?}}\DIFadd{), is controversial.
...
Area-dependence of metabolic traits and the inconsistent correlation strengths obtained from different normalizers (}\protect\hyperlink{ref-Osnas2013}{Osnas et al. 2013}\DIFadd{, }\protect\hyperlink{ref-Lloyd103}{\textbf{Lloyd103?}}\DIFadd{) do not invalidate mass-normalization or the LES (}\protect\hyperlink{ref-Westoby2013}{Westoby et al. 2013}\DIFadd{)
These considerations should, however, lead us to question the strong correlations cited as }\DIFaddend evidence for a single dominant axis \DIFdelbegin \DIFdel{is controversial}\DIFdelend \DIFaddbegin \DIFadd{of leaf functional diversity, which has important implications for how trait variation is represented in global models (}\protect\hyperlink{ref-Bonan2002}{Bonan et al. 2002}\DIFadd{, }\protect\hyperlink{ref-Sakscheski}{\textbf{Sakscheski?}}\DIFadd{)}\DIFaddend .
...
Consider the scenario where }\DIFaddend these two LMA components are independent axes of functional variation\DIFaddbegin \DIFadd{, so that LMAp and LMAs are uncorrelated across species }\DIFaddend (Fig. \ref{fig:Hplt}a).
...
For example, the two-dimensional `\DIFdelbegin \DIFdel{LMAm }\DIFdelend \DIFaddbegin \DIFadd{LMAp }\DIFaddend + LMAs' model proposed by Osnas et al. (\protect\hyperlink{ref-Osnas2018}{2018}) could be compared to a one-dimensional LMA model in terms of their capacities to explain variation in other traits.
\DIFdelbegin \DIFdel{Doing so would require }\DIFdelend \DIFaddbegin \DIFadd{However, }\DIFaddend implementing the `\DIFdelbegin \DIFdel{LMAm }\DIFdelend \DIFaddbegin \DIFadd{LMAp }\DIFaddend + LMAs' model \DIFdelbegin \DIFdel{in a quantitative framework.
...
We develop and test the model using leaf trait data from two tropical forest sites (sun and shade leaves from wet and dry sites in Panama) and the GLOPNET global leaf traits database (\DIFdelbegin \DIFdel{Wright et al. }\DIFdelend \protect\DIFdelbegin %DIFDELCMD < \hyperlink{ref-Wright2004a}{2004}%%%
\DIFdelend \DIFaddbegin \hyperlink{ref-Wright2004a}{Wright et al. 2004}\DIFaddend ).
...
The latent variables \emph{f\textsubscript{i}} are not directly observed, but they can be constrained by available data using Bayesian methods (\DIFdelbegin \DIFdel{Bishop }\DIFdelend \protect\DIFdelbegin %DIFDELCMD < \hyperlink{ref-Bishop2006}{2006}%%%
\DIFdel{, Gelman and Hill }\DIFdelend \DIFaddbegin \hyperlink{ref-Bishop2006}{Bishop 2006}\DIFadd{, }\DIFaddend \protect\DIFdelbegin %DIFDELCMD < \hyperlink{ref-Gelman2006}{2006}%%%
...
Leaf density has also been shown in some cases to be a good predictor for LL (\DIFdelbegin \DIFdel{Kitajima et al. }\DIFdelend \protect\DIFdelbegin %DIFDELCMD < \hyperlink{ref-Kitajima2012}{2012}%%%
...
Eqs. \eqref{eq:E-A}-\eqref{eq:E-R} implicitly account for light availability, because LMA tends to increase from shade to sun within species (\DIFdelbegin \DIFdel{Onoda et al. }\DIFdelend \protect\DIFdelbegin %DIFDELCMD < \hyperlink{ref-Onoda2008}{2008}%%%
\DIFdel{, Kenzo et al. }\DIFdelend \DIFaddbegin \hyperlink{ref-Kenzo2006}{Kenzo et al. 2006}\DIFadd{, }\DIFaddend \protect\DIFdelbegin %DIFDELCMD < \hyperlink{ref-Kenzo2006}{2006}%%%
...
However, LMA cannot account for both inter- and intraspecific variation in LL, because LL increases as LMA increases across species but decreases as LMA increases within species from shade to sun (\DIFdelbegin \DIFdel{Lusk et al. }\DIFdelend \protect\DIFdelbegin %DIFDELCMD < \hyperlink{ref-Lusk2008}{2008}%%%
...
Accounting for the details of leaf carbon balance -- e.g., diurnal and seasonal cycles (\DIFdelbegin \DIFdel{Xu et al. }\DIFdelend \protect\DIFdelbegin %DIFDELCMD < \hyperlink{ref-Xu2017}{2017}%%%
...
\DIFdelend \DIFaddbegin \hyperlink{ref-Wright2004a}{Wright et al. 2004}\DIFaddend ) and from two tropical forest sites in Panama: Monumental Natural Metropolitano (MNM, ``dry site'') and Bosque Protector San Lorenzo (SL, ``wet site'')(\DIFdelbegin \DIFdel{Osnas et al. }\DIFdelend \protect\DIFdelbegin %DIFDELCMD < \hyperlink{ref-Osnas2018}{2018}%%%
\DIFdelend \DIFaddbegin \hyperlink{ref-Osnas2018}{Osnas et al. 2018}\DIFaddend ).
...
To model LL for Panama, we used Eq. \eqref{eq:E-LL2} (light effects model), which was motivated by the negative intraspecific LL-LMA relationship observed in Panama (\DIFdelbegin \DIFdel{Xu et al. }\DIFdelend \protect\DIFdelbegin %DIFDELCMD < \hyperlink{ref-Xu2017}{2017}%%%
...
Convergence of the posterior distribution was assessed with the Gelman-Rubin statistic with a convergence threshold of 1.1 for all diagnostics (\DIFdelbegin \DIFdel{Gelman et al. }\DIFdelend \protect\DIFdelbegin %DIFDELCMD < \hyperlink{ref-Gelman2013}{2013}%%%
...
The causes and interpretation of \emph{A}\textsubscript{max} vs.~LMA relationships are controversial (\DIFdelbegin \DIFdel{Westoby et al. }\DIFdelend \protect\DIFdelbegin %DIFDELCMD < \hyperlink{ref-Westoby2013}{2013}%%%
...
where LMA is the sum of LMAm and LMAs (Eq. \eqref{eq:LMA}), \emph{a} is a fitted constant, and \emph{b} is an index of mass-dependence as illustrated by the following cases (\DIFdelbegin \DIFdel{Osnas et al. }\DIFdelend \protect\DIFdelbegin %DIFDELCMD < \hyperlink{ref-Osnas2013}{2013}%%%
...
Note that although Eq. \eqref{eq:mass} uses area-normalized \emph{A}\textsubscript{max}, equivalent results can be obtained from mass-normalized \emph{A}\textsubscript{max} (\DIFdelbegin \DIFdel{Osnas et al. }\DIFdelend \protect\DIFdelbegin %DIFDELCMD < \hyperlink{ref-Osnas2018}{2018}%%%
\DIFdelend \DIFaddbegin \hyperlink{ref-Osnas2018}{Osnas et al. 2018}\DIFaddend ).
...
Thus, although building costs are likely similar for different leaf chemical components and tissues (\DIFdelbegin \DIFdel{Williams et al. }\DIFdelend \protect\DIFdelbegin %DIFDELCMD < \hyperlink{ref-Williams1989}{1989}%%%
\DIFdel{, Villar and Merino }\DIFdelend \DIFaddbegin \hyperlink{ref-Williams1989}{Williams et al. 1989}\DIFadd{, }\DIFaddend \protect\DIFdelbegin %DIFDELCMD < \hyperlink{ref-Villar2001}{2001}%%%
...
The increase in LMAm from shade to sun -- which likely reflects an increase in the size and number of palisade mesophyll cells with increasing light availability (\DIFdelbegin \DIFdel{Onoda et al. }\DIFdelend \protect\DIFdelbegin %DIFDELCMD < \hyperlink{ref-Onoda2008}{2008}%%%
\DIFdel{, Terashima et al. }\DIFdelend \DIFaddbegin \hyperlink{ref-Onoda2008}{Onoda et al. 2008}\DIFadd{, }\DIFaddend \protect\DIFdelbegin %DIFDELCMD < \hyperlink{ref-Terashima2011}{2011}%%%
...
This positive covariance between LMAm and LMAs within species means that per-area values of LMAm-proportional traits (e.g., \emph{A}\textsubscript{area}) have a strong, positive relationship with total LMA, which implies trait mass-proportionality (\DIFdelbegin \DIFdel{Osnas et al. }\DIFdelend \protect\DIFdelbegin %DIFDELCMD < \hyperlink{ref-Osnas2018}{2018}%%%
\DIFdelend \DIFaddbegin \hyperlink{ref-Osnas2018}{Osnas et al. 2018}\DIFaddend ).
...
Our results point to a simple two-dimensional framework for representing leaf functional diversity in global ecosystem models: a LMAm axis that determines \emph{A}\textsubscript{max}, accounts for nearly all \emph{R}\textsubscript{dark} (see rp and rs estimates in Table S1) and a LMAs axis that determines potential LL through its effects on leaf toughness (\DIFdelbegin \DIFdel{Kleyer et al. }\DIFdelend \protect\DIFdelbegin %DIFDELCMD < \hyperlink{ref-Kleyer2012}{2012}%%%
...
\hypertarget{refs}{}
\DIFdelbegin %DIFDELCMD < \begin{cslreferences}
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \begin{CSLReferences}{1}{0}
\DIFaddend \leavevmode\DIFaddbegin \vadjust \DIFadd{pre}{\DIFaddend \hypertarget{ref-Aranda2004}{}\DIFaddbegin }\DIFaddend %
Aranda, I., F. Pardo, L. Gil, and J. A. Pardos. 2004. \DIFdelbegin \DIFdel{Anatomical basis of the change in leaf mass per area and nitrogen investment with relative irradiance within the canopy of eight temperate tree species}\DIFdelend \DIFaddbegin \href{https://doi.org/10.1016/j.actao.2004.01.003}{\DIFadd{Anatomical basis of the change in leaf mass per area and nitrogen investment with relative irradiance within the canopy of eight temperate tree species}}\DIFaddend . Acta Oecologica 25:187--195.

\leavevmode\DIFaddbegin \vadjust \DIFadd{pre}{\DIFaddend \hypertarget{ref-Bishop2006}{}\DIFaddbegin }\DIFaddend %
Bishop, C. M. 2006. Pattern \DIFdelbegin \DIFdel{Recognition and Machine Learning}\DIFdelend \DIFaddbegin {\DIFadd{Recognition}} \DIFadd{and }{\DIFadd{Machine Learning}}\DIFadd{. }{\DIFadd{Springer}}\DIFadd{, }{\DIFadd{New York}}\DIFaddend .
\DIFdelbegin \DIFdel{Springer, New York.
}\DIFdelend 

\leavevmode\DIFaddbegin \vadjust \DIFadd{pre}{\DIFaddend \hypertarget{ref-Blonder2011}{}\DIFaddbegin }\DIFaddend %
Blonder, B., C. Violle, L. P. Bentley, and B. J. Enquist. 2011. \DIFdelbegin \DIFdel{Venation networks and the origin of the leaf economics spectrum}\DIFdelend \DIFaddbegin \href{https://doi.org/10.1111/j.1461-0248.2010.01554.x}{\DIFadd{Venation networks and the origin of the leaf economics spectrum}}\DIFaddend . Ecol. Lett. 14:91--100.

\leavevmode\DIFaddbegin \vadjust \DIFadd{pre}{\hypertarget{ref-Bonan2002}{}}%DIF > 
\DIFadd{Bonan, G. B., S. Levis, L. Kergoat, and K. W. Oleson. 2002. }\href{https://doi.org/10.1029/2000GB001360}{\DIFadd{Landscapes as patches of plant functional types: }{\DIFadd{An}} \DIFadd{integrating concept for climate and ecosystem models}}\DIFadd{. Glob. Biogeochem. Cycles 16:5-1-5-23.
}

\leavevmode\vadjust \DIFadd{pre}{\DIFaddend \hypertarget{ref-Burnham2002}{}\DIFaddbegin }\DIFaddend %
Burnham, K. P., and D. R. Anderson. 2002. \DIFdelbegin \DIFdel{Model Selection and Multimodel Inference: A Practical Information-Theoretic Approach}\DIFdelend \DIFaddbegin \href{https://doi.org/10.1007/b97636}{\DIFadd{Model }{\DIFadd{Selection}} \DIFadd{and }{\DIFadd{Multimodel Inference}}\DIFadd{: }{\DIFadd{A Practical Information}}\DIFadd{-}{\DIFadd{Theoretic Approach}}}\DIFaddend . Second. \DIFaddbegin {\DIFaddend Springer-Verlag\DIFdelbegin \DIFdel{, New York}\DIFdelend \DIFaddbegin }\DIFadd{, }{\DIFadd{New York}}\DIFaddend .

\leavevmode\DIFaddbegin \vadjust \DIFadd{pre}{\DIFaddend \hypertarget{ref-Carpenter2017}{}\DIFaddbegin }\DIFaddend %
Carpenter, B., A. Gelman, M. D. Hoffman, D. Lee, B. Goodrich, M. Betancourt, M. Brubaker, J. Guo, P. Li, and A. Riddell. 2017. \DIFdelbegin \DIFdel{Stan : A Probabilistic Programming Language}\DIFdelend \DIFaddbegin \href{https://doi.org/10.18637/jss.v076.i01}{\DIFadd{Stan : }{\DIFadd{A Probabilistic Programming Language}}}\DIFaddend . J. Stat. Softw. 76:1--32.

\leavevmode\DIFaddbegin \vadjust \DIFadd{pre}{\DIFaddend \hypertarget{ref-Evans2009}{}\DIFaddbegin }\DIFaddend %
Evans, J. R., R. Kaldenhoff, B. Genty, and I. Terashima. 2009. \DIFdelbegin \DIFdel{Resistances along the CO2 diffusion pathway inside leaves}\DIFdelend \DIFaddbegin \href{https://doi.org/10.1093/jxb/erp117}{\DIFadd{Resistances along the }{\DIFadd{CO2}} \DIFadd{diffusion pathway inside leaves}}\DIFaddend . J. Exp. Bot. 60:2235--2248.

\leavevmode\DIFaddbegin \vadjust \DIFadd{pre}{\hypertarget{ref-Falster2012}{}}%DIF > 
\DIFadd{Falster, D. S., P. B. Reich, D. S. Ellsworth, I. J. Wright, M. Westoby, J. Oleksyn, and T. D. Lee. 2012. }\href{https://doi.org/10.1111/j.1469-8137.2011.03940.x}{\DIFadd{Lifetime return on investment increases with leaf lifespan among 10 }{\DIFadd{Australian}} \DIFadd{woodland species}}\DIFadd{. New Phytol. 193:409--419.
}

\leavevmode\vadjust \DIFadd{pre}{\DIFaddend \hypertarget{ref-Gelman2013}{}\DIFaddbegin }\DIFaddend %
Gelman, A., J. B. Carlin, H. S. Stern, D. B. Dunson, A. Vehtari, and D. B. Rubin. 2013. Bayesian \DIFdelbegin \DIFdel{Data Analysis, Third Edition. }\DIFdelend \DIFaddbegin {\DIFadd{Data Analysis}}\DIFadd{, }{\DIFadd{Third Edition}}\DIFadd{. }{\DIFaddend Taylor \& Francis\DIFaddbegin }\DIFaddend .

\leavevmode\DIFaddbegin \vadjust \DIFadd{pre}{\DIFaddend \hypertarget{ref-Gelman2006}{}\DIFaddbegin }\DIFaddend %
Gelman, A., and J. Hill. 2006. \DIFdelbegin \DIFdel{Multilevel regression}\DIFdelend \DIFaddbegin \href{https://doi.org/10.1017/CBO9780511790942.014}{\DIFadd{Multilevel regression}}\DIFaddend . Data Analysis Using Regression and Multilevel/Hierarchical Models.

\leavevmode\DIFaddbegin \vadjust \DIFadd{pre}{\DIFaddend \hypertarget{ref-Huntingford2017}{}\DIFaddbegin }\DIFaddend %
Huntingford, C., O. K. Atkin, A. Martinez-de la Torre, L. M. Mercado, M. A. Heskel, A. B. Harper, K. J. Bloomfield, O. S. O'Sullivan, P. B. Reich, K. R. Wythers, E. E. Butler, M. Chen, K. L. Griffin, P. Meir, M. G. Tjoelker, M. H. Turnbull, S. Sitch, A. Wiltshire, and Y. Malhi. 2017. \DIFdelbegin \DIFdel{Implications of improved representations of plant respiration in a changing climate}\DIFdelend \DIFaddbegin \href{https://doi.org/10.1038/s41467-017-01774-z}{\DIFadd{Implications of improved representations of plant respiration in a changing climate}}\DIFaddend . Nat. Commun. 8:1602.

\leavevmode\DIFaddbegin \vadjust \DIFadd{pre}{\DIFaddend \hypertarget{ref-John2017}{}\DIFaddbegin }\DIFaddend %
John, G. P., C. Scoffoni, T. N. Buckley, R. Villar, H. Poorter, and L. Sack. 2017. \DIFdelbegin \DIFdel{The anatomical and compositional basis of leaf mass per area}\DIFdelend \DIFaddbegin \href{https://doi.org/10.1111/ele.12739}{\DIFadd{The anatomical and compositional basis of leaf mass per area}}\DIFaddend . Ecol. Lett. 20:412--425.

\leavevmode\DIFaddbegin \vadjust \DIFadd{pre}{\DIFaddend \hypertarget{ref-Kenzo2006}{}\DIFaddbegin }\DIFaddend %
Kenzo, T., T. Ichie, Y. Watanabe, R. Yoneda, I. Ninomiya, and T. Koike. 2006. \DIFdelbegin \DIFdel{Changes in photosynthesis and leaf characteristics with tree height in five dipterocarp species in a tropical rain forest}\DIFdelend \DIFaddbegin \href{https://doi.org/10.1093/treephys/26.7.865}{\DIFadd{Changes in photosynthesis and leaf characteristics with tree height in five dipterocarp species in a tropical rain forest}}\DIFaddend . Tree Physiol. 26:865--873.

\leavevmode\DIFaddbegin \vadjust \DIFadd{pre}{\DIFaddend \hypertarget{ref-Kikuzawa1991}{}\DIFaddbegin }\DIFaddend %
Kikuzawa, K. 1991. \DIFdelbegin \DIFdel{A Cost-Benefit Analysis of Leaf Habit and Leaf Longevity of Trees and Their Geographical}\DIFdelend \DIFaddbegin \href{https://doi.org/10.2307/2462519}{\DIFadd{A }{\DIFadd{Cost}}\DIFadd{-}{\DIFadd{Benefit Analysis}} \DIFadd{of }{\DIFadd{Leaf Habit}} \DIFadd{and }{\DIFadd{Leaf Longevity}} \DIFadd{of }{\DIFadd{Trees}} \DIFadd{and }{\DIFadd{Their Geographical}}}\DIFaddend . Am. Nat. 138:1250--1263.

\leavevmode\DIFaddbegin \vadjust \DIFadd{pre}{\DIFaddend \hypertarget{ref-Kitajima2013}{}\DIFaddbegin }\DIFaddend %
Kitajima, K., R. A. Cordero, and S. J. Wright. 2013. \DIFdelbegin \DIFdel{Leaf life span spectrum of tropical woody seedlings: Effects of light and ontogeny and consequences for survival}\DIFdelend \DIFaddbegin \href{https://doi.org/10.1093/aob/mct036}{\DIFadd{Leaf life span spectrum of tropical woody seedlings: }{\DIFadd{Effects}} \DIFadd{of light and ontogeny and consequences for survival}}\DIFaddend . Ann. Bot. 112:685--699.

\leavevmode\DIFaddbegin \vadjust \DIFadd{pre}{\DIFaddend \hypertarget{ref-Kitajima2012}{}\DIFaddbegin }\DIFaddend %
Kitajima, K., A. M. Llorens, C. Stefanescu, M. V. Timchenko, P. W. Lucas, and S. J. Wright. 2012. \DIFdelbegin \DIFdel{How cellulose-based leaf toughness and lamina density contribute to long leaf lifespans of shade-tolerant species}\DIFdelend \DIFaddbegin \href{https://doi.org/10.1111/j.1469-8137.2012.04203.x}{\DIFadd{How cellulose-based leaf toughness and lamina density contribute to long leaf lifespans of shade-tolerant species}}\DIFaddend . New Phytol. 195:640--652.

\leavevmode\DIFaddbegin \vadjust \DIFadd{pre}{\DIFaddend \hypertarget{ref-Kitajima2010}{}\DIFaddbegin }\DIFaddend %
Kitajima, K., and L. Poorter. 2010. \DIFdelbegin \DIFdel{Tissue-level leaf toughness, but not lamina thickness, predicts sapling leaf lifespan and shade tolerance of tropical tree species}\DIFdelend \DIFaddbegin \href{https://doi.org/10.1111/j.1469-8137.2010.03212.x}{\DIFadd{Tissue-level leaf toughness, but not lamina thickness, predicts sapling leaf lifespan and shade tolerance of tropical tree species}}\DIFaddend . New Phytol. 186:708--721.

\leavevmode\DIFaddbegin \vadjust \DIFadd{pre}{\DIFaddend \hypertarget{ref-Kitajima2016}{}\DIFaddbegin }\DIFaddend %
Kitajima, K., S. J. Wright, and J. W. Westbrook. 2016. \DIFdelbegin \DIFdel{Leaf cellulose density as the key determinant of inter- and intra-specific variation in leaf fracture toughness in a species-rich tropical forest}\DIFdelend \DIFaddbegin \href{https://doi.org/10.1098/rsfs.2015.0100}{\DIFadd{Leaf cellulose density as the key determinant of inter- and intra-specific variation in leaf fracture toughness in a species-rich tropical forest}}\DIFaddend . Interface Focus 6:20150100.

\leavevmode\DIFaddbegin \vadjust \DIFadd{pre}{\DIFaddend \hypertarget{ref-Kleyer2012}{}\DIFaddbegin }\DIFaddend %
Kleyer, M., S. Dray, F. Bello, J. Lepš, R. J. Pakeman, B. Strauss, W. Thuiller, and S. Lavorel. 2012. \DIFdelbegin \DIFdel{Assessing species and community functional responses to environmental gradients: Which multivariate methods? }\DIFdelend \DIFaddbegin \href{https://doi.org/10.1111/j.1654-1103.2012.01402.x}{\DIFadd{Assessing species and community functional responses to environmental gradients: }{\DIFadd{Which}} \DIFadd{multivariate methods?}} \DIFaddend J. Veg. Sci. 23:805--821.

\leavevmode\DIFaddbegin \vadjust \DIFadd{pre}{\DIFaddend \hypertarget{ref-Lloyd2013}{}\DIFaddbegin }\DIFaddend %
Lloyd, J., K. Bloomfield, T. F. Domingues, and G. D. Farquhar. 2013. \DIFdelbegin \DIFdel{Photosynthetically relevant foliar traits correlating better on a mass vs an area basis: Of ecophysiological relevance or just a case of mathematical imperatives and statistical quicksand? }\DIFdelend \DIFaddbegin \href{https://doi.org/10.1111/nph.12281}{\DIFadd{Photosynthetically relevant foliar traits correlating better on a mass vs an area basis: }{\DIFadd{Of}} \DIFadd{ecophysiological relevance or just a case of mathematical imperatives and statistical quicksand?}} \DIFaddend New Phytol. 199:311--321.

\leavevmode\DIFaddbegin \vadjust \DIFadd{pre}{\DIFaddend \hypertarget{ref-Lusk2010}{}\DIFaddbegin }\DIFaddend %
Lusk, C. H., Y. Onoda, R. Kooyman, and A. Gutiérrez-Girón. 2010. \DIFdelbegin \DIFdel{Reconciling species-level vs plastic responses of evergreen leaf structure to light gradients: Shade leaves punch above their weight}\DIFdelend \DIFaddbegin \href{https://doi.org/10.1111/j.1469-8137.2010.03202.x}{\DIFadd{Reconciling species-level vs plastic responses of evergreen leaf structure to light gradients: }{\DIFadd{Shade}} \DIFadd{leaves punch above their weight}}\DIFaddend . New Phytol. 186:429--438.

\leavevmode\DIFaddbegin \vadjust \DIFadd{pre}{\DIFaddend \hypertarget{ref-Lusk2008}{}\DIFaddbegin }\DIFaddend %
Lusk, C. H., P. B. Reich, R. A. Montgomery, D. D. Ackerly, and J. Cavender-Bares. 2008. \DIFdelbegin \DIFdel{Why are evergreen leaves so contrary about shade? }\DIFdelend \DIFaddbegin \href{https://doi.org/10.1016/j.tree.2008.02.006}{\DIFadd{Why are evergreen leaves so contrary about shade?}} \DIFaddend Trends Ecol. Evol. 23:299--303.

\leavevmode\DIFaddbegin \vadjust \DIFadd{pre}{\DIFaddend \hypertarget{ref-Martinez-Vilalta2016}{}\DIFaddbegin }\DIFaddend %
Martínez-Vilalta, J., A. Sala, D. Asensio, L. Galiano, G. Hoch, S. Palacio, F. I. Piper, and F. Lloret. 2016. \DIFdelbegin \DIFdel{Dynamics of non-structural carbohydrates in terrestrial plants: A global synthesis}\DIFdelend \DIFaddbegin \href{https://doi.org/10.1002/ecm.1231}{\DIFadd{Dynamics of non-structural carbohydrates in terrestrial plants: A global synthesis}}\DIFaddend . Ecol. Monogr. 86:495--516.

\leavevmode\DIFaddbegin \vadjust \DIFadd{pre}{\DIFaddend \hypertarget{ref-Niinemets2015}{}\DIFaddbegin }\DIFaddend %
Niinemets, Ü., T. F. Keenan, and L. Hallik. 2015. \DIFdelbegin \DIFdel{A worldwide analysis of within-canopy variations in leaf structural, chemical and physiological traits across plant functional types}\DIFdelend \DIFaddbegin \href{https://doi.org/10.1111/nph.13096}{\DIFadd{A worldwide analysis of within-canopy variations in leaf structural, chemical and physiological traits across plant functional types}}\DIFaddend . New Phytol. 205:973--993.

\leavevmode\DIFaddbegin \vadjust \DIFadd{pre}{\DIFaddend \hypertarget{ref-Onoda2008}{}\DIFaddbegin }\DIFaddend %
Onoda, Y., F. Schieving, and N. P. R. Anten. 2008. \DIFdelbegin \DIFdel{Effects of light and nutrient availability on leaf mechanical properties of Plantago major: A conceptual approach}\DIFdelend \DIFaddbegin \href{https://doi.org/10.1093/aob/mcn013}{\DIFadd{Effects of light and nutrient availability on leaf mechanical properties of }{\DIFadd{Plantago}} \DIFadd{major: }{\DIFadd{A}} \DIFadd{conceptual approach}}\DIFaddend . Ann. Bot. 101:727--736.

\leavevmode\DIFaddbegin \vadjust \DIFadd{pre}{\DIFaddend \hypertarget{ref-Onoda2015}{}\DIFaddbegin }\DIFaddend %
Onoda, Y., F. Schieving, and N. P. R. Anten. 2015. \DIFdelbegin \DIFdel{A novel method of measuring leaf epidermis and mesophyll stiffness shows the ubiquitous nature of the sandwich structure of leaf laminas in broad-leaved angiosperm species}\DIFdelend \DIFaddbegin \href{https://doi.org/10.1093/jxb/erv024}{\DIFadd{A novel method of measuring leaf epidermis and mesophyll stiffness shows the ubiquitous nature of the sandwich structure of leaf laminas in broad-leaved angiosperm species}}\DIFaddend . J. Exp. Bot. 66:2487--2499.

\leavevmode\DIFaddbegin \vadjust \DIFadd{pre}{\DIFaddend \hypertarget{ref-Onoda2017}{}\DIFaddbegin }\DIFaddend %
Onoda, Y., I. J. Wright, J. R. Evans, K. Hikosaka, K. Kitajima, Ü. Niinemets, H. Poorter, T. Tosens, and M. Westoby. 2017. \DIFdelbegin \DIFdel{Physiological and structural tradeoffs underlying the leaf economics spectrum}\DIFdelend \DIFaddbegin \href{https://doi.org/10.1111/nph.14496}{\DIFadd{Physiological and structural tradeoffs underlying the leaf economics spectrum}}\DIFaddend . New Phytol. 214:1447--1463.

\leavevmode\DIFaddbegin \vadjust \DIFadd{pre}{\DIFaddend \hypertarget{ref-Osada2001}{}\DIFaddbegin }\DIFaddend %
Osada, N., H. Takeda, A. Furukawa, and M. Awang. 2001. \DIFdelbegin \DIFdel{Leaf dynamics and maintenance of tree crowns in a malaysian rain forest stand}\DIFdelend \DIFaddbegin \href{https://doi.org/10.1046/j.0022-0477.2001.00590.x}{\DIFadd{Leaf dynamics and maintenance of tree crowns in a malaysian rain forest stand}}\DIFaddend . J. Ecol. 89:774--782.

\leavevmode\DIFaddbegin \vadjust \DIFadd{pre}{\DIFaddend \hypertarget{ref-Osnas2018}{}\DIFaddbegin }\DIFaddend %
Osnas, J. L. D., M. Katabuchi, K. Kitajima, S. J. Wright, P. B. Reich, S. A. Van Bael, N. J. B. Kraft, M. J. Samaniego, S. W. Pacala, and J. W. Lichstein. 2018. \DIFdelbegin \DIFdel{Divergent drivers of leaf trait variation within species, among species, and among functional groups. }\DIFdelend \DIFaddbegin \href{https://doi.org/10.1073/pnas.1803989115}{\DIFadd{Divergent drivers of leaf trait variation within species, among species, and among functional groups.}} \DIFaddend Proc. Natl. Acad. Sci. U. S. A. 115:5480--5485.

\leavevmode\DIFaddbegin \vadjust \DIFadd{pre}{\DIFaddend \hypertarget{ref-Osnas2013}{}\DIFaddbegin }\DIFaddend %
Osnas, J. L. D., J. W. Lichstein, P. B. Reich, and S. W. Pacala. 2013. \DIFdelbegin \DIFdel{Global leaf trait relationships: Mass, area, and the leaf economics spectrum}\DIFdelend \DIFaddbegin \href{https://doi.org/10.1126/science.1231574}{\DIFadd{Global leaf trait relationships: }{\DIFadd{Mass}}\DIFadd{, area, and the leaf economics spectrum}}\DIFaddend . Science 340:741--744.

\leavevmode\DIFaddbegin \vadjust \DIFadd{pre}{\DIFaddend \hypertarget{ref-Poorter2009}{}\DIFaddbegin }\DIFaddend %
Poorter, H., Ü. Niinemets, L. Poorter, I. J. Wright, and R. Villar. 2009. \DIFdelbegin \DIFdel{Causes and consequences of variation in leaf mass per area (LMA): A meta-analysis}\DIFdelend \DIFaddbegin \href{https://doi.org/10.1111/j.1469-8137.2009.02830.x}{\DIFadd{Causes and consequences of variation in leaf mass per area (}{\DIFadd{LMA}}\DIFadd{): }{\DIFadd{A}} \DIFadd{meta-analysis}}\DIFaddend . New Phytol. 182:565--588.

\leavevmode\DIFaddbegin \vadjust \DIFadd{pre}{\DIFaddend \hypertarget{ref-Poorter2006b}{}\DIFaddbegin }\DIFaddend %
Poorter, H., S. Pepin, T. Rijkers, Y. De Jong, J. R. Evans, and C. Körner. 2006. \DIFdelbegin \DIFdel{Construction costs, chemical composition and payback time of high- and low-irradiance leaves}\DIFdelend \DIFaddbegin \href{https://doi.org/10.1093/jxb/erj002}{\DIFadd{Construction costs, chemical composition and payback time of high- and low-irradiance leaves}}\DIFaddend . J. Exp. Bot. 57:355--371.

\leavevmode\DIFaddbegin \vadjust \DIFadd{pre}{\DIFaddend \hypertarget{ref-Reich2014}{}\DIFaddbegin }\DIFaddend %
Reich, P. B. 2014. \DIFdelbegin \DIFdel{The world-wide 'fast-slow' plant economics spectrum: A traits manifesto}\DIFdelend \DIFaddbegin \href{https://doi.org/10.1111/1365-2745.12211}{\DIFadd{The world-wide 'fast-slow' plant economics spectrum: }{\DIFadd{A}} \DIFadd{traits manifesto}}\DIFaddend . J. Ecol. 102:275--301.

\leavevmode\DIFaddbegin \vadjust \DIFadd{pre}{\DIFaddend \hypertarget{ref-Roderick1999}{}\DIFaddbegin }\DIFaddend %
Roderick, M. L., S. L. Berry, I. R. Noble, and G. D. Farquhar. 1999. \DIFdelbegin \DIFdel{A theoretical approach to linking the composition and morphology with the function of leaves}\DIFdelend \DIFaddbegin \href{https://doi.org/10.1046/j.1365-2435.1999.00368.x}{\DIFadd{A theoretical approach to linking the composition and morphology with the function of leaves}}\DIFaddend . Funct. Ecol. 13:683--695.

\leavevmode\DIFaddbegin \vadjust \DIFadd{pre}{\DIFaddend \hypertarget{ref-Russo2016}{}\DIFaddbegin }\DIFaddend %
Russo, S. E., and K. Kitajima. 2016. \DIFdelbegin \DIFdel{The Ecophysiology of Leaf Lifespan in Tropical Forests: Adaptive and Plastic Responses to Environmental Heterogeneity}\DIFdelend \DIFaddbegin \href{https://doi.org/10.1007/978-3-319-27422-5_17}{\DIFadd{The }{\DIFadd{Ecophysiology}} \DIFadd{of }{\DIFadd{Leaf Lifespan}} \DIFadd{in }{\DIFadd{Tropical Forests}}\DIFadd{: }{\DIFadd{Adaptive}} \DIFadd{and }{\DIFadd{Plastic Responses}} \DIFadd{to }{\DIFadd{Environmental Heterogeneity}}}\DIFaddend . Pages 357--383 \emph{in} G. Goldstein and S. L. Santiago, editors. Tropical \DIFdelbegin \DIFdel{Tree Physiology. }\DIFdelend \DIFaddbegin {\DIFadd{Tree Physiology}}\DIFadd{. }{\DIFaddend Springer International Publishing\DIFdelbegin \DIFdel{, Cham}\DIFdelend \DIFaddbegin }\DIFadd{, }{\DIFadd{Cham}}\DIFaddend .

\leavevmode\DIFaddbegin \vadjust \DIFadd{pre}{\DIFaddend \hypertarget{ref-Sakschewski2016}{}\DIFaddbegin }\DIFaddend %
Sakschewski, B., W. von Bloh, A. Boit, L. Poorter, M. Peña-Claros, J. Heinke, J. Joshi, and K. Thonicke. 2016. \DIFdelbegin \DIFdel{Resilience of Amazon forests emerges from plant trait diversity}\DIFdelend \DIFaddbegin \href{https://doi.org/10.1038/nclimate3109}{\DIFadd{Resilience of }{\DIFadd{Amazon}} \DIFadd{forests emerges from plant trait diversity}}\DIFaddend . Nature Clim Change 6:1032--1036.

\leavevmode\DIFaddbegin \vadjust \DIFadd{pre}{\DIFaddend \hypertarget{ref-Sakschewski2015}{}\DIFaddbegin }\DIFaddend %
Sakschewski, B., W. von Bloh, A. Boit, A. Rammig, J. Kattge, L. Poorter, J. Peñuelas, and K. Thonicke. 2015. \DIFdelbegin \DIFdel{Leaf and stem economics spectra drive diversity of functional plant traits in a dynamic global vegetation model}\DIFdelend \DIFaddbegin \href{https://doi.org/10.1111/gcb.12870}{\DIFadd{Leaf and stem economics spectra drive diversity of functional plant traits in a dynamic global vegetation model}}\DIFaddend . Glob. Change Biol. 21:2711--2725.

\leavevmode\DIFaddbegin \vadjust \DIFadd{pre}{\DIFaddend \hypertarget{ref-Scheiter2013}{}\DIFaddbegin }\DIFaddend %
Scheiter, S., L. Langan, and S. I. Higgins. 2013. \DIFdelbegin \DIFdel{Next-generation dynamic global vegetation models: Learning from community ecology}\DIFdelend \DIFaddbegin \href{https://doi.org/10.1111/nph.12210}{\DIFadd{Next-generation dynamic global vegetation models: }{\DIFadd{Learning}} \DIFadd{from community ecology}}\DIFaddend . New Phytol. 198:957--969.

\leavevmode\DIFaddbegin \vadjust \DIFadd{pre}{\DIFaddend \hypertarget{ref-Shipley2006}{}\DIFaddbegin }\DIFaddend %
Shipley, B., M. J. Lechowicz, I. Wright, and P. B. Reich. 2006. \DIFdelbegin \DIFdel{Fundamental trade-offs generating the worldwide leaf economics spectrum}\DIFdelend \DIFaddbegin \href{https://doi.org/10.1890/05-1051}{\DIFadd{Fundamental trade-offs generating the worldwide leaf economics spectrum}}\DIFaddend . Ecology 87:535--541.

\leavevmode\DIFaddbegin \vadjust \DIFadd{pre}{\DIFaddend \hypertarget{ref-Tcherkez2017}{}\DIFaddbegin }\DIFaddend %
Tcherkez, G., P. Gauthier, T. N. Buckley, F. A. Busch, M. M. Barbour, D. Bruhn, M. A. Heskel, X. Y. Gong, K. Y. Crous, K. Griffin, D. Way, M. Turnbull, M. A. Adams, O. K. Atkin, G. D. Farquhar, and G. Cornic. 2017. \DIFdelbegin \DIFdel{Leaf day respiration: Low CO2 flux but high significance for metabolism and carbon balance}\DIFdelend \DIFaddbegin \href{https://doi.org/10.1111/nph.14816}{\DIFadd{Leaf day respiration: Low }{\DIFadd{CO2}} \DIFadd{flux but high significance for metabolism and carbon balance}}\DIFaddend . New Phytol. 216:986--1001.

\leavevmode\DIFaddbegin \vadjust \DIFadd{pre}{\DIFaddend \hypertarget{ref-Terashima2011}{}\DIFaddbegin }\DIFaddend %
Terashima, I., Y. T. Hanba, D. Tholen, and U. Niinemets. 2011. \DIFdelbegin \DIFdel{Leaf Functional Anatomy in Relation to Photosynthesis}\DIFdelend \DIFaddbegin \href{https://doi.org/10.1104/pp.110.165472}{\DIFadd{Leaf }{\DIFadd{Functional Anatomy}} \DIFadd{in }{\DIFadd{Relation}} \DIFadd{to }{\DIFadd{Photosynthesis}}}\DIFaddend . Plant Physiol. 155:108--116.

\leavevmode\DIFaddbegin \vadjust \DIFadd{pre}{\DIFaddend \hypertarget{ref-Vehtari2014}{}\DIFaddbegin }\DIFaddend %
Vehtari, A., T. Mononen, V. Tolvanen, T. Sivula, and O. Winther. 2014. \DIFdelbegin \DIFdel{Bayesian leave-one-out cross-validation approximations for Gaussian latent variable models}\DIFdelend \DIFaddbegin \href{https://arxiv.org/abs/1408.4050v2}{\DIFadd{Bayesian leave-one-out cross-validation approximations for }{\DIFadd{Gaussian}} \DIFadd{latent variable models}}\DIFaddend . ArXiv Prepr. ArXiv14084050v2.

\leavevmode\DIFaddbegin \vadjust \DIFadd{pre}{\DIFaddend \hypertarget{ref-Villar2001}{}\DIFaddbegin }\DIFaddend %
Villar, R., and J. Merino. 2001. \DIFdelbegin \DIFdel{Comparison of leaf construction costs in woody species with differing leaf life-spans in contrasting ecosystems}\DIFdelend \DIFaddbegin \href{https://doi.org/10.1046/j.1469-8137.2001.00147.x}{\DIFadd{Comparison of leaf construction costs in woody species with differing leaf life-spans in contrasting ecosystems}}\DIFaddend . New Phytol. 151:213--226.

\leavevmode\DIFaddbegin \vadjust \DIFadd{pre}{\DIFaddend \hypertarget{ref-Westoby2013}{}\DIFaddbegin }\DIFaddend %
Westoby, M., P. B. Reich, and I. J. Wright. 2013. \DIFdelbegin \DIFdel{Understanding ecological variation across species: Area-based vs mass-based expression of leaf traits}\DIFdelend \DIFaddbegin \href{https://doi.org/10.1111/nph.12345}{\DIFadd{Understanding ecological variation across species: }{\DIFadd{Area}}\DIFadd{-based vs mass-based expression of leaf traits}}\DIFaddend . New Phytol. 199:322--323.

\leavevmode\DIFaddbegin \vadjust \DIFadd{pre}{\hypertarget{ref-Westoby2000}{}}%DIF > 
\DIFadd{Westoby, M., D. Warton, and P. B. Reich. 2000. }\href{https://doi.org/10.1086/303346}{\DIFadd{The }{\DIFadd{Time Value}} \DIFadd{of }{\DIFadd{Leaf Area}}}\DIFadd{. Am. Nat. 155:649--656.
}

\leavevmode\vadjust \DIFadd{pre}{\DIFaddend \hypertarget{ref-Williams1989}{}\DIFaddbegin }\DIFaddend %
Williams, K., C. B. Field, and H. A. Mooney. 1989. \DIFdelbegin \DIFdel{Relationships Among Leaf Construction Cost, Leaf Longevity, and Light Environment in Rain-Forest Plants of the Genus Piper}\DIFdelend \DIFaddbegin \href{https://doi.org/10.1086/284910}{\DIFadd{Relationships }{\DIFadd{Among Leaf Construction Cost}}\DIFadd{, }{\DIFadd{Leaf Longevity}}\DIFadd{, and }{\DIFadd{Light Environment}} \DIFadd{in }{\DIFadd{Rain}}\DIFadd{-}{\DIFadd{Forest Plants}} \DIFadd{of the }{\DIFadd{Genus Piper}}}\DIFaddend . Am. Nat. 133:198--211.

\leavevmode\DIFaddbegin \vadjust \DIFadd{pre}{\DIFaddend \hypertarget{ref-Wright2005}{}\DIFaddbegin }\DIFaddend %
Wright, I. J., P. B. Reich, J. H. C. Cornelissen, D. S. Falster, P. K. Groom, K. Hikosaka, W. Lee, C. H. Lusk, Ü. Niinemets, J. Oleksyn, N. Osada, H. Poorter, D. I. Warton, and M. Westoby. 2005. \DIFdelbegin \DIFdel{Modulation of leaf economic traits and trait relationships by climate}\DIFdelend \DIFaddbegin \href{https://doi.org/10.1111/j.1466-822x.2005.00172.x}{\DIFadd{Modulation of leaf economic traits and trait relationships by climate}}\DIFaddend . Glob. Ecol. Biogeogr. 14:411--421.

\leavevmode\DIFaddbegin \vadjust \DIFadd{pre}{\DIFaddend \hypertarget{ref-Wright2004a}{}\DIFaddbegin }\DIFaddend %
Wright, I. J., P. B. Reich, M. Westoby, D. D. Ackerly, Z. Baruch, F. Bongers, J. Cavender-Bares, T. Chapin, J. H. C. Cornellssen, M. Diemer, J. Flexas, E. Garnier, P. K. Groom, J. Gulias, K. Hikosaka, B. B. Lamont, T. Lee, W. Lee, C. Lusk, J. J. Midgley, M. L. Navas, Ü. Niinemets, J. Oleksyn, H. Osada, H. Poorter, P. Pool, L. Prior, V. I. Pyankov, C. Roumet, S. C. Thomas, M. G. Tjoelker, E. J. Veneklaas, and R. Villar. 2004. \DIFdelbegin \DIFdel{The worldwide leaf economics spectrum}\DIFdelend \DIFaddbegin \href{https://doi.org/10.1038/nature02403}{\DIFadd{The worldwide leaf economics spectrum}}\DIFaddend . Nature 428:821--827.

\leavevmode\DIFaddbegin \vadjust \DIFadd{pre}{\DIFaddend \hypertarget{ref-Wright2003}{}\DIFaddbegin }\DIFaddend %
Wright, S. J., V. Horlyck, Y. Basset, H. Barrios, A. Bethancourt, S. Bohlman, G. Gilbert, G. Goldstein, E. A. Graham, K. Kitajima, M. T. Lerdau, F. C. Meinzer, F. Ødegaard, D. R. Reynolds, D. W. Roubik, S. Sakai, M. Samaniego, J. P. Sparks, S. Van Bael, K. Winter, and G. Zotz. 2003. Tropical \DIFaddbegin {\DIFaddend Canopy Biology Program\DIFdelbegin \DIFdel{, Republic of Panama}\DIFdelend \DIFaddbegin }\DIFadd{, }{\DIFadd{Republic}} \DIFadd{of }{\DIFadd{Panama}}\DIFaddend . Pages 137--155 \emph{in} Y. Basset, V. Horlyck, and S. J. Wright, editors. Studying \DIFdelbegin \DIFdel{Forest Canopies from Above: }\DIFdelend \DIFaddbegin {\DIFadd{Forest Canopies}} \DIFadd{from }{\DIFadd{Above}}\DIFadd{: }{\DIFaddend The International Canopy Crane Network\DIFaddbegin }\DIFadd{. }{\DIFadd{Panama}}\DIFaddend .
\DIFdelbegin \DIFdel{Panama.
}\DIFdelend 

\leavevmode\DIFaddbegin \vadjust \DIFadd{pre}{\DIFaddend \hypertarget{ref-Wullschleger2014}{}\DIFaddbegin }\DIFaddend %
Wullschleger, S. D., H. E. Epstein, E. O. Box, E. S. Euskirchen, S. Goswami, C. M. Iversen, J. Kattge, R. J. Norby, P. M. Van Bodegom, and X. Xu. 2014. \DIFdelbegin \DIFdel{Plant functional types in Earth system models: Past experiences and future directions for application of dynamic vegetation models in high-latitude ecosystems}\DIFdelend \DIFaddbegin \href{https://doi.org/10.1093/aob/mcu077}{\DIFadd{Plant functional types in }{\DIFadd{Earth}} \DIFadd{system models: }{\DIFadd{Past}} \DIFadd{experiences and future directions for application of dynamic vegetation models in high-latitude ecosystems}}\DIFaddend . Ann. Bot. 114:1--16.

\leavevmode\DIFaddbegin \vadjust \DIFadd{pre}{\DIFaddend \hypertarget{ref-Xu2017}{}\DIFaddbegin }\DIFaddend %
Xu, X., D. Medvigy, S. Joseph Wright, K. Kitajima, J. Wu, L. P. Albert, G. A. Martins, S. R. Saleska, and S. W. Pacala. 2017. \DIFdelbegin \DIFdel{Variations of leaf longevity in tropical moist forests predicted by a trait-driven carbon optimality model}\DIFdelend \DIFaddbegin \href{https://doi.org/10.1111/ele.12804}{\DIFadd{Variations of leaf longevity in tropical moist forests predicted by a trait-driven carbon optimality model}}\DIFaddend . Ecol. Lett. 20:1097--1106.
...
\caption{\label{tab:modeltab} \DIFadd{Five model forms compared to predict }\emph{\DIFadd{A}}\DIFadd{\textsubscript{area}, LL and }\emph{\DIFadd{R}}\DIFadd{\textsubscript{area}.}}\tabularnewline
\toprule
\begin{minipage}[b]{\linewidth}\raggedright
\DIFadd{Model
}\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
\DIFadd{Expected trait values
}\end{minipage} \\
\midrule
\endfirsthead
\toprule
...
\midrule
\endhead
\DIFadd{LMA }& \DIFadd{\(\mathrm{E}[A_{\mathrm{area} \, i}] = \alpha_0\mathrm{LMA}_{i}^{\alpha}\) }\\
& \DIFadd{\(\mathrm{E}[\mathrm{LL}_i] = \beta_0\mathrm{LMA}_{i}^{\beta}\) }\\
& \DIFadd{\(\mathrm{E}[R_{\mathrm{area} \, i}] = \gamma_0\mathrm{LMA}_{i}^{\gamma}\) }\\
\DIFadd{LMA + light }& \DIFadd{\(\mathrm{E}[A_{\mathrm{area} \, i}] = \alpha_0\mathrm{LMA}_{i}^{\alpha}\) }\\
& \DIFadd{\(\mathrm{E}[\mathrm{LL}_i] = \beta_0\mathrm{LMA}_{i}^{\beta}exp(\theta Light_i)\) }\\
& \DIFadd{\(\mathrm{E}[R_{\mathrm{area} \, i}] = \gamma_0\mathrm{LMA}_{i}^{\gamma}\) }\\
\DIFadd{LMAm + LMAs }& \DIFadd{\(\mathrm{E}[A_{\mathrm{area} \, i}] = \alpha_0\mathrm{LMAm}_{i}^{\alpha_m} \mathrm{LMAs}_{i}^{\alpha_s}\) }\\
& \DIFadd{\(\mathrm{E}[\mathrm{LL}_i] = \beta_0\mathrm{LMAm}_{i}^{\beta_m} \mathrm{LMAs}_{i}^{\beta_s}\) }\\
& \DIFadd{\(\mathrm{E}[R_{\mathrm{area} \, i}] = \gamma_0\mathrm{LMAm}_{i}^{\gamma_m} \mathrm{LMAs}_{i}^{\gamma_s}\) }\\
\DIFadd{LMAm + LMAs + light }& \DIFadd{\(\mathrm{E}[A_{\mathrm{area} \, i}]= \alpha_0\mathrm{LMAm}_{i}^{\alpha_m} \mathrm{LMAs}_{i}^{\alpha_s}\) }\\
& \DIFadd{\(\mathrm{E}[\mathrm{LL}_i] = \beta_0\mathrm{LMAm}_{i}^{\beta_m} \mathrm{LMAs}_{i}^{\beta_s}exp(\theta Light_i)\) }\\
& \DIFadd{\(\mathrm{E}[R_{\mathrm{area} \, i}] = \gamma_0\mathrm{LMAm}_{i}^{\gamma_m} \mathrm{LMAs}_{i}^{\gamma_s}\) }\\
\DIFadd{LMAm + LMA/LT + light }& \DIFadd{\(\mathrm{E}[A_{\mathrm{area} \, i}]= \alpha_0\mathrm{LMAm}_{i}^{\alpha_m} (\mathrm{LMAs}_{i}/\mathrm{LT}_{i})^{\alpha_s}\) }\\
& \DIFadd{\(\mathrm{E}[\mathrm{LL}_i] = \beta_0\mathrm{LMAm}_{i}^{\beta_m} (\mathrm{LMAs}_{i}/\mathrm{LT}_{i})^{\beta_s}exp(\theta Light_i)\) }\\
& \DIFadd{\(\mathrm{E}[R_{\mathrm{area} \, i}] = \gamma_0\mathrm{LMAm}_{i}^{\gamma_m} \mathrm{LMAs}_{i}^{\gamma_s}\) }\\
\bottomrule
\end{longtable}
...
\begin{longtable}[]{@{}lll@{}}
\caption{\label{tab:lootab} \DIFadd{Summary of the model comparison. Lower approximate leave-one-out cross-validation (LOOIC) indicates better predictive accuracy. N; number of samples.}}\tabularnewline
\toprule
& \DIFadd{LOOIC }& \DIFadd{N }\\
\midrule
\endfirsthead
\toprule
& \DIFadd{LOOIC }& \DIFadd{N }\\
\midrule
\endhead
\textbf{\DIFadd{GLOPNET}} & & \\
\DIFadd{LMAm and LMAs }& \DIFadd{746 }& \DIFadd{198 }\\
\DIFadd{LMA }& \DIFadd{766.2 }& \DIFadd{198 }\\
\textbf{\DIFadd{Panama}} & & \\
\DIFadd{LMAm + LMAs + light }& \DIFadd{501.1 }& \DIFadd{106 }\\
\DIFadd{LMA + light }& \DIFadd{503 }& \DIFadd{106 }\\
\DIFadd{LMAm + LMAs/LT + light }& \DIFadd{503.4 }& \DIFadd{106 }\\
\DIFadd{LMAm + LMAs }& \DIFadd{518.2 }& \DIFadd{106 }\\
\DIFadd{LMA }& \DIFadd{528.1 }& \DIFadd{106 }\\
\bottomrule
\end{longtable}
...
\begin{longtable}[]{@{}
  ...
  >{\raggedright\arraybackslash}p{(\columnwidth - 4\tabcolsep) * \real{0.2887}}@{}}
\caption{\label{tab:paratab} \DIFadd{Posterior medians }{[}\DIFadd{95\% credible interval}{]} \DIFadd{of parameters for the best models. `LMAm + LMAs model' and `LMAm + LMAs + light model' are shown for GLOPNET and Panama data, respectively. Bold values are significantly different from zero based on the 95\% credible interval.}}\tabularnewline
\toprule
\begin{minipage}[b]{\linewidth}\raggedright
\DIFadd{Parameters
}\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
...
\midrule
\endhead
\DIFadd{Effect of LMAm on }\emph{\DIFadd{A}}\DIFadd{\textsubscript{area} (\(\alpha_m\)) }& \textbf{\DIFadd{0.206 }{[}\DIFadd{0.108, 0.294}{]}} & \textbf{\DIFadd{0.442 }{[}\DIFadd{0.338, 0.574}{]}} \\
\DIFadd{Effect of LMAs on }\emph{\DIFadd{A}}\DIFadd{\textsubscript{area} (\(\alpha_s\)) }& \textbf{\DIFadd{-0.111 }{[}\DIFadd{-0.179, -0.037}{]}} & \textbf{\DIFadd{0.29 }{[}\DIFadd{0.16, 0.391}{]}} \\
\DIFadd{Effect of LMAm on LL (\(\beta_m\)) }& \textbf{\DIFadd{0.261 }{[}\DIFadd{0.097, 0.466}{]}} & \DIFadd{0.086 }{[}\DIFadd{-0.119, 0.314}{]} \\
\DIFadd{Effect of LMAs on LL (\(\beta_s\)) }& \textbf{\DIFadd{0.785 }{[}\DIFadd{0.627, 0.93}{]}} & \textbf{\DIFadd{0.376 }{[}\DIFadd{0.172, 0.567}{]}} \\
\DIFadd{Effect of LMAm on }\emph{\DIFadd{R}}\DIFadd{\textsubscript{area} (\(\gamma_m\)) }& \textbf{\DIFadd{0.218 }{[}\DIFadd{0.096, 0.316}{]}} & \textbf{\DIFadd{0.6 }{[}\DIFadd{0.345, 0.822}{]}} \\
\DIFadd{Effect of LMAs on }\emph{\DIFadd{R}}\DIFadd{\textsubscript{area} (\(\gamma_s\)) }& \DIFadd{0.049 }{[}\DIFadd{-0.033, 0.14}{]} & \DIFadd{0.204 }{[}\DIFadd{-0.059, 0.469}{]} \\
\DIFadd{Effect of light on LL (\(\theta\)) }& \DIFadd{- }& \textbf{\DIFadd{-1.046 }{[}\DIFadd{-1.471, -0.617}{]}} \\
\bottomrule
\end{longtable}
...
\begin{figure}
\centering
\includegraphics{LMAms_main_files/figure-latex/Hplt-1.pdf}
\caption{\label{fig:Hplt}\DIFaddFL{Example of a two-dimensional functional space that can result in either a two- or one-dimensional trait space, depending on how metabolic traits are normalized. (A) Hypothetical indpendent variation in two leaf mass per area (LMA) components: metabolic leaf mass per area (LMAm, which largely determines per-area values of photosynthesis, respiration, and nutrient concentrations) and structural leaf mass per area (LMAs, which determines leaf toughness but has little effect on metabolic traits). (B) Two-dimensional relationship between photosynthetic capacity (}\emph{\DIFaddFL{A}}\DIFaddFL{\textsubscript{max}) per-unit leaf area and total LMA (equal to LMAm + LMAs). (C) One-dimensional relationship between }\emph{\DIFaddFL{A}}\DIFaddFL{\textsubscript{max} per-unit leaf mass and total LMA. Variation in LMAm and LMAs and }\emph{\DIFaddFL{A}}\DIFaddFL{\textsubscript{max} values in panels B and C are derived from our analysis of the GLOPNET database. \(A_{\mathrm{area} \, i}=1.9\mathrm{LMAm}_i^{0.36}\mathrm{LMAs}^{-0.25}\epsilon_i\), where \(\epsilon_i\) is log-normally distributed with log-mean with 0, log-scale parameter with 0.3. (see Methods and Results).}}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{LMAms_main_files/figure-latex/GLplt-1.pdf}
\caption{\label{fig:GLplt}\DIFaddFL{Observed and estimated leaf-trait relationships in the global GLOPNET dataset. (A) Leaf life span (LL), net photosynthetic rate per unit leaf area (}\emph{\DIFaddFL{A}}\DIFaddFL{\textsubscript{area}), and dark respiration rate per unit leaf area (}\emph{\DIFaddFL{R}}\DIFaddFL{\textsubscript{area}) are plotted against observed LMA. (B) Residuals of LL, }\emph{\DIFaddFL{A}}\DIFaddFL{\textsubscript{area}, and }\emph{\DIFaddFL{R}}\DIFaddFL{\textsubscript{area} regressed on posteior estimates of photosynthetic and structural LMA components (LMAm and LMAs, respectively) are plotted against LMAm and LMAs (only means are shown). Pearson correlation coefficients are for LMA (left column) and posterior distributions of LMAm (middle column) and LMAs (right column).}}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{LMAms_main_files/figure-latex/PAplt-1.pdf}
\caption{\label{fig:PAplt}\DIFaddFL{Observed and estimated leaf-trait relationships in the Panama dataset. Estimates are from the Optimal LL Model (Eq. 8). Details as in Fig. 2. Results for other LL models are summarized in Table SX.}}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{LMAms_main_files/figure-latex/LLplt-1.pdf}
\caption{\label{fig:LLplt}\DIFaddFL{Observed vs.~predicted leaf lifespan (LL) in the Optimal LL Model (Eq. 8). Predicted LL values are posterior medians. The dashed line indicates the 1:1 relationship. The }\emph{\DIFaddFL{r}}\DIFaddFL{\textsuperscript{2} value is the posterior median of Bayesian }\emph{\DIFaddFL{r}}\DIFaddFL{\textsuperscript{2} (Gelman et al.~2019).}}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{LMAms_main_files/figure-latex/massplt-1.pdf}
\caption{\label{fig:massplt}\DIFaddFL{The relationships among mass proportionality (}\emph{\DIFaddFL{b\textsubscript{i}}} \DIFaddFL{in Eq. }\eqref{eq:mass}\DIFaddFL{), variance in LMAm and LMAs, and scaling slopes between LMAm and }\emph{\DIFaddFL{A}}\DIFaddFL{\textsubscript{area} (\(\alpha_m\)) and LMAs and }\emph{\DIFaddFL{A}}\DIFaddFL{\textsubscript{area} (\(\alpha_s\)) for the global GLOPNET dataset, sun leaves in Panama, and shade leaves in Panama. The photosynthetic rate (}\emph{\DIFaddFL{A}}\DIFaddFL{\textsubscript{max}) is primarily mass-dependent (}\emph{\DIFaddFL{b\textsubscript{i}}} \DIFaddFL{\textgreater{} 0.5, white to blue), primarily area-dependent (0.5 \textgreater{} }\emph{\DIFaddFL{b\textsubscript{i}}} \DIFaddFL{\textgreater{} 0, white to orange) and purely area-proportional (}\emph{\DIFaddFL{b\textsubscript{i}}} \DIFaddFL{= 0, white) (Osnas et al.~2018). Note that when }\emph{\DIFaddFL{b\textsubscript{i}}} \DIFaddFL{is negative, }\emph{\DIFaddFL{A}}\DIFaddFL{\textsubscript{area} decreases with LMA, which is not realistic.}}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{LMAms_main_files/figure-latex/PA-NPC-1.pdf}
\caption{\label{fig:PA-NPC}\DIFaddFL{Measured traits related to photosynthesis and metabolism traits (nitrogen and phosphorus per-unit leaf area; }\emph{\DIFaddFL{N}}\DIFaddFL{\textsubscript{area} and }\emph{\DIFaddFL{P}}\DIFaddFL{\textsubscript{area}) are strongly correlated with estimates (posterior medians) of the photosynthetic LMA component (LMAm), and a measured structural trait (cellulose per-unit leaf area; }\emph{\DIFaddFL{CL}}\DIFaddFL{\textsubscript{area}) is strongly correlated with estimates of the structural LMA component (LMAs) for the Panama dataset. Note that sun and shade leaves align along a single relationship for }\emph{\DIFaddFL{CL}}\DIFaddFL{\textsubscript{area} vs.~LMAs, but not for }\emph{\DIFaddFL{CL}}\DIFaddFL{\textsubscript{area} vs.~LMA or LMAm. }\emph{\DIFaddFL{N}}\DIFaddFL{\textsubscript{area}, }\emph{\DIFaddFL{P}}\DIFaddFL{\textsubscript{area}, and }\emph{\DIFaddFL{CL}}\DIFaddFL{\textsubscript{area} data were not used to fit the models, and are presented here as independent support for the model results. Analogous results were obtained for }\emph{\DIFaddFL{N}}\DIFaddFL{\textsubscript{area} and }\emph{\DIFaddFL{P}}\DIFaddFL{\textsubscript{area} vs.~LMAm for GLOPNET (Fig. S3). Others details as in Fig. GL. Results for other LL models are reported in Table SX.}}
\end{figure}
\DIFaddend 
