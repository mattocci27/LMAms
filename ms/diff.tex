...
%DIF ADD ./ms/LMAms_main.tex       Wed Oct 13 15:33:55 2021
...
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \begin{longtable}[t]{lrr}
\DIFaddend \caption{\label{tab:lootab}
      ...
      N; number of samples.}\DIFdelbegin %DIFDELCMD < \tabularnewline
%DIFDELCMD < \toprule
%DIFDELCMD < & %%%
...
%DIFDELCMD < %%%
\DIFdelend \toprule
\DIFaddbegin \DIFadd{Model }\DIFaddend & LOOIC & N\\
\midrule
\DIFdelbegin %DIFDELCMD < \endhead
%DIFDELCMD < %%%
...
\DIFdelbegin \textbf{\DIFdel{Panama}} %DIFAUXCMD
%DIFDELCMD < & & %%%
\DIFdelend \DIFaddbegin \addlinespace[0.3em]
