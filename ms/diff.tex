...
%DIF DEL LMAms_main_old.tex   Fri Aug 20 18:04:47 2021
%DIF ADD LMAms_main.tex       Fri Aug 20 18:03:32 2021
...
\toprule
\DIFdelbegin %DIFDELCMD < \begin{minipage}[b]{0.14\columnwidth}%%%
\DIFdelend \DIFaddbegin \begin{minipage}[b]{\linewidth}\DIFaddend \raggedright
Model
\DIFdelbegin %DIFDELCMD < \strut
%DIFDELCMD < %%%
\DIFdelend \end{minipage} & \DIFdelbegin %DIFDELCMD < \begin{minipage}[b]{0.80\columnwidth}%%%
\DIFdelend \DIFaddbegin \begin{minipage}[b]{\linewidth}\DIFaddend \raggedright
Expected trait values
\DIFdelbegin %DIFDELCMD < \strut
%DIFDELCMD < %%%
\DIFdelend \end{minipage} \DIFdelbegin %DIFDELCMD < \tabularnewline
%DIFDELCMD < %%%
...
\DIFaddend \midrule
\endhead
\DIFdelbegin %DIFDELCMD < \begin{minipage}[t]{0.14\columnwidth}\raggedright
%DIFDELCMD < %%%
\DIFdel{LMA }%DIFDELCMD < \strut
%DIFDELCMD < \end{minipage} %%%
\DIFdelend \DIFaddbegin \DIFadd{LMA }\DIFaddend & \DIFdelbegin %DIFDELCMD < \begin{minipage}[t]{0.80\columnwidth}\raggedright
%DIFDELCMD < %%%
\DIFdelend \(\mathrm{E}[A_{\mathrm{area} \, i}] = \alpha_0\mathrm{LMA}_{i}^{\alpha}\) \DIFdelbegin %DIFDELCMD < \strut
%DIFDELCMD < \end{minipage}\tabularnewline
%DIFDELCMD < \begin{minipage}[t]{0.14\columnwidth}\raggedright
%DIFDELCMD < \strut
%DIFDELCMD < \end{minipage} %%%
\DIFdelend \DIFaddbegin \\
\DIFaddend & \DIFdelbegin %DIFDELCMD < \begin{minipage}[t]{0.80\columnwidth}\raggedright
%DIFDELCMD < %%%
\DIFdelend \(\mathrm{E}[\mathrm{LL}_i] = \beta_0\mathrm{LMA}_{i}^{\beta}\) \DIFdelbegin %DIFDELCMD < \strut
%DIFDELCMD < \end{minipage}\tabularnewline
%DIFDELCMD < \begin{minipage}[t]{0.14\columnwidth}\raggedright
%DIFDELCMD < \strut
%DIFDELCMD < \end{minipage} %%%
...
\DIFaddend & \DIFdelbegin %DIFDELCMD < \begin{minipage}[t]{0.80\columnwidth}\raggedright
%DIFDELCMD < %%%
\DIFdelend \(\mathrm{E}[R_{\mathrm{area} \, i}] = \gamma_0\mathrm{LMA}_{i}^{\gamma}\) \DIFdelbegin %DIFDELCMD < \strut
%DIFDELCMD < \end{minipage}\tabularnewline
%DIFDELCMD < \begin{minipage}[t]{0.14\columnwidth}\raggedright
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \\
\DIFaddend LMA + light \DIFdelbegin %DIFDELCMD < \strut
%DIFDELCMD < \end{minipage} %%%
\DIFdelend & \DIFdelbegin %DIFDELCMD < \begin{minipage}[t]{0.80\columnwidth}\raggedright
%DIFDELCMD < %%%
\DIFdelend \(\mathrm{E}[A_{\mathrm{area} \, i}] = \alpha_0\mathrm{LMA}_{i}^{\alpha}\) \DIFdelbegin %DIFDELCMD < \strut
%DIFDELCMD < \end{minipage}\tabularnewline
%DIFDELCMD < \begin{minipage}[t]{0.14\columnwidth}\raggedright
...
\DIFaddend & \DIFdelbegin %DIFDELCMD < \begin{minipage}[t]{0.80\columnwidth}\raggedright
%DIFDELCMD < %%%
\DIFdelend \(\mathrm{E}[\mathrm{LL}_i] = \beta_0\mathrm{LMA}_{i}^{\beta}exp(\theta Light_i)\) \DIFdelbegin %DIFDELCMD < \strut
%DIFDELCMD < \end{minipage}\tabularnewline
%DIFDELCMD < \begin{minipage}[t]{0.14\columnwidth}\raggedright
%DIFDELCMD < \strut
%DIFDELCMD < \end{minipage} %%%
...
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \\
\DIFaddend LMAm + LMAs \DIFdelbegin %DIFDELCMD < \strut
%DIFDELCMD < \end{minipage} %%%
\DIFdelend & \DIFdelbegin %DIFDELCMD < \begin{minipage}[t]{0.80\columnwidth}\raggedright
%DIFDELCMD < %%%
\DIFdelend \(\mathrm{E}[A_{\mathrm{area} \, i}] = \alpha_0\mathrm{LMAm}_{i}^{\alpha_m} \mathrm{LMAs}_{i}^{\alpha_s}\) \DIFdelbegin %DIFDELCMD < \strut
%DIFDELCMD < \end{minipage}\tabularnewline
%DIFDELCMD < \begin{minipage}[t]{0.14\columnwidth}\raggedright
%DIFDELCMD < \strut
%DIFDELCMD < \end{minipage} %%%
...
\DIFaddend & \DIFdelbegin %DIFDELCMD < \begin{minipage}[t]{0.80\columnwidth}\raggedright
%DIFDELCMD < %%%
\DIFdelend \(\mathrm{E}[\mathrm{LL}_i] = \beta_0\mathrm{LMAm}_{i}^{\beta_m} \mathrm{LMAs}_{i}^{\beta_s}\) \DIFdelbegin %DIFDELCMD < \strut
%DIFDELCMD < \end{minipage}\tabularnewline
%DIFDELCMD < \begin{minipage}[t]{0.14\columnwidth}\raggedright
%DIFDELCMD < \strut
%DIFDELCMD < \end{minipage} %%%
...
\DIFaddend & \DIFdelbegin %DIFDELCMD < \begin{minipage}[t]{0.80\columnwidth}\raggedright
%DIFDELCMD < %%%
\DIFdelend \(\mathrm{E}[R_{\mathrm{area} \, i}] = \gamma_0\mathrm{LMAm}_{i}^{\gamma_m} \mathrm{LMAs}_{i}^{\gamma_s}\) \DIFdelbegin %DIFDELCMD < \strut
%DIFDELCMD < \end{minipage}\tabularnewline
%DIFDELCMD < \begin{minipage}[t]{0.14\columnwidth}\raggedright
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \\
\DIFaddend LMAm + LMAs + light \DIFdelbegin %DIFDELCMD < \strut
%DIFDELCMD < \end{minipage} %%%
\DIFdelend & \DIFdelbegin %DIFDELCMD < \begin{minipage}[t]{0.80\columnwidth}\raggedright
%DIFDELCMD < %%%
\DIFdelend \(\mathrm{E}[A_{\mathrm{area} \, i}]= \alpha_0\mathrm{LMAm}_{i}^{\alpha_m} \mathrm{LMAs}_{i}^{\alpha_s}\) \DIFdelbegin %DIFDELCMD < \strut
...
\DIFaddend & \DIFdelbegin %DIFDELCMD < \begin{minipage}[t]{0.80\columnwidth}\raggedright
%DIFDELCMD < %%%
\DIFdelend \(\mathrm{E}[\mathrm{LL}_i] = \beta_0\mathrm{LMAm}_{i}^{\beta_m} \mathrm{LMAs}_{i}^{\beta_s}exp(\theta Light_i)\) \DIFdelbegin %DIFDELCMD < \strut
%DIFDELCMD < \end{minipage}\tabularnewline
%DIFDELCMD < \begin{minipage}[t]{0.14\columnwidth}\raggedright
%DIFDELCMD < \strut
%DIFDELCMD < \end{minipage} %%%
...
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \\
\DIFaddend LMAm + LMA/LT + light \DIFdelbegin %DIFDELCMD < \strut
%DIFDELCMD < \end{minipage} %%%
\DIFdelend & \DIFdelbegin %DIFDELCMD < \begin{minipage}[t]{0.80\columnwidth}\raggedright
%DIFDELCMD < %%%
\DIFdelend \(\mathrm{E}[A_{\mathrm{area} \, i}]= \alpha_0\mathrm{LMAm}_{i}^{\alpha_m} (\mathrm{LMAs}_{i}/\mathrm{LT}_{i})^{\alpha_s}\) \DIFdelbegin %DIFDELCMD < \strut
%DIFDELCMD < \end{minipage}\tabularnewline
%DIFDELCMD < \begin{minipage}[t]{0.14\columnwidth}\raggedright
%DIFDELCMD < \strut
%DIFDELCMD < \end{minipage} %%%
...
\DIFaddend & \DIFdelbegin %DIFDELCMD < \begin{minipage}[t]{0.80\columnwidth}\raggedright
%DIFDELCMD < %%%
\DIFdelend \(\mathrm{E}[\mathrm{LL}_i] = \beta_0\mathrm{LMAm}_{i}^{\beta_m} (\mathrm{LMAs}_{i}/\mathrm{LT}_{i})^{\beta_s}exp(\theta Light_i)\) \DIFdelbegin %DIFDELCMD < \strut
%DIFDELCMD < \end{minipage}\tabularnewline
%DIFDELCMD < \begin{minipage}[t]{0.14\columnwidth}\raggedright
%DIFDELCMD < \strut
%DIFDELCMD < \end{minipage} %%%
...
\toprule
& LOOIC & N \DIFdelbegin %DIFDELCMD < \tabularnewline
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \\
\DIFaddend \midrule
\endfirsthead
...
\DIFaddend \midrule
\endhead
\textbf{GLOPNET} & & \DIFdelbegin %DIFDELCMD < \tabularnewline
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \\
\DIFaddend LMAm and LMAs & 746 & 198 \DIFdelbegin %DIFDELCMD < \tabularnewline
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \\
\DIFaddend LMA & 766.2 & 198 \DIFdelbegin %DIFDELCMD < \tabularnewline
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \\
\DIFaddend \textbf{Panama} & & \DIFdelbegin %DIFDELCMD < \tabularnewline
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \\
\DIFaddend LMAm + LMAs + light & 501.1 & 106 \DIFdelbegin %DIFDELCMD < \tabularnewline
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \\
\DIFaddend LMA + light & 503 & 106 \DIFdelbegin %DIFDELCMD < \tabularnewline
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \\
\DIFaddend LMAm + LMAs/LT + light & 503.4 & 106 \DIFdelbegin %DIFDELCMD < \tabularnewline
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \\
\DIFaddend LMAm + LMAs & 518.2 & 106 \DIFdelbegin %DIFDELCMD < \tabularnewline
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \\
\DIFaddend LMA & 528.1 & 106 \DIFdelbegin %DIFDELCMD < \tabularnewline
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \\
\DIFaddend \bottomrule
\end{longtable}
...
\toprule
\DIFdelbegin %DIFDELCMD < \begin{minipage}[b]{0.39\columnwidth}%%%
\DIFdelend \DIFaddbegin \begin{minipage}[b]{\linewidth}\DIFaddend \raggedright
Parameters
\DIFdelbegin %DIFDELCMD < \strut
%DIFDELCMD < %%%
\DIFdelend \end{minipage} & \DIFdelbegin %DIFDELCMD < \begin{minipage}[b]{0.26\columnwidth}%%%
\DIFdelend \DIFaddbegin \begin{minipage}[b]{\linewidth}\DIFaddend \raggedright
GLOPNET
\DIFdelbegin %DIFDELCMD < \strut
%DIFDELCMD < %%%
...
\DIFaddend \midrule
\endhead
\DIFdelbegin %DIFDELCMD < \begin{minipage}[t]{0.39\columnwidth}\raggedright
%DIFDELCMD < %%%
\DIFdelend Effect of LMAm on \emph{A}\textsubscript{area} (\(\alpha_m\)) \DIFdelbegin %DIFDELCMD < \strut
%DIFDELCMD < \end{minipage} %%%
\DIFdelend & \DIFdelbegin %DIFDELCMD < \begin{minipage}[t]{0.26\columnwidth}\raggedright
%DIFDELCMD < %%%
\DIFdelend \textbf{0.206 {[}0.108, 0.294{]}} \DIFdelbegin %DIFDELCMD < \strut
%DIFDELCMD < \end{minipage} %%%
\DIFdelend & \DIFdelbegin %DIFDELCMD < \begin{minipage}[t]{0.26\columnwidth}\raggedright
%DIFDELCMD < %%%
\DIFdelend \textbf{0.442 {[}0.338, 0.574{]}} \DIFdelbegin %DIFDELCMD < \strut
%DIFDELCMD < \end{minipage}\tabularnewline
%DIFDELCMD < \begin{minipage}[t]{0.39\columnwidth}\raggedright
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \\
\DIFaddend Effect of LMAs on \emph{A}\textsubscript{area} (\(\alpha_s\)) \DIFdelbegin %DIFDELCMD < \strut
%DIFDELCMD < \end{minipage} %%%
\DIFdelend & \DIFdelbegin %DIFDELCMD < \begin{minipage}[t]{0.26\columnwidth}\raggedright
%DIFDELCMD < %%%
\DIFdelend \textbf{-0.111 {[}-0.179, -0.037{]}} \DIFdelbegin %DIFDELCMD < \strut
%DIFDELCMD < \end{minipage} %%%
\DIFdelend & \DIFdelbegin %DIFDELCMD < \begin{minipage}[t]{0.26\columnwidth}\raggedright
%DIFDELCMD < %%%
\DIFdelend \textbf{0.29 {[}0.16, 0.391{]}} \DIFdelbegin %DIFDELCMD < \strut
%DIFDELCMD < \end{minipage}\tabularnewline
%DIFDELCMD < \begin{minipage}[t]{0.39\columnwidth}\raggedright
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \\
\DIFaddend Effect of LMAm on LL (\(\beta_m\)) \DIFdelbegin %DIFDELCMD < \strut
%DIFDELCMD < \end{minipage} %%%
\DIFdelend & \DIFdelbegin %DIFDELCMD < \begin{minipage}[t]{0.26\columnwidth}\raggedright
%DIFDELCMD < %%%
\DIFdelend \textbf{0.261 {[}0.097, 0.466{]}} \DIFdelbegin %DIFDELCMD < \strut
%DIFDELCMD < \end{minipage} %%%
\DIFdelend & \DIFdelbegin %DIFDELCMD < \begin{minipage}[t]{0.26\columnwidth}\raggedright
%DIFDELCMD < %%%
\DIFdelend 0.086 {[}-0.119, 0.314{]} \DIFdelbegin %DIFDELCMD < \strut
%DIFDELCMD < \end{minipage}\tabularnewline
%DIFDELCMD < \begin{minipage}[t]{0.39\columnwidth}\raggedright
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \\
\DIFaddend Effect of LMAs on LL (\(\beta_s\)) \DIFdelbegin %DIFDELCMD < \strut
%DIFDELCMD < \end{minipage} %%%
\DIFdelend & \DIFdelbegin %DIFDELCMD < \begin{minipage}[t]{0.26\columnwidth}\raggedright
%DIFDELCMD < %%%
\DIFdelend \textbf{0.785 {[}0.627, 0.93{]}} \DIFdelbegin %DIFDELCMD < \strut
%DIFDELCMD < \end{minipage} %%%
\DIFdelend & \DIFdelbegin %DIFDELCMD < \begin{minipage}[t]{0.26\columnwidth}\raggedright
%DIFDELCMD < %%%
\DIFdelend \textbf{0.376 {[}0.172, 0.567{]}} \DIFdelbegin %DIFDELCMD < \strut
%DIFDELCMD < \end{minipage}\tabularnewline
%DIFDELCMD < \begin{minipage}[t]{0.39\columnwidth}\raggedright
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \\
\DIFaddend Effect of LMAm on \emph{R}\textsubscript{area} (\(\gamma_m\)) \DIFdelbegin %DIFDELCMD < \strut
%DIFDELCMD < \end{minipage} %%%
\DIFdelend & \DIFdelbegin %DIFDELCMD < \begin{minipage}[t]{0.26\columnwidth}\raggedright
%DIFDELCMD < %%%
\DIFdelend \textbf{0.218 {[}0.096, 0.316{]}} \DIFdelbegin %DIFDELCMD < \strut
%DIFDELCMD < \end{minipage} %%%
\DIFdelend & \DIFdelbegin %DIFDELCMD < \begin{minipage}[t]{0.26\columnwidth}\raggedright
%DIFDELCMD < %%%
\DIFdelend \textbf{0.6 {[}0.345, 0.822{]}} \DIFdelbegin %DIFDELCMD < \strut
%DIFDELCMD < \end{minipage}\tabularnewline
%DIFDELCMD < \begin{minipage}[t]{0.39\columnwidth}\raggedright
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \\
\DIFaddend Effect of LMAs on \emph{R}\textsubscript{area} (\(\gamma_s\)) \DIFdelbegin %DIFDELCMD < \strut
%DIFDELCMD < \end{minipage} %%%
\DIFdelend & \DIFdelbegin %DIFDELCMD < \begin{minipage}[t]{0.26\columnwidth}\raggedright
%DIFDELCMD < %%%
\DIFdelend 0.049 {[}-0.033, 0.14{]} \DIFdelbegin %DIFDELCMD < \strut
%DIFDELCMD < \end{minipage} %%%
\DIFdelend & \DIFdelbegin %DIFDELCMD < \begin{minipage}[t]{0.26\columnwidth}\raggedright
%DIFDELCMD < %%%
\DIFdelend 0.204 {[}-0.059, 0.469{]} \DIFdelbegin %DIFDELCMD < \strut
%DIFDELCMD < \end{minipage}\tabularnewline
%DIFDELCMD < \begin{minipage}[t]{0.39\columnwidth}\raggedright
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \\
\DIFaddend Effect of light on LL (\(\theta\)) \DIFdelbegin %DIFDELCMD < \strut
%DIFDELCMD < \end{minipage} %%%
\DIFdelend & \DIFdelbegin %DIFDELCMD < \begin{minipage}[t]{0.26\columnwidth}\raggedright
%DIFDELCMD < %%%
\DIFdelend - \DIFdelbegin %DIFDELCMD < \strut
%DIFDELCMD < \end{minipage} %%%
\DIFdelend & \DIFdelbegin %DIFDELCMD < \begin{minipage}[t]{0.26\columnwidth}\raggedright
%DIFDELCMD < %%%
\DIFdelend \textbf{-1.046 {[}-1.471, -0.617{]}} \DIFdelbegin %DIFDELCMD < \strut
%DIFDELCMD < \end{minipage}\tabularnewline
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \\
\DIFaddend \bottomrule
...
\begin{figure}
\centering
\DIFdelbeginFL %DIFDELCMD < \includegraphics{LMAms_main_re_files/figure-latex/Hplt-1.pdf}
%DIFDELCMD < %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics{LMAms_main_files/figure-latex/Hplt-1.pdf}
...
\begin{figure}
\centering
\DIFdelbeginFL %DIFDELCMD < \includegraphics{LMAms_main_re_files/figure-latex/GLplt-1.pdf}
%DIFDELCMD < %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics{LMAms_main_files/figure-latex/GLplt-1.pdf}
...
\begin{figure}
\centering
\DIFdelbeginFL %DIFDELCMD < \includegraphics{LMAms_main_re_files/figure-latex/PAplt-1.pdf}
%DIFDELCMD < %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics{LMAms_main_files/figure-latex/PAplt-1.pdf}
...
\begin{figure}
\centering
\DIFdelbeginFL %DIFDELCMD < \includegraphics{LMAms_main_re_files/figure-latex/LLplt-1.pdf}
%DIFDELCMD < %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics{LMAms_main_files/figure-latex/LLplt-1.pdf}
...
\begin{figure}
\centering
\DIFdelbeginFL %DIFDELCMD < \includegraphics{LMAms_main_re_files/figure-latex/massplt-1.pdf}
%DIFDELCMD < %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics{LMAms_main_files/figure-latex/massplt-1.pdf}
...
\begin{figure}
\centering
\DIFdelbeginFL %DIFDELCMD < \includegraphics{LMAms_main_re_files/figure-latex/boxplt-1.pdf}
%DIFDELCMD < %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics{LMAms_main_files/figure-latex/boxplt-1.pdf}
...
\begin{figure}
\centering
\DIFdelbeginFL %DIFDELCMD < \includegraphics{LMAms_main_re_files/figure-latex/PA-NPC-1.pdf}
%DIFDELCMD < %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics{LMAms_main_files/figure-latex/PA-NPC-1.pdf}
