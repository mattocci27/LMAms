...
%DIF DEL ms/LMAms_main_old.tex   Fri Aug 27 11:07:45 2021
%DIF ADD ms/LMAms_main.tex       Fri Oct 15 18:06:32 2021
...
To avoid this non-identifiability, we explore two methods based on our \DIFdelbegin \DIFdel{assumption }\DIFdelend \DIFaddbegin \DIFadd{biological assumption (following Osnas et al. (}\protect\hyperlink{ref-Osnas2018}{2018}\DIFadd{)) }\DIFaddend that \emph{A}\textsubscript{area} depends more strongly on metabolic leaf mass (LMAp; parameter \DIFdelbegin \DIFdel{\(\alpha_m\) }\DIFdelend \DIFaddbegin \DIFadd{\(\alpha_p\) }\DIFaddend in Eq. \eqref{eq:E-A}) than structural leaf mass (LMAs; parameter \(\alpha_s\) in \DIFdelbegin \DIFdel{Eq}\DIFdelend \DIFaddbegin \DIFadd{Eqs}\DIFaddend . \eqref{eq:E-A}.
...
We created simulated datasets based on a range of assumptions for the LMA variance components: (i) \DIFdelbegin \DIFdel{LMAp variance \textless\textless{} }\DIFdelend \DIFaddbegin \DIFadd{low LMAp variance and high }\DIFaddend LMAs variance, (ii) \DIFdelbegin \DIFdel{LMAp variance = }\DIFdelend \DIFaddbegin \DIFadd{low LMAp variance and low }\DIFaddend LMAs variance, (iii) \DIFdelbegin \DIFdel{LMAp variance \textgreater\textgreater{} }\DIFdelend \DIFaddbegin \DIFadd{high LMAp variance and low }\DIFaddend LMAs variance, (iv) our estimates (posterior means) of LMAp and LMAs variances from GLOPNET, (v) our estimates of LMAp and LMAs variances for Panama sun leaves, and (vi) our estimates of LMAp and LMAs variances for Panama shade leaves.
...
\DIFdelbegin %DIFDELCMD < \hypertarget{tables}{%
%DIFDELCMD < \section{Tables}\label{tables}}
%DIFDELCMD < 

%DIFDELCMD < %%%
\DIFdel{Table: }%DIFDELCMD < \label{tab:modeltab} %%%
\DIFdel{Five model forms compared to predict }\emph{\DIFdel{A}}%DIFAUXCMD
\DIFdel{\textsubscript{area}, LL and }\emph{\DIFdel{R}}%DIFAUXCMD
...
%DIFDELCMD < \centering
%DIFDELCMD < \begin{tabular}[t]{l}
%DIFDELCMD < %%%
\DIFdelendFL \DIFaddbeginFL \begin{longtable}[t]{l}
\caption{\label{tab:modeltab}
        \DIFaddFL{Five model forms compared to predict $A_{area}$, *A*~area~, LL and *R*~area~.
      }}\\
\DIFaddendFL \toprule
...
%DIFDELCMD <   >{\raggedright\arraybackslash}p{(\columnwidth - 4\tabcolsep) * \real{0.4227}}
%DIFDELCMD <   >{\raggedright\arraybackslash}p{(\columnwidth - 4\tabcolsep) * \real{0.2887}}
%DIFDELCMD <   >{\raggedright\arraybackslash}p{(\columnwidth - 4\tabcolsep) * \real{0.2887}}@{}}
%DIFDELCMD < %%%
...
\DIFaddend \caption{\label{tab:paratab} Posterior \DIFdelbegin \DIFdel{medians }\DIFdelend \DIFaddbegin \DIFadd{means }\DIFaddend {[}95\% credible interval{]} of parameters for the best models. `LMAp + LMAs model' and `LMAp + LMAs + light model' are shown for GLOPNET and Panama data, respectively. Bold values are significantly different from zero based on the 95\% credible interval.}\tabularnewline
\toprule
...
\midrule
\endhead
Effect of LMAp on \emph{A}\textsubscript{area} (\(\alpha_p\)) & \textbf{\DIFdelbegin \DIFdel{0.206 }\DIFdelend \DIFaddbegin \DIFadd{0.283 }\DIFaddend {[}\DIFdelbegin \DIFdel{0.108}\DIFdelend \DIFaddbegin \DIFadd{0.207}\DIFaddend , \DIFdelbegin \DIFdel{0.294}\DIFdelend \DIFaddbegin \DIFadd{0.358}\DIFaddend {]}} & \textbf{\DIFdelbegin \DIFdel{0.442 }\DIFdelend \DIFaddbegin \DIFadd{0.552 }\DIFaddend {[}\DIFdelbegin \DIFdel{0.338}\DIFdelend \DIFaddbegin \DIFadd{0.404}\DIFaddend , \DIFdelbegin \DIFdel{0.574}\DIFdelend \DIFaddbegin \DIFadd{0.702}\DIFaddend {]}} \\
Effect of LMAs on \emph{A}\textsubscript{area} (\(\alpha_s\)) & \textbf{\DIFdelbegin \DIFdel{-0.111 }\DIFdelend \DIFaddbegin \DIFadd{-0.132 }\DIFaddend {[}\DIFdelbegin \DIFdel{-0.179}\DIFdelend \DIFaddbegin \DIFadd{-0.201}\DIFaddend , \DIFdelbegin \DIFdel{-0.037}\DIFdelend \DIFaddbegin \DIFadd{-0.06}\DIFaddend {]}} & \DIFdelbegin \textbf{\DIFdel{0.29 }%DIFDELCMD < {[}%%%
\DIFdel{0.16, 0.391}%DIFDELCMD < {]}%%%
} %DIFAUXCMD
\DIFdelend \DIFaddbegin \DIFadd{- }\DIFaddend \\
Effect of \DIFdelbegin \DIFdel{LMAp on LL (\(\beta_p\)) }%DIFDELCMD < & %%%
\textbf{\DIFdel{0.261 }%DIFDELCMD < {[}%%%
\DIFdel{0.097, 0.466}%DIFDELCMD < {]}%%%
} %DIFAUXCMD
%DIFDELCMD < & %%%
\DIFdel{0.086 }%DIFDELCMD < {[}%%%
\DIFdel{-0.119, 0.314}%DIFDELCMD < {]} \\
%DIFDELCMD < %%%
\DIFdel{Effect of }\DIFdelend LMAs on LL (\(\beta_s\)) & \textbf{\DIFdelbegin \DIFdel{0.785 }\DIFdelend \DIFaddbegin \DIFadd{0.887 }\DIFaddend {[}\DIFdelbegin \DIFdel{0.627}\DIFdelend \DIFaddbegin \DIFadd{0.765}\DIFaddend , \DIFdelbegin \DIFdel{0.93}\DIFdelend \DIFaddbegin \DIFadd{1.017}\DIFaddend {]}} & \textbf{\DIFdelbegin \DIFdel{0.376 }\DIFdelend \DIFaddbegin \DIFadd{0.367 }\DIFaddend {[}\DIFdelbegin \DIFdel{0.172}\DIFdelend \DIFaddbegin \DIFadd{0.188}\DIFaddend , \DIFdelbegin \DIFdel{0.567}\DIFdelend \DIFaddbegin \DIFadd{0.55}\DIFaddend {]}} \\
Effect of LMAp on \emph{R}\textsubscript{area} (\(\gamma_p\)) & \textbf{\DIFdelbegin \DIFdel{0.218 }\DIFdelend \DIFaddbegin \DIFadd{0.294 }\DIFaddend {[}\DIFdelbegin \DIFdel{0.096}\DIFdelend \DIFaddbegin \DIFadd{0.21}\DIFaddend , \DIFdelbegin \DIFdel{0.316}\DIFdelend \DIFaddbegin \DIFadd{0.387}\DIFaddend {]}} & \textbf{\DIFdelbegin \DIFdel{0.6 }\DIFdelend \DIFaddbegin \DIFadd{0.651 }\DIFaddend {[}\DIFdelbegin \DIFdel{0.345}\DIFdelend \DIFaddbegin \DIFadd{0.438}\DIFaddend , \DIFdelbegin \DIFdel{0.822}\DIFdelend \DIFaddbegin \DIFadd{0.851}\DIFaddend {]}} \\
Effect of LMAs on \emph{R}\textsubscript{area} (\(\gamma_s\)) & \DIFdelbegin \DIFdel{0.049 }\DIFdelend \DIFaddbegin \DIFadd{0.033 }\DIFaddend {[}\DIFdelbegin \DIFdel{-0.033, 0.14}\DIFdelend \DIFaddbegin \DIFadd{-0.045, 0.114}\DIFaddend {]} & \DIFdelbegin \DIFdel{0.204 }\DIFdelend \DIFaddbegin \DIFadd{-0.012 }\DIFaddend {[}\DIFdelbegin \DIFdel{-0.059, 0.469}\DIFdelend \DIFaddbegin \DIFadd{-0.276, 0.302}\DIFaddend {]} \\
Effect of light on LL (\(\theta\)) & - & \textbf{\DIFdelbegin \DIFdel{-1.046 }\DIFdelend \DIFaddbegin \DIFadd{-0.804 }\DIFaddend {[}\DIFdelbegin \DIFdel{-1.471}\DIFdelend \DIFaddbegin \DIFadd{-1.104}\DIFaddend , \DIFdelbegin \DIFdel{-0.617}\DIFdelend \DIFaddbegin \DIFadd{-0.525}\DIFaddend {]}} \\
\bottomrule
\end{longtable}
