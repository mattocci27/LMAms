...
![
The relationships between mass dependency (*b* in Eq. 5 in the main tex) and relative variance in LMAs to LMA for the different ranges of the scaling exponent $\alpha_p$ and $\alpha_s$.
