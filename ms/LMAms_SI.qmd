...
## `r s_figure("mass_prop_sim")`

![](`r here("figs/mass_prop_sim.png")`){#fig-mass_prop_sim}

**`r s_figure("mass_prop_sim")`**:
The relationships between mass dependency (*b* in Eq. \ref{eq-mass} in the main text) and relative variance in LMAs to LMA for the different ranges of the scaling exponent $\alpha_m$ and $\alpha_s$.
