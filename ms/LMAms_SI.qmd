...
# `r appendix("model-para")`: Model parametrization
...
Models fit to the randomized datasets either did not converge or showed divergent transitions (Appendix S2), indicating that models fit to randomized data do not provide reliable inferences [@Betancourt2016].
...
# `r appendix("mass-prop")`: Understanding relationships between photosynthetic capacity and LMA
...
# `r appendix("mass-prop-sim")`: Simulated datasets to study relationships between photosynthetic capacity and LMA
