...
Models fit to the randomized datasets either did not converge or showed divergent transitions (Table AS1, Figure AS1-2), indicating that models fit to randomized data do not provide reliable inferences [@Betancourt2016].
...
# Simulated datasets to study relationships between photosynthetic capacity and LMA
