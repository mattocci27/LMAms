...
Although Panama sun and shade leaves were analyzed together when fitting the LMAm-LMAs models (Eqs. `r eq_num("Aarea")`-`r eq_num("LL")`), they were analyzed separately here due to their different estimated covariance structures (`r fig("mass_prop")`, Figs. S4-S5).
