...
%DIF DEL LMAms_main_old.tex   Wed Aug 21 06:40:10 2024
%DIF ADD LMAms_main.tex       Wed Aug 21 05:55:21 2024
...
components (Appendices 1-2). \DIFdelbegin \DIFdel{By using power-law relationships, our
...
cannot be neatly classified as `metabolic' or `structural'. }\DIFdelend We fit the models to two datasets: the
GLOPNET global leaf traits dataset (\citeproc{ref-Wright2004a}{Wright et
al., 2004}), which primarily represents interspecific variation; and the
Panama dataset described by Osnas et al.
(\citeproc{ref-Osnas2018}{2018}), which includes traits for both sun and
...
Although \DIFdelbegin \DIFdel{values of }\DIFdelend \DIFaddbegin \DIFadd{the index of mass-dependence (}\DIFaddend \emph{b}\DIFaddbegin \DIFadd{; Eq. S5) can,
...
(}\emph{\DIFaddFL{b}} \DIFaddFL{in Eq. S5) and LMAs variance (relative to total LMA variance;
...
(}\emph{\DIFaddFL{A}}\DIFaddFL{\textsubscript{max}) is is primarily mass-dependent (}\emph{\DIFaddFL{b}}
\DIFaddFL{\textgreater{} 0.5) or primarily area-dependent (0.5 \textgreater{}
}\emph{\DIFaddFL{b}} \DIFaddFL{\textgreater{} 0), with }\emph{\DIFaddFL{b}} \DIFaddFL{near 0 indicating purely
area-dependence (\mbox{%DIFAUXCMD
\citeproc{ref-Osnas2018}{Osnas et al., 2018}}\hspace{0pt}%DIFAUXCMD
). If
}\emph{\DIFaddFL{b}} \DIFaddFL{\textgreater{} 1, then }\emph{\DIFaddFL{A}}\DIFaddFL{\textsubscript{max} increases
exponentially with LMA, which is not consistent with observed
relationships (\mbox{%DIFAUXCMD
\citeproc{ref-Osnas2018}{Osnas et al., 2018}}\hspace{0pt}%DIFAUXCMD
). See
Appendices 4-6 for details.}\DIFaddendFL }
