...
%DIF DEL LMAms_main_old.tex   Tue Aug 20 02:49:13 2024
%DIF ADD LMAms_main.tex       Tue Aug 20 02:48:41 2024
...
multi-dimensionality would, however, have }\DIFaddend important implications for \DIFdelbegin \DIFdel{how trait variation is represented }\DIFdelend \DIFaddbegin \DIFadd{our
...
accurately represent trait variation }\DIFaddend in ecosystem models\DIFdelbegin \DIFdel{(\mbox{%DIFAUXCMD
...
dynamic global vegetation models }{[}\DIFadd{DGVMs; e.g., Bonan et al.
(\mbox{%DIFAUXCMD
\citeproc{ref-Bonan2002}{2002}}\hspace{0pt}%DIFAUXCMD
); Fisher et al.
(\mbox{%DIFAUXCMD
\citeproc{ref-Fisher2015}{2015}}\hspace{0pt}%DIFAUXCMD
); Sakschewski et al.
(\mbox{%DIFAUXCMD
\citeproc{ref-Sakschewski2016}{2016}}\hspace{0pt}%DIFAUXCMD
)}{]}\DIFaddend .
...
indicating purely area-dependendence (\citeproc{ref-Osnas2018}{Osnas et
...
(\citeproc{ref-Osnas2018}{Osnas et al., 2018}). See Appendices S8-S4 for
