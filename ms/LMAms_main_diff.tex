...
%DIF DEL LMAms_main_old.tex   Fri Oct 25 07:07:36 2024
%DIF ADD LMAms_main.tex       Fri Oct 25 07:07:17 2024
...
\emph{A}\textsubscript{max} and LMA\DIFdelbegin \DIFdel{(Supplementary Section 4), we simulated datasets varying in }\DIFdelend \DIFaddbegin \DIFadd{, we generated simulated datasets
with different }\emph{\DIFadd{A}}\DIFadd{\textsubscript{area}-LMAm relationships and
different }\DIFaddend LMAm and LMAs \DIFaddbegin \DIFadd{variances }\DIFaddend (Supplementary Section \DIFdelbegin \DIFdel{8). This approach allows us to directly examine the cause of }\DIFdelend \DIFaddbegin \DIFadd{5). For each
simulated dataset, we quantified the }\DIFaddend mass-dependence of
\emph{A}\textsubscript{max} in relation to LMA, which we quantified as
the scaling exponent of \emph{A}\textsubscript{max} with LMA \DIFdelbegin \DIFdel{(Supplementary Section 4) }\DIFdelend following
...
LMAs (Fig.~\ref{fig-vpart}a-b), the }\DIFdelend \DIFaddbegin \DIFadd{Figs. S1a-b). The }\DIFaddend higher total LMA in evergreen compared to deciduous
...
\DIFdelbegin \DIFdel{much }\DIFdelend more variation in LMAm than LMAs, whereas site (wet vs.~dry) explained
...
greater \DIFdelbegin \DIFdel{LMAs when we compared the same
canopy strata }\DIFdelend \DIFaddbegin \DIFadd{wet-site LMAs for both sun and shade leaves }\DIFaddend (Figs.
...
and \DIFdelbegin \DIFdel{S1). Thus, }\DIFdelend \DIFaddbegin \DIFadd{S2b). }\DIFaddend LMAs comprised a larger fraction of total LMA for shade leaves
...
Supplementary Section 7). As expected}\DIFaddend , mass-dependence of
...
\DIFdelbegin \DIFdel{and }\DIFdelend \DIFaddbegin \DIFadd{vs.~}\DIFaddend \textasciitilde40\% for deciduous species (Fig. \DIFdelbegin \DIFdel{S2}\DIFdelend \DIFaddbegin \DIFadd{S3}\DIFaddend ), and
...
\DIFdelbegin \DIFdel{Bonan, G.B.
, Levis, S., Kergoat, L. , Oleson, K. W. , 2002. }\DIFdelend \DIFaddbegin \DIFadd{Bonan et al. (2002) }\DIFaddend Landscapes as patches of plant functional types:
...
Muller-Landau, H.C., Powell, T.L., Serbin, S.P.
, Sato, H., Shuman, J.K.,
...
\DIFdelbegin \DIFdel{Gelman, A.
, Carlin, J.B., Stern, H.S., Dunson, D.B. , Vehtari, A., Rubin,
D.
B.
...
P.W., Wright, S.
J., 2012. How cellulose-based leaf toughness and lamina
density contribute to long leaf lifespans of shade-tolerant species. New
...
\DIFdel{Westoby, M.
, Warton, D., Reich, P.B., 2000. The }%DIFDELCMD < {%%%
...
Supplementary Sections 4-5 for details.}\DIFaddendFL }
