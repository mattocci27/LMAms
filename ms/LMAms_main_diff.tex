...
%DIF DEL LMAms_main_old.tex   Wed Oct 23 09:29:48 2024
%DIF ADD LMAms_main.tex       Wed Oct 23 09:28:58 2024
...
into two \DIFdelbegin \DIFdel{conceptual }\DIFdelend components -- metabolic LMAm (which determines photosynthetic
capacity and dark respiration) and structural LMAs (which determines
leaf toughness and potential leaf lifespan) \DIFdelbegin \DIFdel{- }\DIFdelend \DIFaddbegin \DIFadd{-- }\DIFaddend using leaf trait data
...
variation (photosynthesis, respiration, and lifespan) \DIFaddbegin \DIFadd{within and among
species}\DIFaddend . We show that strong area-dependence of metabolic traits across
...
datasets\DIFdelbegin \DIFdel{. Our
results explain different patterns in variation in LMA between across-
versus within-species. Additionally, our analysis highlights that }\DIFdelend \DIFaddbegin \DIFadd{, suggesting the presence of at least two important dimensions
of }\DIFaddend leaf functional variation\DIFdelbegin \DIFdel{is multi-dimensional, suggesting that
biogeochemical models should treat metabolic and structural leaf
components separately}\DIFdelend .
...
\citeproc{ref-Wright2004a}{Wright IJ et al.
2004}}\hspace{0pt}%DIFAUXCMD
; \mbox{%DIFAUXCMD
\citeproc{ref-Reich2014}{Reich PB 2014}}\hspace{0pt}%DIFAUXCMD
;
\mbox{%DIFAUXCMD
\citeproc{ref-Onoda2017}{Onoda Y et al. 2017}}\hspace{0pt}%DIFAUXCMD
}\DIFaddend ) and in carbon and
nutrient cycling (\DIFaddbegin \DIFadd{\mbox{%DIFAUXCMD
\citeproc{ref-Tcherkez2017}{Tcherkez G et al. 2017}}\hspace{0pt}%DIFAUXCMD
;
}\DIFaddend e.g., \DIFdelbegin \DIFdel{\mbox{%DIFAUXCMD
...
\citeproc{ref-Huntingford2017}{Huntingford C et al. 2017}}\hspace{0pt}%DIFAUXCMD
}\DIFaddend ). Thus,
...
\citeproc{ref-Bonan2002}{Bonan GB et al. 2002}}\hspace{0pt}%DIFAUXCMD
;
\mbox{%DIFAUXCMD
\citeproc{ref-Poorter2009}{Poorter H et al. 2009}}\hspace{0pt}%DIFAUXCMD
...
\citeproc{ref-Osnas2013}{Osnas JLD et al. 2013}}\hspace{0pt}%DIFAUXCMD
...
\citeproc{ref-Osada2001}{Osada N et al.
2001}}\hspace{0pt}%DIFAUXCMD
; \mbox{%DIFAUXCMD
\citeproc{ref-Niinemets2015}{Niinemets Ü et al. 2015}}\hspace{0pt}%DIFAUXCMD
;
\mbox{%DIFAUXCMD
\citeproc{ref-Osnas2018}{Osnas JLD et al. 2018}}\hspace{0pt}%DIFAUXCMD
...
on leaf mass and area (\DIFdelbegin \DIFdel{\mbox{%DIFAUXCMD
\citeproc{ref-Lusk2008}{Lusk et al., 2008}}\hspace{0pt}%DIFAUXCMD
;
\mbox{%DIFAUXCMD
\citeproc{ref-Osnas2018}{Osnas et al., 2018}}\hspace{0pt}%DIFAUXCMD
}\DIFdelend \DIFaddbegin \DIFadd{\mbox{%DIFAUXCMD
\citeproc{ref-Lusk2008}{Lusk CH et al. 2008}}\hspace{0pt}%DIFAUXCMD
;
\mbox{%DIFAUXCMD
\citeproc{ref-Osnas2018}{Osnas JLD et al. 2018}}\hspace{0pt}%DIFAUXCMD
}\DIFaddend ). These divergent
...
\citeproc{ref-Wright2004a}{Wright IJ et al. 2004}}\hspace{0pt}%DIFAUXCMD
...
\citeproc{ref-Lloyd2013}{Lloyd J et al. 2013}}\hspace{0pt}%DIFAUXCMD
;
\mbox{%DIFAUXCMD
\citeproc{ref-Osnas2013}{Osnas JLD et al. 2013}}\hspace{0pt}%DIFAUXCMD
}\DIFaddend ), is controversial. On
...
\citeproc{ref-Kikuzawa1991}{Kikuzawa K 1991}}\hspace{0pt}%DIFAUXCMD
;
\mbox{%DIFAUXCMD
\citeproc{ref-Westoby2013}{Westoby M et al. 2013}}\hspace{0pt}%DIFAUXCMD
...
the other hand, because the lifetime return on investment depends on LL
(\DIFdelbegin \DIFdel{\mbox{%DIFAUXCMD
...
), traits should be normalized by their }\DIFdelend \DIFaddbegin \DIFadd{\mbox{%DIFAUXCMD
\citeproc{ref-Westoby2000}{Westoby M et al. 2000}}\hspace{0pt}%DIFAUXCMD
;
\mbox{%DIFAUXCMD
\citeproc{ref-Falster2012}{Falster DS et al. 2012}}\hspace{0pt}%DIFAUXCMD
), leaf economics
analyses should arguably use }\DIFaddend annualized construction costs (or mass/LL),
\DIFdelbegin \DIFdel{which
should be used as a normalizer in leaf economics analyses
(\mbox{%DIFAUXCMD
\citeproc{ref-Osnas2013}{Osnas et al., 2013}}\hspace{0pt}%DIFAUXCMD
}\DIFdelend \DIFaddbegin \DIFadd{rather than mass }\emph{\DIFadd{per se}}\DIFadd{, as an index of leaf cost
(\mbox{%DIFAUXCMD
\citeproc{ref-Osnas2013}{Osnas JLD et al. 2013}}\hspace{0pt}%DIFAUXCMD
...
\DIFaddend Area-dependence of metabolic traits and the inconsistent correlation
...
mass-normalization or the LES (\mbox{%DIFAUXCMD
\citeproc{ref-Westoby2013}{Westoby et
al., 2013}}\hspace{0pt}%DIFAUXCMD
). These considerations do, however, lead us to question the
}\DIFdelend \DIFaddbegin \DIFadd{\mbox{%DIFAUXCMD
\citeproc{ref-Lloyd2013}{Lloyd J et al. 2013}}\hspace{0pt}%DIFAUXCMD
;
\mbox{%DIFAUXCMD
...
}\DIFaddend evidence for a single dominant axis of leaf functional diversity\DIFdelbegin \DIFdel{, which
has }\DIFdelend \DIFaddbegin \DIFadd{. The
existence of multiple important axes of leaf functional diversity would
not invalidate mass-normalization or the LES
(\mbox{%DIFAUXCMD
\citeproc{ref-Westoby2013}{Westoby M et al. 2013}}\hspace{0pt}%DIFAUXCMD
). This
multi-dimensionality would, however, have }\DIFaddend important implications for \DIFdelbegin \DIFdel{how trait variation is represented in ecosystem models (\mbox{%DIFAUXCMD
\citeproc{ref-Bonan2002}{Bonan et al., 2002}}\hspace{0pt}%DIFAUXCMD
;
\mbox{%DIFAUXCMD
...
hand,
mass-normalization has been justified based on economic principles
...
\citeproc{ref-Wright2004a}{Wright et al., 2004}}\hspace{0pt}%DIFAUXCMD
}\DIFdelend \DIFaddbegin \DIFadd{our
understanding of leaf function (\mbox{%DIFAUXCMD
\citeproc{ref-Niinemets2006a}{Niinemets
Ü, Sack L 2006}}\hspace{0pt}%DIFAUXCMD
; \mbox{%DIFAUXCMD
\citeproc{ref-Onoda2017}{Onoda Y et al. 2017}}\hspace{0pt}%DIFAUXCMD
), the
role of trait variation in community assembly (e.g.,
\mbox{%DIFAUXCMD
\citeproc{ref-Falster2017}{Falster DS et al. 2017}}\hspace{0pt}%DIFAUXCMD
;
\mbox{%DIFAUXCMD
\citeproc{ref-Lichstein2021}{Lichstein JW et al. 2021}}\hspace{0pt}%DIFAUXCMD
), and how to
...
Fisher et al., 2015; Sakschewski et al., 2016}\DIFaddend ).
...
variation, consider the conceptual model proposed by Osnas \DIFaddbegin \DIFadd{JLD }\DIFaddend et al.
...
\citeproc{ref-Kitajima2012}{Kitajima K et al. 2012}}\hspace{0pt}%DIFAUXCMD
,
\mbox{%DIFAUXCMD
\citeproc{ref-Kitajima2016}{2016}}\hspace{0pt}%DIFAUXCMD
; \mbox{%DIFAUXCMD
\citeproc{ref-Onoda2017}{Onoda Y et
al. 2017}}\hspace{0pt}%DIFAUXCMD
...
models with different numbers of dimensions \DIFdelbegin \DIFdel{, }\DIFdelend and to ask if models with
...
by Osnas \DIFaddbegin \DIFadd{JLD }\DIFaddend et al. (\citeproc{ref-Osnas2018}{2018}) could be compared
to a one-dimensional LMA model in terms of their capacities to explain
variation in other traits. However, implementing the `LMAm-LMAs' model
is challenging \DIFdelbegin \DIFdel{,
}\DIFdelend because although certain leaf mass components can be
...
\citeproc{ref-Onoda2015}{Onoda Y et al. 2015}}\hspace{0pt}%DIFAUXCMD
}\DIFaddend ),
but at least some cell wall mass is required for the biomechanical
support that enables photosynthesis. Thus, partitioning LMA into
different functional components requires novel empirical or modeling
approaches.
...
\section{\DIFdelbegin \DIFdel{Material }\DIFdelend \DIFaddbegin \DIFadd{Materials }\DIFaddend and \DIFdelbegin \DIFdel{Methods}\DIFdelend \DIFaddbegin \DIFadd{methods}\DIFaddend }\DIFdelbegin %DIFDELCMD < \label{material-and-methods}
%DIFDELCMD < %%%
...
analysis of Wright \DIFaddbegin \DIFadd{IJ }\DIFaddend et al. (\citeproc{ref-Wright2004a}{2004}). For
...
components (\DIFdelbegin \DIFdel{Appendices }\DIFdelend \DIFaddbegin \DIFadd{In the following section and Supplementary Sections }\DIFaddend 1-2). \DIFdelbegin \DIFdel{By using power-law relationships, our
...
cannot be neatly classified as `metabolic' or `structural'. }\DIFdelend We
...
Osnas \DIFaddbegin \DIFadd{JLD }\DIFaddend et al. (\citeproc{ref-Osnas2018}{2018}), which includes traits
for both sun and shade leaves at wet and dry tropical forest sites.
Because LMAm and LMAs are modeled (rather than observed), the
...
dataset) to partition observed LMA into LMAm and LMAs. Given the large
number of parameters in these models, we performed tests with randomized
data to evaluate if our two-dimensional models were prone to creating
patterns from noise, which could lead to spurious conclusions. These
tests suggested that our two-dimensional modeling approach revealed
meaningful patterns in the observed trait data (Supplementary Section
3). \DIFaddbegin \DIFadd{We then used the model predictions to study how LMAm and LMAs
contribute to LMA variance, evergreen-deciduous LMA differences, and
sun-shade LMA differences (Supplementary Section 4).
}\DIFaddend 

To better understand the factors affecting relationships between
\emph{A}\textsubscript{max} and LMA (Supplementary Section \DIFdelbegin \DIFdel{4}\DIFdelend \DIFaddbegin \DIFadd{5}\DIFaddend ), we
\DIFdelbegin \DIFdel{simulated datasets varying in }\DIFdelend \DIFaddbegin \DIFadd{generated simulated datasets with different
}\emph{\DIFadd{A}}\DIFadd{\textsubscript{area}-LMAm relationships and different }\DIFaddend LMAm and
LMAs \DIFaddbegin \DIFadd{variances }\DIFaddend (Supplementary Section \DIFdelbegin \DIFdel{8). This approach allows us to directly examine the cause of }\DIFdelend \DIFaddbegin \DIFadd{6). For each simulated dataset, we
quantified the }\DIFaddend mass-dependence of \emph{A}\textsubscript{max} in
relation to LMA, which we quantified as the scaling exponent of
\emph{A}\textsubscript{max} with LMA (Supplementary Section \DIFdelbegin \DIFdel{4}\DIFdelend \DIFaddbegin \DIFadd{5}\DIFaddend ) following
Osnas \DIFaddbegin \DIFadd{JLD }\DIFaddend et al. (\DIFdelbegin \DIFdel{\mbox{%DIFAUXCMD
\citeproc{ref-Osnas2013}{2013}}\hspace{0pt}%DIFAUXCMD
). Additionally, we performed variance
partitioning to determine the contributions of LMAm and LMAs to total
LMA variance, using both simulated and actual datasets (Supplementary
Section 6).
These analyses are key in exploring the controversial mass
versus area normalization debate in leaf trait analysis.
}\DIFdelend \DIFaddbegin \DIFadd{\mbox{%DIFAUXCMD
...
\citeproc{ref-Landau2021}{Landau WM 2021}}\hspace{0pt}%DIFAUXCMD
).
}\DIFaddend 
...
\DIFdelbegin \[
\DIFdel{\mathrm{E[LL}_i}] \DIFdel{= \beta_0\mathrm{LMAm}_{i}^{\beta_m} \mathrm{LMAs}_{i}^{\beta_s} \mathrm{exp}(\theta \mathrm{Light}_i) \qquad(4\mathrm{b})
}\]%DIFAUXCMD
%DIFDELCMD < 

%DIFDELCMD < %%%
\DIFdelend where E{[}\(\cdot\){]} indicates expected value; the \(\alpha\),
...
performed better than the power-law forms and are not \DIFdelbegin \DIFdel{discussed further}\DIFdelend \DIFaddbegin \DIFadd{presented}\DIFaddend .

We \DIFdelbegin \DIFdel{also considered models in which }\DIFdelend \DIFaddbegin \DIFadd{considered two alternatives to Eq. 4a for modeling LL. First, we
...
gradients (\mbox{%DIFAUXCMD
\citeproc{ref-Lusk2008}{Lusk CH et al. 2008}}\hspace{0pt}%DIFAUXCMD
;
\mbox{%DIFAUXCMD
\citeproc{ref-Russo2016}{Russo SE, Kitajima K 2016}}\hspace{0pt}%DIFAUXCMD
;
\mbox{%DIFAUXCMD
\citeproc{ref-Osnas2018}{Osnas JLD et al. 2018}}\hspace{0pt}%DIFAUXCMD
). Mechanistically
...
(\mbox{%DIFAUXCMD
\citeproc{ref-Xu2017}{Xu X et al. 2017}}\hspace{0pt}%DIFAUXCMD
...
\DIFadd{where Light\textsubscript{\emph{i}} is a dummy variable equal to 1 or 0
for sun or shade leaves, respectively; \(\theta\) is a fitted parameter;
and exp(\(\theta\)) is the sun:shade LL ratio.
}

\DIFadd{The second alternative for LL involved replacing }\DIFaddend LMAs in Eq. \DIFdelbegin \DIFdel{4 was replaced }\DIFdelend \DIFaddbegin \DIFadd{4a and 4b
}\DIFaddend by leaf structural density (\DIFaddbegin \DIFadd{LSD = }\DIFaddend LMAs/LT, where LT is leaf thickness),
...
%DIFDELCMD < %%%
\DIFdel{For example }\DIFdelend \DIFaddbegin \DIFadd{\mbox{%DIFAUXCMD
\citeproc{ref-Kitajima2012}{Kitajima K et al. 2012}}\hspace{0pt}%DIFAUXCMD
,
\mbox{%DIFAUXCMD
...
\DIFadd{The LMAm-LMAs model framework (Eqs. 1-4) has multiple identical
solutions due to the mathematical exchangeability of LMAm and LMAs in
Eq. 1. For example in Eq. 2}\DIFaddend , the parameter set of {[}\(\alpha_m\),
\(\alpha_s\), \(f_i\){]} with values {[}0.3, 0.6, 0.2{]} produces the
same model output as the set {[}0.6, 0.3, 0.8{]}\DIFdelbegin \DIFdel{in Eq. 2. }\DIFdelend \DIFaddbegin \DIFadd{. }\DIFaddend To ensure that the
model was identifiable, we imposed two broad assumptions: (i)
\emph{A}\textsubscript{area} depends more strongly on \DIFdelbegin \DIFdel{metabolic leaf
mass (LMAm : parameter \(\alpha_m\) in Eq. 2) than structural leaf mass
(LMAs: parameter \(\alpha_s\))}\DIFdelend \DIFaddbegin \DIFadd{LMAm than on LMAs}\DIFaddend ,
and (ii) LL depends more strongly on LMAs \DIFdelbegin \DIFdel{(\(\beta_s\) in Eq. 4 than LMAm (\(\beta_m\)). The
first assumption
...
constraint \(\beta_s\) \textgreater{} \(\beta_m\). See }\DIFdelend \DIFaddbegin \DIFadd{than on LMAm. The
implementation of these assumptions is described in }\DIFaddend Table 1 and
Supplementary Section \DIFdelbegin \DIFdel{2 for more detail.
}%DIFDELCMD < 

%DIFDELCMD < %%%
\DIFdel{Finally, we considered a functional form that accounts for the effects
...
The GLOPNET data primarily \DIFdelbegin \DIFdel{represents }\DIFdelend \DIFaddbegin \DIFadd{represent }\DIFaddend interspecific variation (the
...
\citeproc{ref-Wright2003}{Wright SJ et al. 2003}}\hspace{0pt}%DIFAUXCMD
}\DIFaddend ). The wet SL site is
an evergreen Caribbean coastal forest with 3100 mm of annual rainfall
(\DIFdelbegin \DIFdel{\mbox{%DIFAUXCMD
\citeproc{ref-Wright2003}{Wright et al., 2003}}\hspace{0pt}%DIFAUXCMD
}\DIFdelend \DIFaddbegin \DIFadd{\mbox{%DIFAUXCMD
\citeproc{ref-Wright2003}{Wright SJ et al. 2003}}\hspace{0pt}%DIFAUXCMD
}\DIFaddend ). Additional details
of the Panama dataset are described in Osnas \DIFaddbegin \DIFadd{JLD }\DIFaddend et al.
...
additional traits that we used to interpret model results, but \DIFdelbegin \DIFdel{which
}\DIFdelend \DIFaddbegin \DIFadd{that }\DIFaddend were
...
model LL for Panama, we \DIFdelbegin \DIFdel{also used Eq. }\DIFdelend \DIFaddbegin \DIFadd{used both Eqs. 4a and }\DIFaddend 4b (light effects model)\DIFdelbegin \DIFdel{, which
was motivated by the negative intraspecific LL-LMA relationship observed
in Panama (\mbox{%DIFAUXCMD
\citeproc{ref-Osnas2018}{Osnas et al., 2018}}\hspace{0pt}%DIFAUXCMD
;
\mbox{%DIFAUXCMD
\citeproc{ref-Xu2017}{Xu et al., 2017}}\hspace{0pt}%DIFAUXCMD
...
structural density (LSD = LMAs/LT}\DIFaddend ).
...
\citeproc{ref-Carpenter2017}{Carpenter B et al. 2017}}\hspace{0pt}%DIFAUXCMD
}\DIFaddend ). We used
non-informative or weakly informative prior distributions
(\DIFdelbegin \DIFdel{\mbox{%DIFAUXCMD
\citeproc{ref-Lemoine2019}{Lemoine, 2019}}\hspace{0pt}%DIFAUXCMD
}\DIFdelend \DIFaddbegin \DIFadd{\mbox{%DIFAUXCMD
\citeproc{ref-Lemoine2019}{Lemoine NP 2019}}\hspace{0pt}%DIFAUXCMD
}\DIFaddend ). Prior distributions for
the latent variables \emph{f\textsubscript{i}} (which \DIFdelbegin \DIFdel{are used to }\DIFdelend partition LMA into
...
data). See Supplementary Section 1 for more details. \DIFdelbegin \DIFdel{The
Stan code use to fit models is available from Github at:
}%DIFDELCMD < \url{https://github.com/mattocci27/LMAms}%%%
\DIFdel{. }\DIFdelend Convergence of the
...
\citeproc{ref-Gelman2013}{Gelman A et al. 2013}}\hspace{0pt}%DIFAUXCMD
}\DIFaddend ).
...
\citeproc{ref-Vehtari2017}{Vehtari A et al. 2017}}\hspace{0pt}%DIFAUXCMD
...
\subsection{\DIFdelbegin %DIFDELCMD < \texorpdfstring{Decomposing LMA into metabolic and
%DIFDELCMD < structural components leads to improved predictions of
%DIFDELCMD < \emph{A}\textsubscript{area}, \emph{R}\textsubscript{area} and
%DIFDELCMD < LL.}{Decomposing LMA into metabolic and structural components leads to improved predictions of Aarea, Rarea and LL.}%%%
\DIFdelend \DIFaddbegin \texorpdfstring{Decomposing LMA into metabolic and
structural components leads to improved predictions of
\emph{A}\textsubscript{area}, \emph{R}\textsubscript{area}, and
LL.}{Decomposing LMA into metabolic and structural components leads to improved predictions of Aarea, Rarea, and LL.}\DIFaddend }\label{decomposing-lma-into-metabolic-and-structural-components-leads-to-improved-predictions-of-aarea-rarea-and-ll.}

For both the GLOPNET and Panama datasets, two-dimensional models
(LMAm-LMAs) performed better in \DIFdelbegin \DIFdel{cross validation }\DIFdelend \DIFaddbegin \DIFadd{cross-validation }\DIFaddend than one-dimensional
(LMA) models (Table 1). Thus, predictions of
\emph{A}\textsubscript{area}, \emph{R}\textsubscript{area}\DIFaddbegin \DIFadd{, }\DIFaddend and LL were
...
(\emph{A}\textsubscript{area}, \emph{R}\textsubscript{area}\DIFaddbegin \DIFadd{, }\DIFaddend and LL) had
...
best Panama model also included the effect of light\DIFdelbegin \DIFdel{(sun vs.~shade ) on
LL }\DIFdelend \DIFaddbegin \DIFadd{, with shade leaves
having longer LL than sun leaves for a given LMAs }\DIFaddend (Tables 1-2;
...
\citeproc{ref-Williams1989}{Williams K et al. 1989}}\hspace{0pt}%DIFAUXCMD
;
\mbox{%DIFAUXCMD
\citeproc{ref-Villar2001}{Villar R, Merino J 2001}}\hspace{0pt}%DIFAUXCMD
...
(\DIFdelbegin \DIFdel{Fig.~\ref{fig-vpart}a-b). Despite the relatively large residuals in
LMAs (Fig.~\ref{fig-vpart}a-b), the }\DIFdelend \DIFaddbegin \DIFadd{S4a-b). The }\DIFaddend higher total LMA in evergreen compared to deciduous leaves
was primarily due to differences in LMAs (Figs. \ref{fig-box_de}, \DIFdelbegin \DIFdel{S1}\DIFdelend \DIFaddbegin \DIFadd{S1a}\DIFaddend ,
and S2). In the Panama dataset, light (sun vs.~shade) explained \DIFdelbegin \DIFdel{much }\DIFdelend more
variation in LMAm than LMAs, whereas site (wet vs.~dry) explained \DIFdelbegin \DIFdel{much more variation in LMAs than LMAm (Fig.~\ref{fig-vpart}c}\DIFdelend \DIFaddbegin \DIFadd{near
zero variation in LMAm but substantial variaion in LMAs (S4c}\DIFaddend ). Panama
wet-site leaves had higher total LMA than dry-site leaves due to greater
\DIFdelbegin \DIFdel{LMAs when we compared the same
canopy strata }\DIFdelend \DIFaddbegin \DIFadd{wet-site LMAs for both sun and shade leaves }\DIFaddend (Figs. \ref{fig-box_pa} and
\DIFdelbegin \DIFdel{S1}\DIFdelend \DIFaddbegin \DIFadd{S1b}\DIFaddend ). In contrast, Panama sun leaves had higher total LMA than shade
leaves primarily due to greater LMAm, with a smaller but significant
contribution from LMAs (Figs. \ref{fig-box_pa} and \DIFdelbegin \DIFdel{S1). Thus, }\DIFdelend \DIFaddbegin \DIFadd{S1b). }\DIFaddend LMAs comprised
a larger fraction of total LMA for shade leaves than for sun leaves
(Fig. \DIFdelbegin \DIFdel{S2}\DIFdelend \DIFaddbegin \DIFadd{S3}\DIFaddend ).
...
to LMAs variation \DIFdelbegin \DIFdel{(Eq. 5) }\DIFdelend strongly affected the area- vs.~mass-dependence of
\emph{A}\textsubscript{max} (i.e., the degree to which whole-leaf
\emph{A}\textsubscript{max} depends on leaf area or mass; \DIFdelbegin \DIFdel{Osnas et al. (\mbox{%DIFAUXCMD
\citeproc{ref-Osnas2013}{2013}}\hspace{0pt}%DIFAUXCMD
); Osnas et al.
(\mbox{%DIFAUXCMD
\citeproc{ref-Osnas2018}{2018}}\hspace{0pt}%DIFAUXCMD
)). Generally}\DIFdelend \DIFaddbegin \DIFadd{see
Supplementary Section 4). As expected}\DIFaddend , mass-dependence of
\emph{A}\textsubscript{max} \DIFdelbegin \DIFdel{decreased }\DIFdelend \DIFaddbegin \DIFadd{was generally weak }\DIFaddend (area-dependence \DIFdelbegin \DIFdel{increased) with
increasing LMAs variance }\DIFdelend \DIFaddbegin \DIFadd{was
strong) when LMA variance was dominated by LMAs
}\DIFaddend (Fig.~\ref{fig-mass_prop}). \DIFdelbegin \DIFdel{Other factors, including the sensitivity of }\DIFdelend \DIFaddbegin \DIFadd{In this case, }\DIFaddend \emph{A}\textsubscript{max}
per-unit leaf area (\emph{A}\textsubscript{area}) \DIFaddbegin \DIFadd{and LMA are not
...
whole-leaf }\emph{\DIFadd{A}}\DIFadd{\textsubscript{max} thus depends primarily on leaf
area rather than mass).
}

\DIFadd{Factors other than LMA variance components also affected the area-
vs.~mass-dependence of }\emph{\DIFadd{A}}\DIFadd{\textsubscript{max}, including the
sensitivity of }\emph{\DIFadd{A}}\DIFadd{\textsubscript{area} }\DIFaddend to variation in LMAm and
LMAs (\(\alpha_m\) and \(\alpha_s\) in Eq. 2) and covariance between
LMAm and LMAs \DIFdelbegin \DIFdel{, also affect the mass-dependence of }\emph{\DIFdel{A}}%DIFAUXCMD
\DIFdel{\textsubscript{max}
}\DIFdelend (Fig.~\ref{fig-mass_prop}, Figs. \DIFdelbegin \DIFdel{S4-S5}\DIFdelend \DIFaddbegin \DIFadd{S5-S6}\DIFaddend ). For example, \DIFaddbegin \DIFadd{in
GLOPNET, }\DIFaddend LMAs variance was relatively low \DIFdelbegin \DIFdel{in GLOPNET }\DIFdelend (51\% of total LMA variance)\DIFdelbegin \DIFdel{. However,
variation in }\DIFdelend \DIFaddbegin \DIFadd{,
yet }\DIFaddend \emph{A}\textsubscript{max} \DIFdelbegin \DIFdel{in GLOPNET was strongly area-dependent. This is because the }\DIFdelend \DIFaddbegin \DIFadd{was strongly area-depedent. Thus, in
GLOPNET, strong area-dependence of }\emph{\DIFadd{A}}\DIFadd{\textsubscript{max} did not
emerge from high LMAs variance, but instead reflected a }\DIFaddend relatively weak
dependence of \emph{A}\textsubscript{area} on LMAm and \DIFdelbegin \DIFdel{the }\DIFdelend \DIFaddbegin \DIFadd{a }\DIFaddend negative
dependence of \emph{A}\textsubscript{area} on LMAs (Table 2)\DIFaddbegin \DIFadd{, which
together }\DIFaddend led to a weak \DIFdelbegin \DIFdel{overall
}\DIFdelend dependence of \emph{A}\textsubscript{area} on
LMA. \DIFdelbegin \DIFdel{Thus, }\DIFdelend \DIFaddbegin \DIFadd{These factors resulted in similar }\DIFaddend mass-dependence of
\emph{A}\textsubscript{max} \DIFdelbegin \DIFdel{in GLOPNET was similar or weaker than in
the Panama data}\DIFdelend \DIFaddbegin \DIFadd{across GLOPNET and Panama datasets}\DIFaddend , despite
...
respectively) \DIFaddbegin \DIFadd{compared to GLOPNET (51\%; Fig.~\ref{fig-mass_prop})}\DIFaddend .
...
revealed \DIFdelbegin \DIFdel{several patterns that are
}\DIFdelend \DIFaddbegin \DIFadd{patterns }\DIFaddend consistent with previous analyses of measured traits
...
\citeproc{ref-Evans2009}{Evans JR et al. 2009}}\hspace{0pt}%DIFAUXCMD
;
\mbox{%DIFAUXCMD
\citeproc{ref-Terashima2011}{Terashima I et al. 2011}}\hspace{0pt}%DIFAUXCMD
;
\mbox{%DIFAUXCMD
\citeproc{ref-Onoda2017}{Onoda Y et al. 2017}}\hspace{0pt}%DIFAUXCMD
...
\citeproc{ref-Niinemets2006a}{Niinemets Ü, Sack L 2006}}\hspace{0pt}%DIFAUXCMD
;
\mbox{%DIFAUXCMD
\citeproc{ref-Poorter2009}{Poorter H et al. 2009}}\hspace{0pt}%DIFAUXCMD
;
...
\citeproc{ref-Onoda2011}{Onoda Y et al. 2011}}\hspace{0pt}%DIFAUXCMD
;
\mbox{%DIFAUXCMD
\citeproc{ref-Kitajima2012}{Kitajima K et al. 2012}}\hspace{0pt}%DIFAUXCMD
,
...
\DIFdelbegin \DIFdel{and }\DIFdelend \DIFaddbegin \DIFadd{vs.~}\DIFaddend \textasciitilde40\% for deciduous species (Fig. S2), and
\DIFdelbegin \DIFdel{15-40}\DIFdelend \DIFaddbegin \DIFadd{\textasciitilde70}\DIFaddend \% for shade leaves \DIFdelbegin \DIFdel{and 50-70}\DIFdelend \DIFaddbegin \DIFadd{vs.~\textasciitilde40}\DIFaddend \% for sun
leaves (Fig. S3). These estimates align with measurements of cell wall
(fibre) content from a global dataset (\DIFdelbegin \DIFdel{14--77\%, }\DIFdelend median 47\% of total leaf mass
\DIFaddbegin \DIFadd{across species and canopy positions}\DIFaddend , with higher values for shade than
sun leaves; Onoda et al.~2011) and a Panama study site (Barro Colorado
Island, BCI: \textasciitilde50\% mean across species \DIFaddbegin \DIFadd{and canopy
positions}\DIFaddend , with higher values for shade leaves; Kitajima et al.~2016).
...
; \mbox{%DIFAUXCMD
\citeproc{ref-Kitajima2012}{Kitajima K
et al. 2012}}\hspace{0pt}%DIFAUXCMD
, \mbox{%DIFAUXCMD
\citeproc{ref-Kitajima2016}{2016}}\hspace{0pt}%DIFAUXCMD
}\DIFaddend ). For a given LMAs,
shade leaves had longer LL than sun leaves (see Fig.~\ref{fig-pa_point}i
and parameter \(\theta\) in Table 2). Thus, partitioning LMA into LMAm
and LMAs is not sufficient to explain the widely observed
counter-gradient, whereby LL increases with increasing LMA across
species but decreases with increasing LMA within species from shade to
sun (\DIFdelbegin \DIFdel{\mbox{%DIFAUXCMD
\citeproc{ref-Lusk2008}{Lusk et al., 2008}}\hspace{0pt}%DIFAUXCMD
;
\mbox{%DIFAUXCMD
\citeproc{ref-Osnas2018}{Osnas et al., 2018}}\hspace{0pt}%DIFAUXCMD
...
factors \DIFdelbegin \DIFdel{unlreated }\DIFdelend \DIFaddbegin \DIFadd{unrealted }\DIFaddend to leaf toughness \DIFdelbegin \DIFdel{- }\DIFdelend \DIFaddbegin \DIFadd{− }\DIFaddend e.g., how optimal LL depends on
...
toughness) \DIFaddbegin \DIFadd{(\mbox{%DIFAUXCMD
\citeproc{ref-Kitajima2016}{Kitajima K et al. 2016}}\hspace{0pt}%DIFAUXCMD
)}\DIFaddend . Thus,
...
\citeproc{ref-Kitajima2016}{Kitajima K et
...
Osnas \DIFaddbegin \DIFadd{JLD }\DIFaddend et al. (\citeproc{ref-Osnas2018}{2018}) suggested that in leaf
...
than mass-dependent (parameter \emph{b} in Eq. \DIFdelbegin \DIFdel{6}\DIFdelend \DIFaddbegin \DIFadd{S5.1}\DIFaddend , with \emph{b}
...
Osnas \DIFaddbegin \DIFadd{JLD }\DIFaddend et al. (\citeproc{ref-Osnas2018}{2018}). However, our analysis
also revealed complexities that were not anticipated by Osnas \DIFaddbegin \DIFadd{JLD }\DIFaddend et al.
...
\citeproc{ref-Terashima2011}{Terashima I et
al. 2011}}\hspace{0pt}%DIFAUXCMD
}\DIFaddend ). Both of these factors would decrease the marginal benefit of
additional \DIFdelbegin \DIFdel{units of }\DIFdelend LMAm, and this marginal decrease may be especially strong in
GLOPNET due to its large LMAm range (3.2 - 594 g m\textsuperscript{2}\DIFaddbegin \DIFadd{,
according to our model results}\DIFaddend ) relative to Panama (1.9 - 133 g
m\textsuperscript{2}).

Finally, while much of the model-inferred LMAm may be directly or
indirectly related to photosynthesis, \DIFdelbegin \DIFdel{`LMAm ' }\DIFdelend \DIFaddbegin \DIFadd{LMAm }\DIFaddend may also include metabolic
leaf mass unrelated to photosynthesis and/or non-metabolic leaf mass
that is\DIFdelbegin \DIFdel{statistically assigned (by default) }\DIFdelend \DIFaddbegin \DIFadd{, in our modeling framework, attributed }\DIFaddend to LMAm simply because it
...
\citeproc{ref-Wurth2005}{Würth MKR et al. 2005}}\hspace{0pt}%DIFAUXCMD
}\DIFaddend ) and up to 20\%
of leaf mass in evergreen species
(\DIFdelbegin \DIFdel{\mbox{%DIFAUXCMD
...
non-metabolic leaf mass in LMAm, a }\DIFdelend \DIFaddbegin \DIFadd{\mbox{%DIFAUXCMD
\citeproc{ref-Martinez-Vilalta2016}{Martínez-Vilalta J et al. 2016}}\hspace{0pt}%DIFAUXCMD
). A
}\DIFaddend more refined model that accounts for more than two LMA components may
reveal stronger relationships between metabolic traits
(\emph{A}\textsubscript{area} and \emph{R}\textsubscript{area}) and \DIFdelbegin \DIFdel{LMAm}\DIFdelend \DIFaddbegin \DIFadd{LMA
components than in the present study}\DIFaddend .
...
\citeproc{ref-Osnas2018}{Osnas JLD et al. 2018}}\hspace{0pt}%DIFAUXCMD
}\DIFaddend ). LMA increased from
shade to sun primarily due to an increase in LMAm (Figs.
...
\citeproc{ref-Onoda2008}{Onoda Y et al. 2008}}\hspace{0pt}%DIFAUXCMD
;
\mbox{%DIFAUXCMD
\citeproc{ref-Terashima2011}{Terashima I et al. 2011}}\hspace{0pt}%DIFAUXCMD
}\DIFaddend ). In contrast to
our interspecific analysis \DIFaddbegin \DIFadd{suggesting weak mass-dependence of
}\emph{\DIFadd{A}}\DIFadd{\textsubscript{max} }\DIFaddend within sun and shade leaves
(Fig.~\ref{fig-mass_prop}), estimates of intraspecific \DIFaddbegin \DIFadd{analysis of the
same Panama dataset suggests strong }\DIFaddend mass-dependence of metabolic traits
across light levels \DIFdelbegin \DIFdel{are around 0.8-1.0 for the same
...
Although \DIFdelbegin \DIFdel{values of }\DIFdelend \DIFaddbegin \DIFadd{the index of mass-dependence (}\DIFaddend \emph{b}\DIFaddbegin \DIFadd{; Eq. S5.1) can,
theoretically, be }\DIFaddend greater than 1 \DIFdelbegin \DIFdel{are theoretically possible
(which implies }\DIFdelend \DIFaddbegin \DIFadd{(implying }\DIFaddend an exponential increase in
...
\subsection{Implications for \DIFdelbegin \DIFdel{terrestrial ecosystem
models}\DIFdelend \DIFaddbegin \DIFadd{Terrestrial Ecosystem
Models}\DIFaddend }\label{implications-for-terrestrial-ecosystem-models}
...
\citeproc{ref-Moorcroft2001}{Moorcroft PR et al. 2001}}\hspace{0pt}%DIFAUXCMD
;
\mbox{%DIFAUXCMD
\citeproc{ref-Bonan2002}{Bonan GB et al. 2002}}\hspace{0pt}%DIFAUXCMD
;
\mbox{%DIFAUXCMD
\citeproc{ref-Verheijen2013}{Verheijen LM et al. 2013}}\hspace{0pt}%DIFAUXCMD
}\DIFaddend ), with the
ultimate goal of adding ecological and physiological realism to coupled
Earth \DIFdelbegin \DIFdel{System Models }\DIFdelend \DIFaddbegin \DIFadd{system models }\DIFaddend (ESMs, \DIFdelbegin \DIFdel{\mbox{%DIFAUXCMD
...
\citeproc{ref-Moorcroft2006}{Moorcroft PR
2006}}\hspace{0pt}%DIFAUXCMD
; \mbox{%DIFAUXCMD
\citeproc{ref-Wullschleger2014}{Wullschleger SD et al. 2014}}\hspace{0pt}%DIFAUXCMD
}\DIFaddend ).
...
\citeproc{ref-Scheiter2013}{Scheiter S et al. 2013}}\hspace{0pt}%DIFAUXCMD
;
\mbox{%DIFAUXCMD
\citeproc{ref-Sakschewski2015}{Sakschewski B et al. 2015}}\hspace{0pt}%DIFAUXCMD
;
\mbox{%DIFAUXCMD
\citeproc{ref-Fisher2015}{Fisher RA et al. 2015}}\hspace{0pt}%DIFAUXCMD
;
\mbox{%DIFAUXCMD
\citeproc{ref-Sakschewski2016}{Sakschewski B et al. 2016}}\hspace{0pt}%DIFAUXCMD
;
\mbox{%DIFAUXCMD
\citeproc{ref-DantasdePaula2021}{Dantas de Paula M et al. 2021}}\hspace{0pt}%DIFAUXCMD
}\DIFaddend ) along
...
\citeproc{ref-Fisher2018}{Fisher RA et al.
2018}}\hspace{0pt}%DIFAUXCMD
...
structural leaf mass separately \DIFdelbegin \DIFdel{, }\DIFdelend and indicate weak\DIFdelbegin \DIFdel{if any }\DIFdelend \DIFaddbegin \DIFadd{,if any, }\DIFaddend interspecific
...
\citeproc{ref-Dong2017}{Dong N et
al. 2017}}\hspace{0pt}%DIFAUXCMD
, \mbox{%DIFAUXCMD
...
\citeproc{ref-Hidaka2011}{Hidaka
A, Kitayama K 2011}}\hspace{0pt}%DIFAUXCMD
...
Bonan \DIFdelbegin \DIFdel{, G.B., Levis , S., Kergoat , L., Oleson , K.W., 2002. }\DIFdelend \DIFaddbegin \DIFadd{GB, Levis S, Kergoat L, Oleson KW (2002) }\DIFaddend Landscapes as patches of
plant functional types: {An} integrating concept for climate and
ecosystem models. Global Biogeochemical \DIFdelbegin \DIFdel{Cycles 16, }\DIFdelend \DIFaddbegin \DIFadd{Cycles16:}\DIFaddend 5-1-5-23.
\url{https://doi.org/10.1029/2000GB001360}\DIFaddbegin \DIFadd{.
}\DIFaddend 

\bibitem[\citeproctext]{ref-Carpenter2017}
Carpenter \DIFdelbegin \DIFdel{, B., Gelman , A., Hoffman , M.D., Lee , D., Goodrich , B., Betancourt , M.,
Brubaker , M., Guo , J., Li , P., Riddell , A ., 2017. }\DIFdelend \DIFaddbegin \DIFadd{B, Gelman A, Hoffman MD, Lee D, Goodrich B, Betancourt M,
Brubaker M, Guo J, Li P, Riddell A (2017) }\DIFaddend Stan : {A Probabilistic
Programming Language}. Journal of Statistical \DIFdelbegin \DIFdel{Software
...
Dantas de Paula \DIFdelbegin \DIFdel{, M., Forrest , M., Langan , L., Bendix , J., Homeier , J., Velescu , A.,
Wilcke , W., Hickler , T ., 2021. }\DIFdelend \DIFaddbegin \DIFadd{M, Forrest M, Langan L, Bendix J, Homeier J, Velescu A,
Wilcke W, Hickler T (2021) }\DIFaddend Nutrient cycling drives plant community trait
assembly and ecosystem functioning in a tropical mountain biodiversity
hotspot. New \DIFdelbegin \DIFdel{Phytologist 232, }\DIFdelend \DIFaddbegin \DIFadd{Phytologist232:}\DIFaddend 551--566.
\url{https://doi.org/10.1111/nph.17600}\DIFaddbegin \DIFadd{.
}\DIFaddend 

\bibitem[\citeproctext]{ref-Dong2017}
Dong \DIFdelbegin \DIFdel{, N., Prentice , I.C., Evans , B.J.}\DIFdelend \DIFaddbegin \DIFadd{N, Prentice IC, Evans BJ}\DIFaddend , Caddy-Retalic \DIFdelbegin \DIFdel{, S., Lowe , A.J., Wright , I.J., 2017. }\DIFdelend \DIFaddbegin \DIFadd{S, Lowe AJ, Wright IJ
(2017) }\DIFaddend Leaf nitrogen from first principles: Field evidence for adaptive
variation with climate. \DIFdelbegin \DIFdel{Biogeosciences 14, }\DIFdelend \DIFaddbegin \DIFadd{Biogeosciences14:}\DIFaddend 481--495.
\url{https://doi.org/10.5194/bg-14-481-2017}\DIFaddbegin \DIFadd{.
}\DIFaddend 

\bibitem[\citeproctext]{ref-Dong2022}
Dong \DIFdelbegin \DIFdel{, N., Prentice , I.C., Wright , I.J., Wang , H., Atkin , O.K., Bloomfield , K.J.,
Domingues , T.F., Gleason , S.M., Maire , V., Onoda , Y., Poorter , H., Smith , N.G., 2022. }\DIFdelend \DIFaddbegin \DIFadd{N, Prentice IC, Wright IJ, Wang H, Atkin OK, Bloomfield KJ,
Domingues TF, Gleason SM, Maire V, Onoda Y, Poorter H, Smith NG (2022)
}\DIFaddend Leaf nitrogen from the perspective of optimal plant function. Journal of
\DIFdelbegin \DIFdel{Ecology 110, }\DIFdelend \DIFaddbegin \DIFadd{Ecology110:}\DIFaddend 2585--2602. \url{https://doi.org/10.1111/1365-2745.13967}\DIFaddbegin \DIFadd{.
}\DIFaddend 

\bibitem[\citeproctext]{ref-Evans2009}
Evans \DIFdelbegin \DIFdel{, J.R., Kaldenhoff , R., Genty , B., Terashima , I ., 2009. }\DIFdelend \DIFaddbegin \DIFadd{JR, Kaldenhoff R, Genty B, Terashima I (2009) }\DIFaddend Resistances along
the {CO2} diffusion pathway inside leaves. Journal of Experimental
\DIFdelbegin \DIFdel{Botany 60, }\DIFdelend \DIFaddbegin \DIFadd{Botany60:}\DIFaddend 2235--2248. \url{https://doi.org/10.1093/jxb/erp117}\DIFaddbegin \DIFadd{.
}\DIFaddend 

\DIFdelbegin \bibitem[\citeproctext]{ref-Falster2012}
\DIFdel{Falster }\DIFdelend \DIFaddbegin \bibitem[\citeproctext]{ref-Falster2017}
\DIFadd{Falster DS, Brännström Å, Westoby M, Dieckmann U (2017) Multitrait
successional forest dynamics enable diverse competitive coexistence.
Proceedings of the National Academy of Sciences114:E2719--E2728.
}\url{https://doi.org/10.1073/pnas.1610206114}\DIFadd{.
}

\bibitem[\citeproctext]{ref-Falster2012}
\DIFadd{Falster DS, Reich PB, Ellsworth DS, Wright IJ, Westoby M}\DIFaddend , \DIFdelbegin \DIFdel{D.S., Reich, P.
B.
}\DIFdelend \DIFaddbegin \DIFadd{Oleksyn J}\DIFaddend , \DIFdelbegin \DIFdel{Ellsworth, D.S., Wright , I.J., Westoby , M., Oleksyn , J., Lee
, T.D., 2012. }\DIFdelend \DIFaddbegin \DIFadd{Lee
TD (2012) }\DIFaddend Lifetime return on investment increases with leaf lifespan
among 10 {Australian} woodland species. New \DIFdelbegin \DIFdel{Phytologist 193, }\DIFdelend \DIFaddbegin \DIFadd{Phytologist193:}\DIFaddend 409--419.
\url{https://doi.org/10.1111/j.1469-8137.2011.03940.x}\DIFaddbegin \DIFadd{.
}\DIFaddend 

\bibitem[\citeproctext]{ref-Fisher2018}
Fisher \DIFdelbegin \DIFdel{, R.A., Koven , C.D., Anderegg , W.R.L., Christoffersen , B.O., Dietze , M.C., Farrior
, C.E., Holm , J.A., Hurtt , G.C., Knox , R.G., Lawrence , P.J., Lichstein , J.W., Longo , M.,
Matheny , A.M., Medvigy , D.}\DIFdelend \DIFaddbegin \DIFadd{RA, Koven CD, Anderegg WRL, Christoffersen BO, Dietze MC, Farrior
CE, Holm JA, Hurtt GC, Knox RG, Lawrence PJ, Lichstein JW, Longo M,
Matheny AM, Medvigy D}\DIFaddend , Muller-Landau \DIFdelbegin \DIFdel{, H.C., Powell , T.L., Serbin , S.P., Sato , H.,
Shuman , J.K., Smith , B., Trugman , A.T., Viskari , T., Verbeeck , H., Weng , E., Xu , C., Xu
, X., Zhang , T., Moorcroft , P.R., 2018. }\DIFdelend \DIFaddbegin \DIFadd{HC, Powell TL, Serbin SP, Sato H,
Shuman JK, Smith B, Trugman AT, Viskari T, Verbeeck H, Weng E, Xu C, Xu
X, Zhang T, Moorcroft PR (2018) }\DIFaddend Vegetation demographics in {Earth System
Models}: {A} review of progress and priorities. Global Change
\DIFdelbegin \DIFdel{Biology 24, }\DIFdelend \DIFaddbegin \DIFadd{Biology24:}\DIFaddend 35--54. \url{https://doi.org/10.1111/gcb.13910}\DIFaddbegin \DIFadd{.
}\DIFaddend 

\bibitem[\citeproctext]{ref-Fisher2015}
Fisher \DIFdelbegin \DIFdel{, R.A., Muszala , S., Verteinstein , M., Lawrence , P., Xu , C., McDowell , N.G.,
Knox , R.G., Koven , C., Holm , J., Rogers , B.M., Spessa ,
A., Lawrence , D., Bonan , G
., 2015. }\DIFdelend \DIFaddbegin \DIFadd{RA, Muszala S, Verteinstein M, Lawrence P, Xu C, McDowell NG,
Knox RG, Koven C, Holm J, Rogers BM, Spessa A, Lawrence D, Bonan G
(2015) }\DIFaddend Taking off the training wheels: The properties of a dynamic
vegetation model without climate envelopes, {CLM4}.5({ED}).
...
Gelman \DIFdelbegin \DIFdel{, A., Carlin , J.B., Stern , H.S., Dunson , D.B., Vehtari , A., Rubin ,
D.B., 2013. }\DIFdelend \DIFaddbegin \DIFadd{A, Carlin JB, Stern HS, Dunson DB, Vehtari A, Rubin DB (2013)
}\DIFaddend Bayesian {Data Analysis}, {Third Edition}.
\DIFdelbegin \DIFdel{Chapman \&
Hall/CRC, Boca Raton, FL, USA.
}\DIFdelend 

\bibitem[\citeproctext]{ref-Hidaka2011}
Hidaka \DIFdelbegin \DIFdel{, A., Kitayama , K ., 2011. }\DIFdelend \DIFaddbegin \DIFadd{A, Kitayama K (2011) }\DIFaddend Allocation of foliar phosphorus fractions
...
Huntingford \DIFdelbegin \DIFdel{, C., Atkin , O.K.}\DIFdelend \DIFaddbegin \DIFadd{C, Atkin OK}\DIFaddend , Martinez-de la Torre \DIFdelbegin \DIFdel{, A., Mercado , L.M., Heskel , M.A.,
Harper , A.B., Bloomfield , K.J.}\DIFdelend \DIFaddbegin \DIFadd{A, Mercado LM, Heskel MA,
Harper AB, Bloomfield KJ}\DIFaddend , O'Sullivan \DIFdelbegin \DIFdel{, O.S., Reich ,
P.B., Wythers , K.R., Butler
, E.E., Chen , M., Griffin , K.L., Meir , P., Tjoelker , M.G., Turnbull , M.H., Sitch , S.,
Wiltshire , A., Malhi , Y .,
2017. }\DIFdelend \DIFaddbegin \DIFadd{OS, Reich PB, Wythers KR, Butler
EE, Chen M, Griffin KL, Meir P, Tjoelker MG, Turnbull MH, Sitch S,
Wiltshire A, Malhi Y (2017) }\DIFaddend Implications of improved representations of
...
Kikuzawa \DIFdelbegin \DIFdel{, K ., 1991. }\DIFdelend \DIFaddbegin \DIFadd{K (1991) }\DIFaddend A {Cost-Benefit Analysis} of {Leaf Habit} and {Leaf
...
Kitajima \DIFdelbegin \DIFdel{, K., Cordero , R.A., Wright , S.J., 2013. }\DIFdelend \DIFaddbegin \DIFadd{K, Cordero RA, Wright SJ (2013) }\DIFaddend Leaf life span spectrum of
tropical woody seedlings: {Effects} of light and ontogeny and
consequences for survival. Annals of \DIFdelbegin \DIFdel{Botany 112, }\DIFdelend \DIFaddbegin \DIFadd{Botany112:}\DIFaddend 685--699.
\url{https://doi.org/10.1093/aob/mct036}\DIFaddbegin \DIFadd{.
}\DIFaddend 

\bibitem[\citeproctext]{ref-Kitajima2012}
Kitajima \DIFdelbegin \DIFdel{, K., Llorens , A.M., Stefanescu , C., Timchenko , M.V., Lucas ,
P.W., Wright , S.J., 2012. }\DIFdelend \DIFaddbegin \DIFadd{K, Llorens AM, Stefanescu C, Timchenko MV, Lucas PW, Wright SJ
(2012) }\DIFaddend How cellulose-based leaf toughness and lamina density contribute
to long leaf lifespans of shade-tolerant species. New
\DIFdelbegin \DIFdel{Phytologist 195, }\DIFdelend \DIFaddbegin \DIFadd{Phytologist195:}\DIFaddend 640--652.
\url{https://doi.org/10.1111/j.1469-8137.2012.04203.x}\DIFaddbegin \DIFadd{.
}\DIFaddend 

\bibitem[\citeproctext]{ref-Kitajima2016}
Kitajima \DIFdelbegin \DIFdel{, K., Wright , S.J., Westbrook , J.W., 2016. }\DIFdelend \DIFaddbegin \DIFadd{K, Wright SJ, Westbrook JW (2016) }\DIFaddend Leaf cellulose density as the
key determinant of inter- and intra-specific variation in leaf fracture
toughness in a species-rich tropical forest. Interface \DIFdelbegin \DIFdel{Focus 6, }\DIFdelend \DIFaddbegin \DIFadd{Focus6:}\DIFaddend 20150100.
\url{https://doi.org/10.1098/rsfs.2015.0100}\DIFaddbegin \DIFadd{.
}\DIFaddend 

\bibitem[\citeproctext]{ref-Landau2021}
Landau \DIFdelbegin \DIFdel{, W.M., 2021. }\DIFdelend \DIFaddbegin \DIFadd{WM (2021) }\DIFaddend The targets {R} package: A dynamic {Make-like}
...
Lemoine \DIFdelbegin \DIFdel{, N.P., 2019. }\DIFdelend \DIFaddbegin \DIFadd{NP (2019) }\DIFaddend Moving beyond noninformative priors: Why and how to
...
}\DIFdelend \DIFaddbegin \DIFadd{JW, Peterson BT, Langebrake J, McKinley SA (2021) }\DIFaddend Leaf
economics of early-and late-successional plants. The American
Naturalist. \url{https://doi.org/10.1086/715453}\DIFaddbegin \DIFadd{.
}\DIFaddend 

\bibitem[\citeproctext]{ref-Lloyd2013}
Lloyd \DIFdelbegin \DIFdel{, J., Bloomfield , K., Domingues , T.F., Farquhar , G.D., 2013.
}\DIFdelend \DIFaddbegin \DIFadd{J, Bloomfield K, Domingues TF, Farquhar GD (2013)
}\DIFaddend Photosynthetically relevant foliar traits correlating better on a mass
vs an area basis: {Of} ecophysiological relevance or just a case of
mathematical imperatives and statistical quicksand? New
\DIFdelbegin \DIFdel{Phytologist 199,
}\DIFdelend \DIFaddbegin \DIFadd{Phytologist199:}\DIFaddend 311--321. \url{https://doi.org/10.1111/nph.12281}\DIFaddbegin \DIFadd{.
}\DIFaddend 

\bibitem[\citeproctext]{ref-Lusk2008}
Lusk \DIFdelbegin \DIFdel{, C.H., Reich , P.B., Montgomery , R.A., Ackerly , D.D.}\DIFdelend \DIFaddbegin \DIFadd{CH, Reich PB, Montgomery RA, Ackerly DD}\DIFaddend , Cavender-Bares \DIFdelbegin \DIFdel{, J ., 2008. }\DIFdelend \DIFaddbegin \DIFadd{J (2008)
}\DIFaddend Why are evergreen leaves so contrary about shade? Trends in Ecology and
\DIFdelbegin \DIFdel{Evolution 23, }\DIFdelend \DIFaddbegin \DIFadd{Evolution23:}\DIFaddend 299--303. \url{https://doi.org/10.1016/j.tree.2008.02.006}\DIFaddbegin \DIFadd{.
}\DIFaddend 

\bibitem[\citeproctext]{ref-Martinez-Vilalta2016}
Martínez-Vilalta \DIFdelbegin \DIFdel{, J., Sala , A., Asensio , D., Galiano , L., Hoch , G., Palacio , S.,
Piper , F.I., Lloret , F ., 2016. }\DIFdelend \DIFaddbegin \DIFadd{J, Sala A, Asensio D, Galiano L, Hoch G, Palacio S,
Piper FI, Lloret F (2016) }\DIFaddend Dynamics of non-structural carbohydrates in
terrestrial plants: A global synthesis. Ecological
\DIFdelbegin \DIFdel{Monographs 86, }\DIFdelend \DIFaddbegin \DIFadd{Monographs86:}\DIFaddend 495--516. \url{https://doi.org/10.1002/ecm.1231}\DIFaddbegin \DIFadd{.
}\DIFaddend 

\bibitem[\citeproctext]{ref-Moorcroft2006}
Moorcroft \DIFdelbegin \DIFdel{, P.R., 2006. }\DIFdelend \DIFaddbegin \DIFadd{PR (2006) }\DIFaddend How close are we to a predictive science of the
biosphere? Trends in Ecology \& \DIFdelbegin \DIFdel{Evolution 21, }\DIFdelend \DIFaddbegin \DIFadd{Evolution21:}\DIFaddend 400--407.
\url{https://doi.org/10.1016/j.tree.2006.04.009}\DIFaddbegin \DIFadd{.
}\DIFaddend 

\bibitem[\citeproctext]{ref-Moorcroft2001}
Moorcroft \DIFdelbegin \DIFdel{, P.R., Hurtt , G.C., Pacala , S.W., 2001. }\DIFdelend \DIFaddbegin \DIFadd{PR, Hurtt GC, Pacala SW (2001) }\DIFaddend A {Method} for {Scaling
Vegetation Dynamics}: {The Ecosystem Demography Model} ({ED}).
Ecological \DIFdelbegin \DIFdel{Monographs 71, }\DIFdelend \DIFaddbegin \DIFadd{Monographs71:}\DIFaddend 557--585. \url{https://doi.org/10.2307/3100036}\DIFaddbegin \DIFadd{.
}\DIFaddend 

\DIFdelbegin \bibitem[\citeproctext]{ref-Onoda2015}
\DIFdel{Onoda, Y.
, Schieving, F., Anten, N. P.
R.
, 2015. A novel method of measuring leaf
epidermis and mesophyll stiffness shows the ubiquitous
...
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \bibitem[\citeproctext]{ref-Niinemets2015}
\DIFadd{Niinemets Ü, Keenan TF, Hallik L (2015) A worldwide analysis of
within-canopy variations in leaf structural, chemical and physiological
traits across plant functional types. New Phytologist205:973--993.
}\url{https://doi.org/10.1111/nph.13096}\DIFadd{.
}

\bibitem[\citeproctext]{ref-Niinemets2006a}
\DIFadd{Niinemets Ü, Sack L (2006) Structural determinants of leaf
light-harvesting capacity and photosynthetic potentials. Progress in
botany:385--419.
}\DIFaddend 

\bibitem[\citeproctext]{ref-Onoda2008}
Onoda \DIFdelbegin \DIFdel{, Y., Schieving , F., Anten , N.P.R., 2008. }\DIFdelend \DIFaddbegin \DIFadd{Y, Schieving F, Anten NPR (2008) }\DIFaddend Effects of light and nutrient
availability on leaf mechanical properties of {\emph{Plantago}}{
\emph{Major}}: {A} conceptual approach. Annals of \DIFdelbegin \DIFdel{Botany 101, }\DIFdelend \DIFaddbegin \DIFadd{Botany101:}\DIFaddend 727--736.
\url{https://doi.org/10.1093/aob/mcn013}\DIFaddbegin \DIFadd{.
}\DIFaddend 

\DIFdelbegin \bibitem[\citeproctext]{ref-Onoda2011}
\DIFdel{Onoda , Y}\DIFdelend \DIFaddbegin \bibitem[\citeproctext]{ref-Onoda2015}
\DIFadd{Onoda Y, Schieving F, Anten NPR (2015) A novel method of measuring leaf
epidermis and mesophyll stiffness shows the ubiquitous nature of the
sandwich structure of leaf laminas in broad-leaved angiosperm species.
Journal of Experimental Botany66:2487--2499}\DIFaddend .
\DIFaddbegin \url{https://doi.org/10.1093/jxb/erv024}\DIFadd{.
}

\bibitem[\citeproctext]{ref-Onoda2011}
\DIFadd{Onoda Y, Westoby M}\DIFaddend , \DIFdelbegin \DIFdel{Westoby, M., Adler , P.B., Choong , A.M.F., Clissold , F.J., Cornelissen , J.H.C.}\DIFdelend \DIFaddbegin \DIFadd{Adler PB, Choong AMF, Clissold FJ, Cornelissen JHC}\DIFaddend ,
Díaz \DIFdelbegin \DIFdel{, S., Dominy , N.J., Elgart , A., Enrico , L., Fine , P.V.A., Howard , J.J., Jalili , A.,
Kitajima , K., Kurokawa , H., McArthur , C., Lucas , P.W., Markesteijn , L.}\DIFdelend \DIFaddbegin \DIFadd{S, Dominy NJ, Elgart A, Enrico L, Fine PVA, Howard JJ, Jalili A,
Kitajima K, Kurokawa H, McArthur C, Lucas PW, Markesteijn L}\DIFaddend ,
Pérez-Harguindeguy \DIFdelbegin \DIFdel{, N., Poorter , L., Richards , L., Santiago , L.S., Sosinski , E.E.}\DIFdelend \DIFaddbegin \DIFadd{N, Poorter L, Richards L, Santiago LS, Sosinski EE}\DIFaddend ,
Van Bael \DIFdelbegin \DIFdel{,
S.A., Warton , D.I., Wright , I.J.}\DIFdelend \DIFaddbegin \DIFadd{SA, Warton DI, Wright IJ}\DIFaddend , Joseph Wright \DIFdelbegin \DIFdel{, S., Yamashita , N .,
2011. }\DIFdelend \DIFaddbegin \DIFadd{S, Yamashita N (2011)
}\DIFaddend Global patterns of leaf mechanical properties. Ecology
\DIFdelbegin \DIFdel{Letters 14,
...
Onoda \DIFdelbegin \DIFdel{, Y., Wright , I.J., Evans , J.R., Hikosaka , K., Kitajima , K., Niinemets }\DIFdelend \DIFaddbegin \DIFadd{Y}\DIFaddend , \DIFaddbegin \DIFadd{Wright IJ, Evans JR, Hikosaka K, Kitajima K, Niinemets }\DIFaddend Ü\DIFdelbegin \DIFdel{.,
Poorter , H., Tosens , T., Westoby , M ., 2017. }\DIFdelend \DIFaddbegin \DIFadd{,
Poorter H, Tosens T, Westoby M (2017) }\DIFaddend Physiological and structural
tradeoffs underlying the leaf economics spectrum. New
\DIFdelbegin \DIFdel{Phytologist 214, }\DIFdelend \DIFaddbegin \DIFadd{Phytologist214:}\DIFaddend 1447--1463. \url{https://doi.org/10.1111/nph.14496}\DIFaddbegin \DIFadd{.
}\DIFaddend 

\bibitem[\citeproctext]{ref-Osada2001}
Osada \DIFdelbegin \DIFdel{, N., Takeda , H., Furukawa , A., Awang , M ., 2001. }\DIFdelend \DIFaddbegin \DIFadd{N, Takeda H, Furukawa A, Awang M (2001) }\DIFaddend Leaf dynamics and
maintenance of tree crowns in a malaysian rain forest stand. Journal of
\DIFdelbegin \DIFdel{Ecology 89, }\DIFdelend \DIFaddbegin \DIFadd{Ecology89:}\DIFaddend 774--782.
\url{https://doi.org/10.1046/j.0022-0477.2001.00590.x}\DIFaddbegin \DIFadd{.
}\DIFaddend 

\bibitem[\citeproctext]{ref-Osnas2018}
Osnas \DIFdelbegin \DIFdel{, J.L.D., Katabuchi , M., Kitajima , K., Wright , S.J., Reich , P.B.}\DIFdelend \DIFaddbegin \DIFadd{JLD, Katabuchi M, Kitajima K, Wright SJ, Reich PB}\DIFaddend , Van Bael \DIFdelbegin \DIFdel{, S.A.,
Kraft , N.J.B., Samaniego , M.J., Pacala , S.W., Lichstein ,
J.W., 2018. }\DIFdelend \DIFaddbegin \DIFadd{SA,
Kraft NJB, Samaniego MJ, Pacala SW, Lichstein JW (2018) }\DIFaddend Divergent
...
the United States of \DIFdelbegin \DIFdel{America 115, }\DIFdelend \DIFaddbegin \DIFadd{America115:}\DIFaddend 5480--5485.
\url{https://doi.org/10.1073/pnas.1803989115}\DIFaddbegin \DIFadd{.
}\DIFaddend 

\bibitem[\citeproctext]{ref-Osnas2013}
Osnas \DIFdelbegin \DIFdel{, J.L.D., Lichstein , J.W., Reich , P.B., Pacala , S.W., 2013. }\DIFdelend \DIFaddbegin \DIFadd{JLD, Lichstein JW, Reich PB, Pacala SW (2013) }\DIFaddend Global leaf trait
relationships: {Mass}, area, and the leaf economics spectrum.
\DIFdelbegin \DIFdel{Science 340, }\DIFdelend \DIFaddbegin \DIFadd{Science340:}\DIFaddend 741--744. \url{https://doi.org/10.1126/science.1231574}\DIFaddbegin \DIFadd{.
}\DIFaddend 

\bibitem[\citeproctext]{ref-Poorter2009}
Poorter \DIFdelbegin \DIFdel{, H., Niinemets }\DIFdelend \DIFaddbegin \DIFadd{H}\DIFaddend , \DIFaddbegin \DIFadd{Niinemets }\DIFaddend Ü\DIFdelbegin \DIFdel{., Poorter , L., Wright , I.J., Villar , R ., 2009.
}\DIFdelend \DIFaddbegin \DIFadd{, Poorter L, Wright IJ, Villar R (2009) }\DIFaddend Causes and
consequences of variation in leaf mass per area ({LMA}): {A}
meta-analysis. New \DIFdelbegin \DIFdel{Phytologist 182, }\DIFdelend \DIFaddbegin \DIFadd{Phytologist182:}\DIFaddend 565--588.
...
Reich \DIFdelbegin \DIFdel{, P.B., 2014. }\DIFdelend \DIFaddbegin \DIFadd{PB (2014) }\DIFaddend The world-wide 'fast-slow' plant economics spectrum: {A}
...
Russo \DIFdelbegin \DIFdel{, S.E., Kitajima , K ., 2016. }\DIFdelend \DIFaddbegin \DIFadd{SE, Kitajima K (2016) }\DIFaddend The {Ecophysiology} of {Leaf Lifespan} in
...
\url{https://doi.org/10.1007/978-3-319-27422-5_17}\DIFaddbegin \DIFadd{.
}\DIFaddend 

\bibitem[\citeproctext]{ref-Sakschewski2016}
Sakschewski \DIFdelbegin \DIFdel{, B.}\DIFdelend \DIFaddbegin \DIFadd{B}\DIFaddend , von Bloh \DIFdelbegin \DIFdel{, W., Boit , A., Poorter , L.}\DIFdelend \DIFaddbegin \DIFadd{W, Boit A, Poorter L}\DIFaddend , Peña-Claros \DIFdelbegin \DIFdel{, M., Heinke , J.,
Joshi , J., Thonicke , K ., 2016. }\DIFdelend \DIFaddbegin \DIFadd{M, Heinke J,
Joshi J, Thonicke K (2016) }\DIFaddend Resilience of {Amazon} forests emerges from
plant trait diversity. Nature Climate \DIFdelbegin \DIFdel{Change 6,
}\DIFdelend \DIFaddbegin \DIFadd{Change6:}\DIFaddend 1032--1036.
\url{https://doi.org/10.1038/nclimate3109}\DIFaddbegin \DIFadd{.
}\DIFaddend 

\bibitem[\citeproctext]{ref-Sakschewski2015}
Sakschewski \DIFdelbegin \DIFdel{, B.}\DIFdelend \DIFaddbegin \DIFadd{B}\DIFaddend , von Bloh \DIFdelbegin \DIFdel{, W., Boit , A., Rammig , A., Kattge , J., Poorter , L.}\DIFdelend \DIFaddbegin \DIFadd{W, Boit A, Rammig A, Kattge J, Poorter L}\DIFaddend ,
Peñuelas \DIFdelbegin \DIFdel{, J., Thonicke , K ., 2015. }\DIFdelend \DIFaddbegin \DIFadd{J, Thonicke K (2015) }\DIFaddend Leaf and stem economics spectra drive
...
Scheiter \DIFdelbegin \DIFdel{, S., Langan , L., Higgins , S.I., 2013. }\DIFdelend \DIFaddbegin \DIFadd{S, Langan L, Higgins SI (2013) }\DIFaddend Next-generation dynamic global
vegetation models: {Learning} from community ecology. New
\DIFdelbegin \DIFdel{Phytologist 198, }\DIFdelend \DIFaddbegin \DIFadd{Phytologist198:}\DIFaddend 957--969. \url{https://doi.org/10.1111/nph.12210}\DIFaddbegin \DIFadd{.
}\DIFaddend 

\bibitem[\citeproctext]{ref-Tcherkez2017}
Tcherkez \DIFdelbegin \DIFdel{, G., Gauthier , P., Buckley , T.N., Busch , F.A., Barbour , M.M., Bruhn , D.,
Heskel , M.A., Gong , X.Y., Crous , K.Y., Griffin , K., Way , D., Turnbull , M., Adams , M.A.,
Atkin , O.K., Farquhar , G.D., Cornic , G .,
2017. }\DIFdelend \DIFaddbegin \DIFadd{G, Gauthier P, Buckley TN, Busch FA, Barbour MM, Bruhn D,
Heskel MA, Gong XY, Crous KY, Griffin K, Way D, Turnbull M, Adams MA,
Atkin OK, Farquhar GD, Cornic G (2017) }\DIFaddend Leaf day respiration: Low {CO2}
...
Terashima \DIFdelbegin \DIFdel{, I., Hanba , Y.T., Tholen , D., Niinemets , U ., 2011. }\DIFdelend \DIFaddbegin \DIFadd{I, Hanba YT, Tholen D, Niinemets U (2011) }\DIFaddend Leaf {Functional
Anatomy} in {Relation} to {Photosynthesis}. Plant
\DIFdelbegin \DIFdel{Physiology
155, }\DIFdelend \DIFaddbegin \DIFadd{Physiology155:}\DIFaddend 108--116. \url{https://doi.org/10.1104/pp.110.165472}\DIFaddbegin \DIFadd{.
}\DIFaddend 

\bibitem[\citeproctext]{ref-Vehtari2017}
Vehtari \DIFdelbegin \DIFdel{, A., Gelman , A., Gabry , J ., 2017. }\DIFdelend \DIFaddbegin \DIFadd{A, Gelman A, Gabry J (2017) }\DIFaddend Practical {Bayesian} model
evaluation using leave-one-out cross-validation and {WAIC}. Statistics
and Computing\DIFaddbegin \DIFadd{:}\DIFaddend 1413--1432.
\url{https://doi.org/10.1007/s11222-016-9696-4}\DIFaddbegin \DIFadd{.
}\DIFaddend 

\bibitem[\citeproctext]{ref-Verheijen2013}
Verheijen \DIFdelbegin \DIFdel{, L.M., Brovkin , V., Aerts , R.}\DIFdelend \DIFaddbegin \DIFadd{LM, Brovkin V, Aerts R}\DIFaddend , Bönisch \DIFdelbegin \DIFdel{, G., Cornelissen ,
J.H.C., Kattge , J.,
Reich , P.B., Wright , I.J., Bodegom , P.M. van }\DIFdelend \DIFaddbegin \DIFadd{G}\DIFaddend , \DIFdelbegin \DIFdel{2013.
}\DIFdelend \DIFaddbegin \DIFadd{Cornelissen JHC, Kattge J,
Reich PB, Wright IJ, Bodegom PM van (2013) }\DIFaddend Impacts of trait variation
through observed trait--climate relationships on performance of an
{Earth} system model: A conceptual analysis.
\DIFdelbegin \DIFdel{Biogeosciences 10, }\DIFdelend \DIFaddbegin \DIFadd{Biogeosciences10:}\DIFaddend 5497--5515.
\url{https://doi.org/10.5194/bg-10-5497-2013}\DIFaddbegin \DIFadd{.
}\DIFaddend 

\bibitem[\citeproctext]{ref-Villar2001}
Villar \DIFdelbegin \DIFdel{, R., Merino , J ., 2001. }\DIFdelend \DIFaddbegin \DIFadd{R, Merino J (2001) }\DIFaddend Comparison of leaf construction costs in woody
...
Westoby \DIFdelbegin \DIFdel{, M., Reich , P.B., Wright , I.J., 2013. }\DIFdelend \DIFaddbegin \DIFadd{M, Reich PB, Wright IJ (2013) }\DIFaddend Understanding ecological variation
across species: {Area-based} vs mass-based expression of leaf traits.
New \DIFdelbegin \DIFdel{Phytologist 199, }\DIFdelend \DIFaddbegin \DIFadd{Phytologist199:}\DIFaddend 322--323. \url{https://doi.org/10.1111/nph.12345}\DIFaddbegin \DIFadd{.
}\DIFaddend 

\bibitem[\citeproctext]{ref-Westoby2000}
Westoby \DIFdelbegin \DIFdel{, M., Warton , D., Reich , P.B., 2000. }\DIFdelend \DIFaddbegin \DIFadd{M, Warton D, Reich PB (2000) }\DIFaddend The {Time Value} of {Leaf Area}.
The American \DIFdelbegin \DIFdel{Naturalist 155, }\DIFdelend \DIFaddbegin \DIFadd{Naturalist155:}\DIFaddend 649--656.
\url{https://doi.org/10.1086/303346}\DIFaddbegin \DIFadd{.
}\DIFaddend 

\bibitem[\citeproctext]{ref-Williams1989}
Williams \DIFdelbegin \DIFdel{, K., Field , C.B., Mooney , H.A., 1989. }\DIFdelend \DIFaddbegin \DIFadd{K, Field CB, Mooney HA (1989) }\DIFaddend Relationships {Among Leaf
Construction Cost}, {Leaf Longevity}, and {Light Environment} in
{Rain-Forest Plants} of the {Genus Piper}. The American
\DIFdelbegin \DIFdel{Naturalist 133,
}\DIFdelend \DIFaddbegin \DIFadd{Naturalist133:}\DIFaddend 198--211. \url{https://doi.org/10.1086/284910}\DIFaddbegin \DIFadd{.
}\DIFaddend 

\bibitem[\citeproctext]{ref-Wright2004a}
Wright \DIFdelbegin \DIFdel{, I.J., Reich , P.B., Westoby , M., Ackerly , D.D., Baruch , Z., Bongers , F.}\DIFdelend \DIFaddbegin \DIFadd{IJ, Reich PB, Westoby M, Ackerly DD, Baruch Z, Bongers F}\DIFaddend ,
Cavender-Bares \DIFdelbegin \DIFdel{, J., Chapin , T., Cornellssen , J.H.C., Diemer , M., Flexas , J., Garnier
, E., Groom , P.K., Gulias , J., Hikosaka ,
K., Lamont , B.B., Lee , T., Lee , W., Lusk , C.,
Midgley , J.J., Navas ,
M.L., Niinemets }\DIFdelend \DIFaddbegin \DIFadd{J, Chapin T, Cornellssen JHC, Diemer M, Flexas J, Garnier
E, Groom PK, Gulias J}\DIFaddend , \DIFaddbegin \DIFadd{Hikosaka K, Lamont BB, Lee T, Lee W, Lusk C,
Midgley JJ, Navas ML, Niinemets }\DIFaddend Ü\DIFdelbegin \DIFdel{., Oleksyn , J., Osada , H., Poorter , H., Pool
, P., Prior , L., Pyankov , V.I., Roumet , C., Thomas , S.C., Tjoelker , M.G., Veneklaas , E.J.,
Villar , R ., 2004. }\DIFdelend \DIFaddbegin \DIFadd{, Oleksyn J, Osada H, Poorter H, Pool
P, Prior L, Pyankov VI, Roumet C, Thomas SC, Tjoelker MG, Veneklaas EJ,
Villar R (2004) }\DIFaddend The worldwide leaf economics spectrum.
\DIFdelbegin \DIFdel{Nature 428, }\DIFdelend \DIFaddbegin \DIFadd{Nature428:}\DIFaddend 821--827. \url{https://doi.org/10.1038/nature02403}\DIFaddbegin \DIFadd{.
}\DIFaddend 

\bibitem[\citeproctext]{ref-Wright2003}
Wright \DIFdelbegin \DIFdel{, S.J., Horlyck , V., Basset , Y., Barrios , H., Bethancourt , A., Bohlman , S.,
Gilbert , G., Goldstein , G., Graham , E.A., Kitajima , K., Lerdau , M.T., Meinzer , F.C.}\DIFdelend \DIFaddbegin \DIFadd{SJ, Horlyck V, Basset Y, Barrios H, Bethancourt A, Bohlman S,
Gilbert G, Goldstein G, Graham EA, Kitajima K, Lerdau MT, Meinzer FC}\DIFaddend ,
Ødegaard \DIFdelbegin \DIFdel{, F., Reynolds , D.R., Roubik , D.W., Sakai , S., Samaniego , M., Sparks , J.P.}\DIFdelend \DIFaddbegin \DIFadd{F, Reynolds DR, Roubik DW, Sakai S, Samaniego M, Sparks JP}\DIFaddend , Van
Bael \DIFdelbegin \DIFdel{, S., Winter , K., Zotz ,
G ., 2003. }\DIFdelend \DIFaddbegin \DIFadd{S, Winter K, Zotz G (2003) }\DIFaddend Tropical {Canopy Biology Program},
{Republic} of {Panama}\DIFdelbegin \DIFdel{, in:
Basset, Y., Horlyck, V., Wright, S.J. (Eds. ), }\DIFdelend \DIFaddbegin \DIFadd{. }\DIFaddend Studying {Forest Canopies} from {Above}: {The
International Canopy Crane Network}\DIFdelbegin \DIFdel{. Panama, pp.
}\DIFdelend \DIFaddbegin \DIFadd{:}\DIFaddend 137--155.

\bibitem[\citeproctext]{ref-Wullschleger2014}
Wullschleger \DIFdelbegin \DIFdel{, S.D., Epstein , H.E., Box , E.O., Euskirchen , E.S., Goswami ,
S., Iversen
, C.M., Kattge , J., Norby , R.J.}\DIFdelend \DIFaddbegin \DIFadd{SD, Epstein HE, Box EO, Euskirchen ES, Goswami S, Iversen
CM, Kattge J, Norby RJ}\DIFaddend , Van Bodegom \DIFdelbegin \DIFdel{, P.M., Xu , X .,
2014. }\DIFdelend \DIFaddbegin \DIFadd{PM, Xu X (2014) }\DIFaddend Plant functional
...
ecosystems. Annals of \DIFdelbegin \DIFdel{Botany 114, }\DIFdelend \DIFaddbegin \DIFadd{Botany114:}\DIFaddend 1--16.
\url{https://doi.org/10.1093/aob/mcu077}\DIFaddbegin \DIFadd{.
}\DIFaddend 

\bibitem[\citeproctext]{ref-Wurth2005}
Würth \DIFdelbegin \DIFdel{, M.K.R.}\DIFdelend \DIFaddbegin \DIFadd{MKR}\DIFaddend , Peláez-Riedl \DIFdelbegin \DIFdel{, S., Wright , S.J.}\DIFdelend \DIFaddbegin \DIFadd{S, Wright SJ}\DIFaddend , Körner \DIFdelbegin \DIFdel{, C ., 2005.
}\DIFdelend \DIFaddbegin \DIFadd{C (2005) }\DIFaddend Non-structural
carbohydrate pools in a tropical forest. \DIFdelbegin \DIFdel{Oecologia 143,
...
Xu \DIFdelbegin \DIFdel{, X., Medvigy , D.}\DIFdelend \DIFaddbegin \DIFadd{X, Medvigy D}\DIFaddend , Joseph Wright \DIFdelbegin \DIFdel{, S., Kitajima , K., Wu , J., Albert ,
L.P., Martins
, G.A., Saleska , S.R., Pacala , S.W., 2017. }\DIFdelend \DIFaddbegin \DIFadd{S, Kitajima K, Wu J, Albert LP, Martins
GA, Saleska SR, Pacala SW (2017) }\DIFaddend Variations of leaf longevity in
tropical moist forests predicted by a trait-driven carbon optimality
model. Ecology \DIFdelbegin \DIFdel{Letters 20, }\DIFdelend \DIFaddbegin \DIFadd{Letters20:}\DIFaddend 1097--1106.
\url{https://doi.org/10.1111/ele.12804}\DIFaddbegin \DIFadd{.
}\DIFaddend 
...
%DIFDELCMD < Relationships between mass dependency (\emph{b} in Eq. S5) and LMAs
%DIFDELCMD < variance (relative to total LMA variance; Eq. S7) for the global GLPNET
%DIFDELCMD < dataset, sun leaves in Panama, and shade leaves in Panama. Solid lines
%DIFDELCMD < indicate simulated medians and shaded regions indicate 95\% confidence
%DIFDELCMD < intervals. Each point indicates the estimated values from the empirical
%DIFDELCMD < data and represents interspecific variation (e.g., across species within
%DIFDELCMD < a canopy position in the Panama dataset). The y-axis values indicates if
%DIFDELCMD < photosynthetic capacity (\emph{A}\textsubscript{max}) is is primarily
%DIFDELCMD < mass-dependent (\emph{b} \textgreater{} 0.5) or primarily area-dependent
%DIFDELCMD < (0.5 \textgreater{} \emph{b} \textgreater{} 0), with \emph{b} near 0
%DIFDELCMD < indicating purely area-dependendence (\citeproc{ref-Osnas2018}{Osnas et
%DIFDELCMD < al., 2018}). If \emph{b} \textgreater{} 1, then
%DIFDELCMD < \emph{A}\textsubscript{max} increases exponentially with LMA, which is
%DIFDELCMD < not consistent with observed relationships
%DIFDELCMD < (\citeproc{ref-Osnas2018}{Osnas et al., 2018}). See Appendices 9-6 for
%DIFDELCMD < details. \includegraphics{../figs/mass_prop_mv.png}
%DIFDELCMD < 
...
\caption{\label{fig-mass_prop}\DIFaddbeginFL \DIFaddFL{Relationships between mass dependency
(}\emph{\DIFaddFL{b}} \DIFaddFL{in Eq. S5.1) and LMAs variance (relative to total LMA
...
capacity (}\emph{\DIFaddFL{A}}\DIFaddFL{\textsubscript{max}) is is primarily mass-dependent
(}\emph{\DIFaddFL{b}} \DIFaddFL{\textgreater{} 0.5) or primarily area-dependent (0.5
\textgreater{} }\emph{\DIFaddFL{b}} \DIFaddFL{\textgreater{} 0), with }\emph{\DIFaddFL{b}} \DIFaddFL{near 0
indicating purely area-dependence (\mbox{%DIFAUXCMD
\citeproc{ref-Osnas2018}{Osnas JLD et
al. 2018}}\hspace{0pt}%DIFAUXCMD
). If }\emph{\DIFaddFL{b}} \DIFaddFL{\textgreater{} 1, then
}\emph{\DIFaddFL{A}}\DIFaddFL{\textsubscript{max} increases exponentially with LMA, which is
not consistent with observed relationships
(\mbox{%DIFAUXCMD
\citeproc{ref-Osnas2018}{Osnas JLD et al. 2018}}\hspace{0pt}%DIFAUXCMD
). See Supplementary
Sections 4-6 for details.}\DIFaddendFL }
