...
%DIF DEL LMAms_main_old.tex   Fri Oct 25 09:31:43 2024
%DIF ADD LMAms_main.tex       Fri Oct 25 09:31:29 2024
...
\DIFdel{Fisher, R.A.
, Koven, C.D., Anderegg, W.R.L., Christoffersen, B.O.,
...
\DIFdelbegin \DIFdel{Gelman, A., Carlin, J.B., Stern, H.S., Dunson, D.
B. , Vehtari, A., Rubin,
D.
B.
...
P.W.
, Wright, S.J., 2012. How cellulose-based leaf toughness and lamina
density contribute to long leaf lifespans of shade-tolerant species. New
...
\DIFdel{Osnas, J.L.D., Lichstein, J.W., Reich, P.B., Pacala, S.W., 2013. Global
leaf trait relationships: }%DIFDELCMD < {%%%
\DIFdel{Mass}%DIFDELCMD < }%%%
\DIFdel{, area, and the leaf economics spectrum.
Science 340, 741--744.
}%DIFDELCMD < \url{https://doi.org/10.1126/science.1231574}
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \DIFadd{.
}\DIFaddend 
...
Heinke, J.
, Joshi, J., Thonicke, K., 2016. Resilience of }%DIFDELCMD < {%%%
...
Diemer, M., Flexas, J., Garnier, E., Groom, P.K., Gulias, J.
, Hikosaka,
...
Supplementary Section \DIFdelbeginFL \DIFdelFL{6.}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{5.}\DIFaddendFL }
...
indicating purely area-dependence (\DIFdelbeginFL \DIFdelFL{\mbox{%DIFAUXCMD
...
2018}}\hspace{0pt}%DIFAUXCMD
}\DIFaddendFL ). If \emph{b} \textgreater{} 1, then \emph{A}\textsubscript{max}
increases exponentially with LMA, which is not consistent with observed
relationships (\DIFdelbeginFL \DIFdelFL{\mbox{%DIFAUXCMD
\citeproc{ref-Osnas2018}{Osnas et al., 2018}}\hspace{0pt}%DIFAUXCMD
}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{\mbox{%DIFAUXCMD
\citeproc{ref-Osnas2018}{Osnas et al. 2018}}\hspace{0pt}%DIFAUXCMD
}\DIFaddendFL ). See
Supplementary Sections \DIFdelbeginFL \DIFdelFL{4-6 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{4-5 }\DIFaddendFL for details.}
