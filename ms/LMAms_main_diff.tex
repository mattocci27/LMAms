...
%DIF DEL LMAms_main_old.tex   Thu Oct 17 09:57:30 2024
%DIF ADD LMAms_main.tex       Thu Oct 17 09:57:11 2024
...
species across light gradients (\DIFaddbegin \DIFadd{\mbox{%DIFAUXCMD
\citeproc{ref-Niinemets2015}{Niinemets
et al., 2015}}\hspace{0pt}%DIFAUXCMD
; }\DIFaddend \citeproc{ref-Osada2001}{Osada et al., 2001};
...
principles alone (\DIFaddbegin \DIFadd{\mbox{%DIFAUXCMD
\citeproc{ref-Kikuzawa1991}{Kikuzawa, 1991}}\hspace{0pt}%DIFAUXCMD
;
}\DIFaddend \citeproc{ref-Westoby2013}{Westoby et al., 2013}), because leaf mass
...
\citeproc{ref-Westoby2000}{Westoby et al., 2000}), \DIFdelbegin \DIFdel{traits should be normalized by their }\DIFdelend \DIFaddbegin \DIFadd{leaf economics
...
}\DIFaddend (\citeproc{ref-Osnas2013}{Osnas et al., 2013}). In global analyses,
...
(\citeproc{ref-Lloyd2013}{Lloyd et al., 2013};
\citeproc{ref-Osnas2013}{Osnas et al., 2013}) \DIFdelbegin \DIFdel{do notinvalidate
...
}\DIFdelend \DIFaddbegin \DIFadd{suggest that strong
...
components (\DIFdelbegin \DIFdel{Appendices }\DIFdelend \DIFaddbegin \DIFadd{Section 2.2 and Supplementary Sections }\DIFaddend 1-2). \DIFdelbegin \DIFdel{By using power-law relationships, our
...
cannot be neatly classified as `metabolic' or `structural'. }\DIFdelend We fit the
...
observed trait data (Supplementary Section 3). \DIFaddbegin \DIFadd{We then used the model
...
Osnas et al. (\DIFdelbegin \DIFdel{\mbox{%DIFAUXCMD
...
}\DIFaddend (\citeproc{ref-RCoreTeam2022}{R Core Team, 2022}) using the R package
\emph{targets} version \DIFdelbegin \DIFdel{0.12.0 }\DIFdelend \DIFaddbegin \DIFadd{1.5.1 }\DIFaddend for workflow management
(\citeproc{ref-Landau2021}{Landau, 2021})\DIFaddbegin \DIFadd{.
}\DIFaddend 
...
\DIFdelbegin \DIFdel{These models with leaf
...
%DIFDELCMD < %%%
\DIFdel{For example }\DIFdelend \DIFaddbegin 
...
accurate and reliable approximation \DIFdelbegin \DIFdel{to }\DIFdelend \DIFaddbegin \DIFadd{for }\DIFaddend standard leave-one-out
...
\textasciitilde60\% for evergreen species \DIFdelbegin \DIFdel{and }\DIFdelend \DIFaddbegin \DIFadd{vs.~}\DIFaddend \textasciitilde40\% for
deciduous species (Fig. S2), and \DIFdelbegin \DIFdel{15-40}\DIFdelend \DIFaddbegin \DIFadd{\textasciitilde70}\DIFaddend \% for shade leaves
\DIFdelbegin \DIFdel{and 50-70}\DIFdelend \DIFaddbegin \DIFadd{vs.~\textasciitilde40}\DIFaddend \% for sun leaves (Fig. S3). These estimates align
with measurements of cell wall (fibre) content from a global dataset
(\DIFdelbegin \DIFdel{14--77\%, }\DIFdelend median 47\% of total leaf mass \DIFaddbegin \DIFadd{across species and canopy positions}\DIFaddend ,
...
across species \DIFaddbegin \DIFadd{and canopy positions}\DIFaddend , with higher values for shade
...
light availability (\citeproc{ref-Kikuzawa1991}{Kikuzawa, 1991}) \DIFdelbegin \DIFdel{- }\DIFdelend \DIFaddbegin \DIFadd{− }\DIFaddend as
...
(\citeproc{ref-Martinez-Vilalta2016}{Martínez-Vilalta et al., 2016}). \DIFdelbegin \DIFdel{Although scaling parameters in our model allow us to include
non-metabolic leaf mass in LMAm, a }\DIFdelend \DIFaddbegin \DIFadd{A
...
Panama dataset }\DIFdelend (\citeproc{ref-Osnas2018}{Osnas et al., 2018}).
...
\DIFdelbegin \DIFdel{System Models }\DIFdelend \DIFaddbegin \DIFadd{system models }\DIFaddend (ESMs, \citeproc{ref-Moorcroft2006}{Moorcroft, 2006};
...
\DIFaddbegin \bibitem[\citeproctext]{ref-Falster2017}
\DIFadd{Falster, D.S., Brännström, Å., Westoby, M., Dieckmann, U., 2017.
...
\DIFaddend \bibitem[\citeproctext]{ref-Falster2012}
...
\DIFaddbegin \bibitem[\citeproctext]{ref-Niinemets2015}
\DIFadd{Niinemets, Ü., Keenan, T.F., Hallik, L., 2015. A worldwide analysis of
...
\DIFaddend \bibitem[\citeproctext]{ref-Onoda2015}
