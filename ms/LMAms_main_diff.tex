...
%DIF DEL LMAms_main_old.tex   Thu Oct 24 08:01:54 2024
%DIF ADD LMAms_main.tex       Thu Oct 24 08:00:47 2024
...
how light affects LL via leaf carbon balance (\mbox{%DIFAUXCMD
\citeproc{ref-Xu2017}{Xu
et al. 2017}}\hspace{0pt}%DIFAUXCMD
) is beyond the scope of our study. Instead, we introduced
...
interspecific analysis \DIFaddbegin \DIFadd{suggesting weak mass-dependence of
...
\DIFdelbegin \DIFdel{System Models }\DIFdelend \DIFaddbegin \DIFadd{system models }\DIFaddend (ESMs, \DIFdelbegin \DIFdel{\mbox{%DIFAUXCMD
...
\subsection{\DIFadd{Authors' contributions}}\label{authors-contributions}
...
\DIFdelbegin \DIFdel{Bonan, G.B., Levis, S., Kergoat, L. , Oleson, K. W. , 2002. }\DIFdelend \DIFaddbegin \DIFadd{Bonan et al. (2002) }\DIFaddend Landscapes as patches of plant functional types:
...
\url{https://doi.org/10.1093/jxb/erp117}\DIFaddbegin \DIFadd{.
}\DIFaddend 
...
\DIFdelbegin \DIFdel{Gelman, A., Carlin, J.B.
, Stern, H.S., Dunson, D.B. , Vehtari, A., Rubin,
D.
B.
...
\DIFdel{Kitajima, K., Llorens, A.M., Stefanescu, C., Timchenko, M.V., Lucas,
P.W., Wright, S.J., 2012. How cellulose-based leaf toughness and lamina
density contribute to long leaf lifespans of shade-tolerant species. New
Phytologist 195, 640--652.
}%DIFDELCMD < \url{https://doi.org/10.1111/j.1469-8137.2012.04203.x}
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \DIFadd{.
}\DIFaddend 
...
\DIFadd{Niinemets et al. (2015) A worldwide analysis of within-canopy variations
...
\DIFadd{Niinemets, and Sack (2006) Structural determinants of leaf
...
\DIFdel{Osnas, J.L.D., Lichstein, J.
W., Reich, P.B., Pacala, S.W., 2013. Global
...
\DIFdel{Sakschewski, B., von Bloh, W., Boit, A., Poorter, L., Peña-Claros, M.,
...
1032--1036.
}%DIFDELCMD < \url{https://doi.org/10.1038/nclimate3109}
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \DIFadd{.
}\DIFaddend 
...
\DIFdel{Westoby, M., Warton, D., Reich, P.B., 2000. The }%DIFDELCMD < {%%%
\DIFdel{Time Value}%DIFDELCMD < } %%%
\DIFdel{of }%DIFDELCMD < {%%%
\DIFdel{Leaf
Area}%DIFDELCMD < }%%%
\DIFdel{. The American Naturalist 155, 649--656.
}%DIFDELCMD < \url{https://doi.org/10.1086/303346}
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \DIFadd{.
}\DIFaddend 
...
\DIFdel{Wright, I.J., Reich, P.B., Westoby, M., Ackerly, D.D., Baruch, Z.,
...
\citeproc{ref-Osnas2018}{Osnas et al.
2018}}\hspace{0pt}%DIFAUXCMD
). If }\emph{\DIFaddFL{b}} \DIFaddFL{\textgreater{} 1, then }\emph{\DIFaddFL{A}}\DIFaddFL{\textsubscript{max}
increases exponentially with LMA, which is not consistent with observed
relationships (\mbox{%DIFAUXCMD
\citeproc{ref-Osnas2018}{Osnas et al. 2018}}\hspace{0pt}%DIFAUXCMD
). See
Supplementary Sections 4-6 for details.}\DIFaddendFL }
