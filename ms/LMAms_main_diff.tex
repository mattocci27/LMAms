...
%DIF DEL LMAms_main_old.tex   Mon Feb 10 10:13:22 2025
%DIF ADD LMAms_main.tex       Mon Feb 10 10:13:02 2025
...
sun leaves ; Onoda et al.
~2011)and a Panama study site (Barro Colorado
Island, BCI: \textasciitilde50\% mean across species and
canopy
positions, with higher values for shade leaves ; Kitajima et al.
~2016}\DIFdelend \DIFaddbegin \DIFadd{fiber) content (\mbox{%DIFAUXCMD
...
\ref{fig-pa_point}d-f}\DIFaddend ).
...
well as
variation in leaf toughness for a given value of LMAs . In a
...
\DIFdel{\textsubscript{area}}\DIFdelend \DIFaddbegin \DIFadd{Finally, the clustering of unclassified species (not reported as
...
(\mbox{%DIFAUXCMD
\citeproc{ref-Onoda2011}{Onoda et al. 2011}}\hspace{0pt}%DIFAUXCMD
)}\DIFaddend , \DIFdelbegin \emph{\DIFdel{R}}%DIFAUXCMD
...
maintenance respiration rate indistinguishable from
zero. Like total
...
canopy positions as well as ecophysiological tradeoffs across edaphic-climate gradients}\DIFdelend \DIFaddbegin \DIFadd{which likely explain
...
). Because LMA encompasses varying
...
function across diverse plant forms}\DIFaddend .
...
to different functions\DIFaddbegin \DIFadd{. Single-axis approaches could not capture the
