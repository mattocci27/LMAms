...
%DIF DEL LMAms_main_old.tex   Wed Jan 22 10:34:23 2025
%DIF ADD LMAms_main.tex       Wed Jan 22 10:32:45 2025
...
al. 2016})\DIFaddbegin \DIFadd{.
}

\DIFadd{Furthermore, 65\% of these ``unclassified'' species are grasses or
herbaceous forbs, which often have lower leaf tissue density reduced
structural fiber content than woody plants
(\mbox{%DIFAUXCMD
\citeproc{ref-Onoda2011}{Onoda et al. 2011}}\hspace{0pt}%DIFAUXCMD
). This likely contributes
to their markedly low LMAs (Fig.~\ref{fig-pa_point}i). In this sense,
growth form adds another dimension of LMA variation, particularly in
herbs that invest relatively little mass in toughening tissues}\DIFaddend .
