...
%DIF DEL /var/folders/ph/r5fc9nzd1j38q4j50kgwd4cw0000gn/T/7EhCb9aB37/latexdiff-vc-621812a/ms/LMAms_main.tex   Fri Apr  7 11:37:03 2023
%DIF ADD ms/LMAms_main.tex                                                                                    Tue Jan 16 17:03:04 2024
...
\makeatletter
%DIF 167c170
%DIF < \@ifpackageloaded{tcolorbox}{}{\usepackage[many]{tcolorbox}}
%DIF -------
\@ifpackageloaded{tcolorbox}{}{\usepackage[skins,breakable]{tcolorbox}} %DIF > 
%DIF -------
\makeatother
\makeatletter
...
\begin{document}
\ifdefined\Shaded\DIFdelbegin %DIFDELCMD < \renewenvironment{Shaded}{\begin{tcolorbox}[sharp corners, enhanced, frame hidden, borderline west={3pt}{0pt}{shadecolor}, interior hidden, breakable, boxrule=0pt]}{\end{tcolorbox}}%%%
\DIFdelend \DIFaddbegin \renewenvironment{Shaded}{\begin{tcolorbox}[interior hidden, sharp corners, enhanced, borderline west={3pt}{0pt}{shadecolor}, breakable, boxrule=0pt, frame hidden]}{\end{tcolorbox}}\DIFaddend \fi
...
%DIFDELCMD <   %%%
\DIFdelend \DIFaddbegin \DIFadd{In order to explain these contrasting
patterns, }\DIFaddend We developed a statistical modeling framework to decompose LMA
...
leaf mass and area (\protect\DIFaddbegin \hyperlink{ref-Lusk2008}{Lusk et al. 2008}\DIFadd{,
}\protect\DIFaddend \hyperlink{ref-Osnas2018}{Osnas et al. 2018}). These divergent
...
\protect\hyperlink{ref-Sakschewski2016}{Sakschewski et al. 2016}). \DIFaddbegin \DIFadd{On
the one hand, mass-normalization has been justified based on economic
principles alone (}\protect\hyperlink{ref-Kikuzawa1991}{Kikuzawa 1991}\DIFadd{,
}\protect\hyperlink{ref-Westoby2013}{Westoby et al. 2013}\DIFadd{), because leaf
...
LMA into metabolic and structural components: LMAm and LMAs. \DIFaddbegin \DIFadd{Our models
...
which resist simplistic `metabolic' or `structural' categorization. }\DIFaddend We
develop and test this two-dimensional \DIFaddbegin \DIFadd{trait space }\DIFaddend model using leaf trait
...
one-dimensional (total LMA) or two-dimensional (LMAm-LMAs) \DIFaddbegin \DIFadd{trait space
}\DIFaddend model? (2) What are the relative contributions of LMAm and LMAs to total
...
model tests. We considered a simple one-dimensional \DIFaddbegin \DIFadd{trait space }\DIFaddend model
that predicts LL, \emph{A}\textsubscript{max}, and
\emph{R}\textsubscript{dark} from LMA alone, as well as two-dimensional
\DIFaddbegin \DIFadd{trait space }\DIFaddend models that predict LL, \emph{A}\textsubscript{max}, and
\emph{R}\textsubscript{dark} from two additive LMA components: \DIFdelbegin \DIFdel{structural and }\DIFdelend metabolic
...
To implement the two-dimensional \DIFaddbegin \DIFadd{trait space }\DIFaddend models, we developed a
statistical modeling framework to partition LMA into additive LMAm and
LMAs components \DIFdelbegin \DIFdel{. }\DIFdelend \DIFaddbegin \DIFadd{(Appendices S1-S2). By using power-law relationships,
...
observed), the two-dimensional \DIFaddbegin \DIFadd{trait space }\DIFaddend models require one parameter
...
\DIFaddbegin \DIFadd{trait space }\DIFaddend models were prone to overfitting, which could lead to
spurious conclusions. These tests suggested that our two-dimensional
\DIFaddbegin \DIFadd{trait space }\DIFaddend modeling approach revealed meaningful patterns in the
observed trait data \DIFaddbegin \DIFadd{(Appendix S3)}\DIFaddend .

\DIFaddbegin \DIFadd{To further understand the intricacies of LMA to photosynthetic capacity
...
\DIFaddend All statistical analyses were conducted in R version 4.2.1
...
with \DIFdelbegin \DIFdel{LMAs/LT }\DIFdelend \DIFaddbegin \DIFadd{leaf thickness }\DIFaddend yielded qualitatively similar results as those
\DIFdelbegin \DIFdel{based on
LMAs, but }\DIFdelend \DIFaddbegin \DIFadd{without leaf thickness, but they }\DIFaddend did not perform as well in the model
...
0) leads to a more parsimonious model (fewer parameters).
We considered
...
\DIFdel{\textsubscript{area} (\(\gamma_m\) and \(\gamma_s\)).
}\DIFdelend \DIFaddbegin \DIFadd{See Table 1 Appendix
S2 for more detail.
}\DIFaddend 
...
(\protect\hyperlink{ref-Wright2003}{Wright et al. 2003}). The \DIFdelbegin \DIFdel{PNM crane
is 40 m tall with a 51 m long boom. The }\DIFdelend wet SL
...
\DIFdelbegin \DIFdel{The SL crane
is 52 m tall with a 54 m long boom. }\DIFdelend Additional details of the Panama dataset are described in Osnas et al.
...
LL; each typically averaged over multiple leaves) were available. \DIFdelbegin \DIFdel{Each
...
canopy position in the Panama dataset. }\DIFdelend After
...
\DIFdelbegin \DIFdel{Because }\DIFdelend \DIFaddbegin \DIFadd{Considering the complexity of }\DIFaddend our two-dimensional \DIFdelbegin \DIFdel{(LMAm-LMAs) modeling
approachincludes many
parameters (one latent variable }\emph{\DIFdel{f\textsubscript{i}}} %DIFAUXCMD
\DIFdel{to partition
LMA into }\DIFdelend \DIFaddbegin \DIFadd{trait space modeling
approach, which involves numerous latent parameters, we validated our
estimates of }\DIFaddend LMAm and LMAs \DIFdelbegin \DIFdel{for each leaf sample), we implemented tests with
randomized data to assess potential overfitting. We generated 10
different randomized datasets by randomizing all trait values (LMA, }\emph{\DIFdel{A}}%DIFAUXCMD
...
(}%DIFDELCMD < \protect\hyperlink{ref-Betancourt2016}{Betancourt 2016}%%%
\DIFdel{). Furthermore,
...
(total LMA) for both GLOPNET and Panama (see Results). Thus, the tests with randomized data indicate that our two-dimensional approach is not
inherently prone to overfitting or to creating spurious results. We
therefore assume that estimates of LMAm and LMAs obtained from the }\DIFdelend \DIFaddbegin \DIFadd{through randomized tests, detailed in
Appendix S3. These tests support our assumption that the patterns
observed in the }\DIFaddend GLOPNET and Panama datasets \DIFdelbegin \DIFdel{reflect meaningful patterns in the
observations }\DIFdelend \DIFaddbegin \DIFadd{are meaningful }\DIFaddend and allow for
a \DIFdelbegin \DIFdel{meaningful }\DIFdelend \DIFaddbegin \DIFadd{substantial }\DIFaddend exploration of our questions.
...
(\protect\hyperlink{ref-Vehtari2017}{Vehtari et al. 2017}))\DIFdelbegin \DIFdel{to compare the performance of different models}\DIFdelend . PSIS-LOO is
...
(\protect\hyperlink{ref-Vehtari2017}{Vehtari et al. 2017}). \DIFdelbegin \DIFdel{LOO requires
}\emph{\DIFdel{n}} %DIFAUXCMD
\DIFdel{model fits (for a dataset with }\emph{\DIFdel{n}} %DIFAUXCMD
\DIFdel{observations) and was
therefore impractical in our study due to our computationally-demanding
modeling approach. }\DIFdelend We used
PSIS-LOO to calculate the LOO Information Criterion (LOOIC) for each
model. A \DIFdelbegin \DIFdel{lower LOOIC indicates a better model
in terms of }\DIFdelend \DIFaddbegin \DIFadd{model with lower LOOIC is considered to have better }\DIFaddend predictive
accuracy (\protect\hyperlink{ref-Vehtari2017}{Vehtari et al. 2017}).

\DIFdelbegin %DIFDELCMD < \hypertarget{understanding-relationships-between-photosynthetic-capacity-and-lma}{%
%DIFDELCMD < \subsection{Understanding relationships between photosynthetic capacity
%DIFDELCMD < and
%DIFDELCMD < LMA}\label{understanding-relationships-between-photosynthetic-capacity-and-lma}}
%DIFDELCMD < 
...
controversial (}%DIFDELCMD < \protect\hyperlink{ref-Westoby2013}{Westoby et al.
%DIFDELCMD < 2013}%%%
\DIFdel{). Although }\emph{\DIFdel{A}}%DIFAUXCMD
\DIFdel{\textsubscript{max} is often mass-normalized
(e.g., }%DIFDELCMD < \protect\hyperlink{ref-Wright2004a}{Wright et al. 2004}%%%
\DIFdel{,
}%DIFDELCMD < \protect\hyperlink{ref-Shipley2006}{Shipley et al. 2006}%%%
\DIFdel{,
}%DIFDELCMD < \protect\hyperlink{ref-Blonder2011}{Blonder et al. 2011}%%%
\DIFdel{), it has been
argued that }\emph{\DIFdel{A}}%DIFAUXCMD
...
process (}%DIFDELCMD < \protect\hyperlink{ref-Lloyd2013}{Lloyd et al. 2013}%%%
\DIFdel{).
Consistent with this argument, Osnas et al.
(}%DIFDELCMD < \protect\hyperlink{ref-Osnas2013}{2013}%%%
\DIFdel{) showed that across global
species, variation in whole-leaf }\emph{\DIFdel{A}}%DIFAUXCMD
\DIFdel{\textsubscript{max} is strongly
...
\DIFdel{) further showed that the
...
following Osnas et al. (}%DIFDELCMD < \protect\hyperlink{ref-Osnas2018}{2018}%%%
\DIFdel{):
}%DIFDELCMD < 
...
the following cases (}%DIFDELCMD < \protect\hyperlink{ref-Osnas2013}{Osnas et al.
%DIFDELCMD < 2013}%%%
\DIFdel{, }%DIFDELCMD < \protect\hyperlink{ref-Osnas2018}{2018}%%%
\DIFdel{): if }\emph{\DIFdel{b}} %DIFAUXCMD
\DIFdel{= 0, then
}\emph{\DIFdel{A}}%DIFAUXCMD
...
\DIFdel{\textsubscript{max} yields equivalent results
(}%DIFDELCMD < \protect\hyperlink{ref-Osnas2018}{Osnas et al. 2018}%%%
\DIFdel{).
}%DIFDELCMD < 
...
%DIFDELCMD < \hypertarget{variance-partitioning}{%
%DIFDELCMD < \subsection{Variance partitioning}\label{variance-partitioning}}
%DIFDELCMD < 
...
datasets, two-dimensional \DIFaddbegin \DIFadd{trait space }\DIFaddend models (LMAm-LMAs) performed
...
(LMAm) accounted for nearly all leaf dark respiration; i.e., \DIFaddbegin \DIFadd{the
}\DIFaddend estimated dark respiration rate per-unit structural mass (\(\gamma_s\))
was close to zero for both GLOPNET and Panama (Table 2). Thus, although
building costs appear similar for different leaf chemical components and
tissues (\protect\hyperlink{ref-Williams1989}{Williams et al. 1989},
...
relative to a simpler one-dimensional \DIFaddbegin \DIFadd{trait space }\DIFaddend model based on total
...
than mass-dependent \DIFdelbegin \DIFdel{. }\DIFdelend \DIFaddbegin \DIFadd{(parameter }\emph{\DIFadd{b}} \DIFadd{in Eq. 5, with }\emph{\DIFadd{b}}
\DIFadd{\textgreater{} 0.5 indicating greatermass- than area-dependence). }\DIFaddend Our
...
Panama (\DIFdelbegin \DIFdel{3.2 }\DIFdelend \DIFaddbegin \DIFadd{1.8 }\DIFaddend - \DIFdelbegin \DIFdel{591 }\DIFdelend \DIFaddbegin \DIFadd{133 }\DIFaddend g m\textsuperscript{2}).
...
}\DIFaddend species (\protect\hyperlink{ref-Wurth2005}{Würth et al. 2005}) and up to
20\% of leaf mass in evergreen species
(\protect\hyperlink{ref-Martinez-Vilalta2016}{Martínez‐Vilalta et al.
2016}). \DIFdelbegin \DIFdel{A }\DIFdelend \DIFaddbegin \DIFadd{Although scaling parameters in our model allow us to include
...
\protect\hyperlink{ref-Terashima2011}{Terashima et al. 2011}). \DIFdelbegin \DIFdel{Estimates
of }\DIFdelend \DIFaddbegin \DIFadd{In
...
dataset we analyzed }\DIFdelend \DIFaddbegin \DIFadd{same
Panama dataset }\DIFaddend (\protect\hyperlink{ref-Osnas2018}{Osnas et al. 2018}).
\DIFaddbegin 
...
\leavevmode\vadjust pre{\DIFdelbegin %DIFDELCMD < \hypertarget{ref-Betancourt2016}{}}%%%
%DIF < 
...
\DIFdel{pre}%DIFDELCMD < {\hypertarget{ref-Blonder2011}{}}%%%
%DIF < 
...
\DIFdelend \hypertarget{ref-Bonan2002}{}}%
...
\leavevmode\vadjust pre{\DIFdelbegin %DIFDELCMD < \hypertarget{ref-Shipley2006}{}}%%%
%DIF < 
...
\DIFdel{. Ecology 87:535--541.
}%DIFDELCMD < 

%DIFDELCMD < \leavevmode\vadjust %%%
\DIFdel{pre}%DIFDELCMD < {%%%
\DIFdelend \hypertarget{ref-Tcherkez2017}{}}%
...
(one-dimensional \DIFaddbegin \DIFadd{trait space }\DIFaddend model) or both LMAm and LMAs
(two-dimensional \DIFaddbegin \DIFadd{trait space }\DIFaddend model; see Eqs. 2, 3, and 4a). For the
...
combined the two-dimensional \DIFaddbegin \DIFadd{trait space }\DIFaddend model forms with four types of
...
\DIFaddbegin \DIFadd{Those constraints were based on the following hypotheses: (1)
...
(\(\beta_s\) in Eq. 4 than LMAm (\(\beta_m\)). See the method and
...
\endlastfoot
\DIFaddend Effect of LMAm on \emph{A}\textsubscript{area} (\(\alpha_p\)) &
...
{\centering \DIFdelbeginFL %DIFDELCMD < \includegraphics{/Users/mattocci/Dropbox/MS/LMAms/figs/hypo.png}
%DIFDELCMD < %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics{/Users/mattocci/Dropbox/Reserach/MS/LMAms/figs/hypo.png}
\DIFaddendFL 
...
{\centering \DIFdelbeginFL %DIFDELCMD < \includegraphics{/Users/mattocci/Dropbox/MS/LMAms/figs/gl_point.png}
%DIFDELCMD < %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics{/Users/mattocci/Dropbox/Reserach/MS/LMAms/figs/gl_point.png}
\DIFaddendFL 
...
{\centering \DIFdelbeginFL %DIFDELCMD < \includegraphics{/Users/mattocci/Dropbox/MS/LMAms/figs/pa_point.png}
%DIFDELCMD < %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics{/Users/mattocci/Dropbox/Reserach/MS/LMAms/figs/pa_point.png}
\DIFaddendFL 
...
{\centering \DIFdelbeginFL %DIFDELCMD < \includegraphics{/Users/mattocci/Dropbox/MS/LMAms/figs/pa_point_par_ll.png}
%DIFDELCMD < %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics{/Users/mattocci/Dropbox/Reserach/MS/LMAms/figs/pa_point_par_ll.png}
\DIFaddendFL 
...
{\centering \DIFdelbeginFL %DIFDELCMD < \includegraphics{/Users/mattocci/Dropbox/MS/LMAms/figs/vpart_intra.png}
%DIFDELCMD < %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics{/Users/mattocci/Dropbox/Reserach/MS/LMAms/figs/vpart_intra.png}
\DIFaddendFL 
...
{\centering \DIFdelbeginFL %DIFDELCMD < \includegraphics{/Users/mattocci/Dropbox/MS/LMAms/figs/box_de.png}
%DIFDELCMD < %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics{/Users/mattocci/Dropbox/Reserach/MS/LMAms/figs/box_de.png}
\DIFaddendFL 
...
{\centering \DIFdelbeginFL %DIFDELCMD < \includegraphics{/Users/mattocci/Dropbox/MS/LMAms/figs/box_pa.png}
%DIFDELCMD < %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics{/Users/mattocci/Dropbox/Reserach/MS/LMAms/figs/box_pa.png}
\DIFaddendFL 
...
{\centering \DIFdelbeginFL %DIFDELCMD < \includegraphics{/Users/mattocci/Dropbox/MS/LMAms/figs/mass_prop_mv.png}
%DIFDELCMD < %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics{/Users/mattocci/Dropbox/Reserach/MS/LMAms/figs/mass_prop_mv.png}
\DIFaddendFL 
...
{\centering \DIFdelbeginFL %DIFDELCMD < \includegraphics{/Users/mattocci/Dropbox/MS/LMAms/figs/pa_point_npc.png}
%DIFDELCMD < %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics{/Users/mattocci/Dropbox/Reserach/MS/LMAms/figs/pa_point_npc.png}
\DIFaddendFL 
