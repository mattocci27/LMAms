...
%DIF DEL /tmp/ouWSI9jIF_/latexdiff-vc-621812a/ms/LMAms_main.tex   Fri Apr  7 12:37:03 2023
%DIF ADD ms/LMAms_main.tex                                        Thu Jan 18 12:04:45 2024
...
\DIFdelend \DIFaddbegin \renewenvironment{Shaded}{\begin{tcolorbox}[boxrule=0pt, sharp corners, frame hidden, interior hidden, borderline west={3pt}{0pt}{shadecolor}, breakable, enhanced]}{\end{tcolorbox}}\DIFaddend \fi
...
\DIFaddbegin \DIFadd{(Appendix S3).
}
...
varying in LMAm and LMAs (Appendix S5). We quantified the
mass-dependence of }\emph{\DIFadd{A}}\DIFadd{\textsubscript{max} based on the scaling
exponent of }\emph{\DIFadd{A}}\DIFadd{\textsubscript{max} with LMA (Appendix S4) following
Osnas et al. (}\protect\hyperlink{ref-Osnas2013}{2013}\DIFadd{). These
simulations allow us to explore the controversial mass versus area
normalization debate in leaf trait analysis. Additionally, we performed
variance partitioning to determine the contributions of LMAm and LMAs to
total LMA variance, using both simulated and actual datasets (Appendix
S6)}\DIFaddend .
...
therefore assume that estimates of LMAm and LMAs obtained from }\DIFdelend \DIFaddbegin \DIFadd{through randomized tests, detailed in Appendix S3. These
...
\DIFdelend \DIFaddbegin \hypertarget{decomposing-lma-into-metabolic-and-structural-components-leads-to-improved-predictions-of-aarea-rarea-and-ll.}{%
...
\DIFdelend \DIFaddbegin \hypertarget{nearly-all-leaf-dark-respiration-is-associated-with-metabolic-leaf-tissue-mass.}{%
...
\DIFdelend \DIFaddbegin \hypertarget{evergreen-leaves-have-greater-lmas-than-deciduous-leaves-and-sun-leaves-have-both-greater-lmam-and-lmas-than-shade-leaves.}{%
...
\DIFdelend \DIFaddbegin \hypertarget{lma-variance-components-affect-the-area--vs.-mass-dependence-of-leaf-photosynthetic-capacity-amax.}{%
...
(Fig.~\ref{fig-mass_prop}). Other factors, including the sensitivity of
...
\DIFdelend \DIFaddbegin \hypertarget{nitrogen-and-phosphorus-per-unit-leaf-area-are-strongly-correlated-with-lmam-and-cellulose-per-unit-leaf-area-is-strongly-correlated-with-total-lma.}{%
...
(\(\beta_s\) in Eq. 4) than LMAm (\(\beta_m\)). See Appendix S8 for more
details.
}\DIFaddend 
...
%DIFDELCMD < %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics{/home/mattocci/LMAms/figs/hypo.png}
\DIFaddendFL 
...
%DIFDELCMD < %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics{/home/mattocci/LMAms/figs/gl_point.png}
\DIFaddendFL 
...
%DIFDELCMD < %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics{/home/mattocci/LMAms/figs/pa_point.png}
\DIFaddendFL 
...
%DIFDELCMD < %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics{/home/mattocci/LMAms/figs/pa_point_par_ll.png}
\DIFaddendFL 
...
%DIFDELCMD < %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics{/home/mattocci/LMAms/figs/vpart_intra.png}
\DIFaddendFL 
...
%DIFDELCMD < %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics{/home/mattocci/LMAms/figs/box_de.png}
\DIFaddendFL 
...
%DIFDELCMD < %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics{/home/mattocci/LMAms/figs/box_pa.png}
\DIFaddendFL 
...
%DIFDELCMD < %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics{/home/mattocci/LMAms/figs/mass_prop_mv.png}
\DIFaddendFL 

}

\caption{\label{fig-mass_prop}Relationships between mass dependency
(\emph{b} in Eq. \DIFdelbeginFL \DIFdelFL{5}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{S5}\DIFaddendFL ) and LMAs variance (relative to total LMA variance;
Eq. \DIFdelbeginFL \DIFdelFL{6}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{S7}\DIFaddendFL ) for the global GLPNET dataset, sun leaves in Panama, and shade
...
\DIFaddbeginFL \DIFaddFL{See Appendices S4-S6 for details.}\DIFaddendFL }
...
%DIFDELCMD < %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics{/home/mattocci/LMAms/figs/pa_point_npc.png}
\DIFaddendFL 
