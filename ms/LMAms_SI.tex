...
1.95, \(\alpha_m\) = 0.56, \(\alpha_s\) = 0, \(\rho\) = -0.4.
...
\textbf{Figure S1}: Boxplots comparing leaf mass per area (LMA),
...
\textbf{Figure S2}: Boxplots comparing posterior medians of the latent
...
\textbf{Figure S4}: The relationships between mass dependency (\emph{b}
...
\(\mu_s\) = 26.7, \(\sigma_m\) = 1.95, and \(\rho\) = -0.4,
...
\textbf{Figure S6}: Measured traits related to photosynthesis and
...
\textbf{Figure S7}: Partial regression plots for nitrogen, phosphorus
...
\textbf{Figure S8} Pearson correlation coefficients for posterior
