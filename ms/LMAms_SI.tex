...
Models fit to the randomized datasets either did not converge or showed
divergent transitions (Table AS1, Figure AS1-2), indicating that models
...
In contrast, when fit to the observed (non-randomized) data, the
...
\section{Understanding relationships between photosynthetic capacity and
...
\section{Simulated datasets to study relationships between
photosynthetic capacity and
LMA}\label{simulated-datasets-to-study-relationships-between-photosynthetic-capacity-and-lma}
