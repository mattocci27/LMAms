...
\(\mu_s\) = 63.1, \(\sigma_p\) = 2.12, \(\alpha_p\) = , \(\alpha_s\) =
-0.13, sun leaves in Panama: \(\mu_p\) = 45.1, \(\mu_s\) = 31,
\(\sigma_p\) = 1.53, and \(\alpha_p\) = , \(\alpha_s\) = 0, shade leaves
in Panama: \(\mu_p\) = 8.6, \(\mu_s\) = 24, \(\sigma_p\) = 1.88,
\(\alpha_p\) = , \(\alpha_s\) = 0, \(\rho\) = -0.4.
...
{\centering \includegraphics{/Users/mattocci/Dropbox/MS/LMAms/figs/ps_point.png}
...
{\centering \includegraphics{/Users/mattocci/Dropbox/MS/LMAms/figs/box_inter.png}
...
{\centering \includegraphics{/Users/mattocci/Dropbox/MS/LMAms/figs/box_frac.png}
...
{\centering \includegraphics{/Users/mattocci/Dropbox/MS/LMAms/figs/mass_prop_sim.png}
...
exponent \(\alpha_p\) is constant (\(\alpha_p\) = ,). Solid lines
indicate simulated means and shaded regions indicate 95\% CI. The
photosynthetic rate (\emph{A}) is primarily mass-dependent (\emph{b}
...
increase with LMA, which is not realistic. Parameter settings:
\(\alpha_0\) = 1.77, \(\mu_p\) = 58.8, \(\mu_s\) = 63.1, \(\sigma_p\) =
2.12.}
...
{\centering \includegraphics{/Users/mattocci/Dropbox/MS/LMAms/figs/mass_prop_comp.png}
...
settings: \(\alpha_0\) = 0.33, \(\alpha_p\) = , \(\alpha_s\) = 0,
...
{\centering \includegraphics{/Users/mattocci/Dropbox/MS/LMAms/figs/gl_point_np2.png}
