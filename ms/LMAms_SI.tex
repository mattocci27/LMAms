...
(\citeproc{ref-Lewandowski2009}{Lewandowski et al. 2009};
\citeproc{ref-Alvarez2014}{Alvarez et al. 2014}). A prior for \textbf{L}
was specified as an LKJ distribution with a shape parameter of 2
(\citeproc{ref-Lewandowski2009}{Lewandowski et al. 2009}), which is
...
typically between 0 and 1 (\citeproc{ref-Osnas2018}{Osnas et al. 2018}).
...
\emph{b} \textgreater{} 0 (\citeproc{ref-Osnas2018}{Osnas et al. 2018}).
...
\emph{P}\textsubscript{area} for GLOPNET
(\quartosuppfigref{suppfig-gl_point_np2}). The results shown here
include all leaves for which \emph{N}\textsubscript{area},
