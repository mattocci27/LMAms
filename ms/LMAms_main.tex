...
components (Appendices 1-2). We fit the models to two datasets: the
...
than mass-dependent (parameter \emph{b} in Eq. S5, with \emph{b}
...
Although the index of mass-dependence (\emph{b}; Eq. S5) can,
