...
LMA into LMAm and LMAs, we reveal why mass‐based correlations that seem
...
\citeproc{ref-Kitajima2012}{Kitajima et al. 2012},
\citeproc{ref-Kitajima2016}{2016}). By separating total LMA into these
...
(\citeproc{ref-Onoda2011}{Onoda et al. 2011};
\citeproc{ref-Kitajima2016}{Kitajima et al. 2016}) (Fig. S3). (Fig. S4)
This correspondence supports our inference that structural investment,
...
remains unassociated with the structural fraction of leaf mass.
...
\citeproc{ref-Russo2016}{Russo, and Kitajima 2016};
\citeproc{ref-Osnas2018}{Osnas et al. 2018}). We further examine
...
(\citeproc{ref-Onoda2011}{Onoda et al. 2011};
\citeproc{ref-Niinemets2006}{\textbf{Niinemets2006?}}). This likely
contributes to their low LMAs (Fig.~\ref{fig-pa_point}i), highlighting
...
LMA into both metabolic and structural components to more accurately
model leaf function across diverse plant forms.
...
thickness or density (\citeproc{ref-Onoda2011}{Onoda et al. 2011}).
...
less structural toughness) (\citeproc{ref-Kitajima2016}{Kitajima et al.
2016}). Thus, just as not all LMA is equal, it is almost certainly true
...
\citeproc{ref-Kitajima2016}{Kitajima et al. 2016}). Thus, while optimal
...
Trait‐based approaches have long been used to incorporate plant
functional diversity into biogeochemical models and, by extension, Earth
system models (\citeproc{ref-Moorcroft2001}{Moorcroft et al. 2001};
\citeproc{ref-Bonan2002}{Bonan et al. 2002};
\citeproc{ref-Moorcroft2006}{Moorcroft 2006};
\citeproc{ref-Verheijen2013}{Verheijen et al. 2013};
...
(\citeproc{ref-Wright2004a}{Wright et al. 2004}), our findings suggest
...
major axes of leaf function (r s\_fig(``LMAm\_LMAs'')). Consistent with
our conclusion that leaf function is inherently multidimensional,
previous work also shows that nitrogen is partitioned into metabolic
(e.g., rubisco) versus structural fractions
(\citeproc{ref-Dong2017}{Dong et al. 2017},
\citeproc{ref-Dong2022}{2022}), and that more than 20\% of total leaf
