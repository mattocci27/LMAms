...
We compared the performance of different models (Table 1) by using Pareto-smoothed importance sampling leave-one-out cross-validation (LOO; Vehtari et al. (\protect\hyperlink{ref-Vehtari2014}{2014})), an approximation to LOO.
...
\includegraphics{../figs/table2.png}
