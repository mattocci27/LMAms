...
LMAs components. By using power-law relationships, our models assume
that LMAm the contribution of LMAm to metabolic rates is not direct or
linear, which reflects that leaf mass components still cannot be neatly
classified as `metabolic' or `structural'. We fit the models to two
datasets: the GLOPNET global leaf traits dataset
...
we simulated datasets varying in LMAm and LMAs. These simulations
allowed us to explore the controversial mass versus area normalization
debate in leaf trait analysis (Appendix X). Additionally, we performed
...
Appendix S2. These tests support our assumption that the patterns
