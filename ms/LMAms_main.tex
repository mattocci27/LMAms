...
physiological tradeoffs (\citeproc{ref-Wright2004a}{Wright IJ et al.
2004}; \citeproc{ref-Reich2014}{Reich PB 2014};
\citeproc{ref-Onoda2017}{Onoda Y et al. 2017}) and in carbon and
nutrient cycling (\citeproc{ref-Tcherkez2017}{Tcherkez G et al. 2017};
e.g., \citeproc{ref-Huntingford2017}{Huntingford C et al. 2017}). Thus,
...
(\citeproc{ref-Bonan2002}{Bonan GB et al. 2002};
\citeproc{ref-Poorter2009}{Poorter H et al. 2009}). Different leaf
...
(\citeproc{ref-Osnas2013}{Osnas JLD et al. 2013}), whereas the opposite
pattern (strong mass-dependence of these same traits) is observed within
species across light gradients (\citeproc{ref-Osada2001}{Osada N et al.
2001}; \citeproc{ref-Niinemets2015}{Niinemets Ü et al. 2015};
\citeproc{ref-Osnas2018}{Osnas JLD et al. 2018}). Functional groups
...
on leaf mass and area (\citeproc{ref-Lusk2008}{Lusk CH et al. 2008};
\citeproc{ref-Osnas2018}{Osnas JLD et al. 2018}). These divergent
...
(\citeproc{ref-Wright2004a}{Wright IJ et al. 2004}). However, the
interpretation of these strong correlations, which can result from
mass-normalization of area-dependent traits
(\citeproc{ref-Lloyd2013}{Lloyd J et al. 2013};
\citeproc{ref-Osnas2013}{Osnas JLD et al. 2013}), is controversial. On
the one hand, mass-normalization has been justified based on economic
principles alone (\citeproc{ref-Kikuzawa1991}{Kikuzawa K 1991};
\citeproc{ref-Westoby2013}{Westoby M et al. 2013}), because leaf mass
...
rate of return (\citeproc{ref-Wright2004a}{Wright IJ et al. 2004}). On
the other hand, because the lifetime return on investment depends on LL
(\citeproc{ref-Westoby2000}{Westoby M et al. 2000};
\citeproc{ref-Falster2012}{Falster DS et al. 2012}), leaf economics
...
(\citeproc{ref-Osnas2013}{Osnas JLD et al. 2013}). In global analyses,
...
across global species (\citeproc{ref-Osnas2013}{Osnas JLD et al. 2013}).

Area-dependence of metabolic traits and the inconsistent correlation
strengths obtained from different normalizers
(\citeproc{ref-Lloyd2013}{Lloyd J et al. 2013};
\citeproc{ref-Osnas2013}{Osnas JLD et al. 2013}) suggest that strong
...
(\citeproc{ref-Westoby2013}{Westoby M et al. 2013}). This
...
Ü, Sack L 2006}; \citeproc{ref-Onoda2017}{Onoda Y et al. 2017}), the
role of trait variation in community assembly (e.g.,
\citeproc{ref-Falster2017}{Falster DS et al. 2017};
\citeproc{ref-Lichstein2021}{Lichstein JW et al. 2021}), and how to
...
variation, consider the conceptual model proposed by Osnas JLD et al.
...
(\citeproc{ref-Kitajima2012}{Kitajima K et al. 2012},
\citeproc{ref-Kitajima2016}{2016}; \citeproc{ref-Onoda2017}{Onoda Y et
...
by Osnas JLD et al. (\citeproc{ref-Osnas2018}{2018}) could be compared
...
(\citeproc{ref-Poorter2009}{Poorter H et al. 2009};
\citeproc{ref-Osnas2018}{Osnas JLD et al. 2018}), other leaf mass
components cannot. For example, thick cell walls contribute to
structural toughness (\citeproc{ref-Onoda2015}{Onoda Y et al. 2015}),
...
(\citeproc{ref-Wright2004a}{Wright IJ et al. 2004}). We use the model to
...
analysis of Wright IJ et al. (\citeproc{ref-Wright2004a}{2004}). For
...
(\citeproc{ref-Wright2004a}{Wright IJ et al. 2004}), which primarily
represents interspecific variation; and the Panama dataset described by
Osnas JLD et al. (\citeproc{ref-Osnas2018}{2018}), which includes traits
...
3). We then used the model predictions to study how LMAm and LMAs
...
Osnas JLD et al. (\citeproc{ref-Osnas2018}{2018}).
...
(\citeproc{ref-Landau2021}{Landau WM 2021}).
...
availability (\citeproc{ref-Kikuzawa1991}{Kikuzawa K 1991}), and also by
...
gradients (\citeproc{ref-Lusk2008}{Lusk CH et al. 2008};
\citeproc{ref-Russo2016}{Russo SE, Kitajima K 2016};
\citeproc{ref-Osnas2018}{Osnas JLD et al. 2018}). Mechanistically
modeling how light affects LL via leaf carbon balance
(\citeproc{ref-Xu2017}{Xu X et al. 2017}) is beyond the scope of our
...
traits database (\citeproc{ref-Wright2004a}{Wright IJ et al. 2004}) and
...
are available (\citeproc{ref-Wright2004a}{Wright IJ et al. 2004}). In
...
(\citeproc{ref-Wright2003}{Wright SJ et al. 2003}). The wet SL site is
an evergreen Caribbean coastal forest with 3100 mm of annual rainfall
(\citeproc{ref-Wright2003}{Wright SJ et al. 2003}). Additional details
of the Panama dataset are described in Osnas JLD et al.
...
(\citeproc{ref-Carpenter2017}{Carpenter B et al. 2017}). We used
non-informative or weakly informative prior distributions
(\citeproc{ref-Lemoine2019}{Lemoine NP 2019}). Prior distributions for
the latent variables \emph{f\textsubscript{i}} (which partition LMA into
...
(\citeproc{ref-Gelman2013}{Gelman A et al. 2013}).
...
(\citeproc{ref-Vehtari2017}{Vehtari A et al. 2017}). We used PSIS-LOO to
...
(\citeproc{ref-Vehtari2017}{Vehtari A et al. 2017}).
...
(\citeproc{ref-Williams1989}{Williams K et al. 1989};
\citeproc{ref-Villar2001}{Villar R, Merino J 2001}), our results suggest
...
(S4a-b). The higher total LMA in evergreen compared to deciduous leaves
was primarily due to differences in LMAs (Figs. \ref{fig-box_de}, S1a,
and S2). In the Panama dataset, light (sun vs.~shade) explained more
variation in LMAm than LMAs, whereas site (wet vs.~dry) explained near
zero variation in LMAm but substantial variaion in LMAs (S4c). Panama
wet-site leaves had higher total LMA than dry-site leaves due to greater
wet-site LMAs for both sun and shade leaves (Figs. \ref{fig-box_pa} and
S1b). In contrast, Panama sun leaves had higher total LMA than shade
leaves primarily due to greater LMAm, with a smaller but significant
contribution from LMAs (Figs. \ref{fig-box_pa} and S1b). LMAs comprised
...
LMAm and LMAs (Fig.~\ref{fig-mass_prop}, Figs. S5-S6). For example, in
...
but only weak correlations with LMAs (Fig. S7). Similarly, in the Panama
dataset, \emph{N}\textsubscript{area} and \emph{P}\textsubscript{area}
had strong positive correlations with LMAm but not with LMAs (Fig. S8).
...
consistent across canopy positions and sites (Fig. S8). Partial
...
(compared to shade leaves; Fig. S8) were primarily due to sun leaves
having higher LMAm than shade leaves (Fig. S9).
...
wall thickness (\citeproc{ref-Evans2009}{Evans JR et al. 2009};
\citeproc{ref-Terashima2011}{Terashima I et al. 2011};
\citeproc{ref-Onoda2017}{Onoda Y et al. 2017}). This trend may be less
...
components (\citeproc{ref-Niinemets2006a}{Niinemets Ü, Sack L 2006};
\citeproc{ref-Poorter2009}{Poorter H et al. 2009};
...
(\citeproc{ref-Onoda2011}{Onoda Y et al. 2011};
\citeproc{ref-Kitajima2012}{Kitajima K et al. 2012},
\citeproc{ref-Kitajima2016}{2016}). Median values of LMAs, as a percent
of total LMA, were \textasciitilde60\% for evergreen species
vs.~\textasciitilde40\% for deciduous species (Fig. S2), and
...
and LL (\citeproc{ref-Onoda2011}{Onoda Y et al. 2011},
\citeproc{ref-Onoda2017}{2017}; \citeproc{ref-Kitajima2012}{Kitajima K
et al. 2012}, \citeproc{ref-Kitajima2016}{2016}). For a given LMAs,
...
sun (\citeproc{ref-Lusk2008}{Lusk CH et al. 2008};
\citeproc{ref-Russo2016}{Russo SE, Kitajima K 2016};
\citeproc{ref-Osnas2018}{Osnas JLD et al. 2018}). The failure of LMAs to
...
light availability (\citeproc{ref-Kikuzawa1991}{Kikuzawa K 1991}) − as
...
or density (\citeproc{ref-Onoda2011}{Onoda Y et al. 2011}). Accordingly,
...
toughness) (\citeproc{ref-Kitajima2016}{Kitajima K et al. 2016}). Thus,
...
cell walls of vascular tissue, \citeproc{ref-Kitajima2016}{Kitajima K et
al. 2016}).
...
Optimal LL theory (\citeproc{ref-Kikuzawa1991}{Kikuzawa K 1991})
...
Osnas JLD et al. (\citeproc{ref-Osnas2018}{2018}) suggested that in leaf
...
Osnas JLD et al. (\citeproc{ref-Osnas2018}{2018}). However, our analysis
also revealed complexities that were not anticipated by Osnas JLD et al.
...
diffusion pathway (\citeproc{ref-Evans2009}{Evans JR et al. 2009}).
Similarly, high LMAm may lead to a high level of chloroplast
self-shading within a leaf (\citeproc{ref-Terashima2011}{Terashima I et
...
species (\citeproc{ref-Wurth2005}{Würth MKR et al. 2005}) and up to 20\%
of leaf mass in evergreen species
(\citeproc{ref-Martinez-Vilalta2016}{Martínez-Vilalta J et al. 2016}). A
...
(\citeproc{ref-Osnas2018}{Osnas JLD et al. 2018}). LMA increased from
...
(\citeproc{ref-Onoda2008}{Onoda Y et al. 2008};
\citeproc{ref-Terashima2011}{Terashima I et al. 2011}). In contrast to
...
across light levels (\citeproc{ref-Osnas2018}{Osnas JLD et al. 2018}).
...
(\citeproc{ref-Moorcroft2001}{Moorcroft PR et al. 2001};
\citeproc{ref-Bonan2002}{Bonan GB et al. 2002};
\citeproc{ref-Verheijen2013}{Verheijen LM et al. 2013}), with the
ultimate goal of adding ecological and physiological realism to coupled
Earth system models (ESMs, \citeproc{ref-Moorcroft2006}{Moorcroft PR
2006}; \citeproc{ref-Wullschleger2014}{Wullschleger SD et al. 2014}).
Recently, there has been a proliferation of interest in this topic
(\citeproc{ref-Scheiter2013}{Scheiter S et al. 2013};
\citeproc{ref-Sakschewski2015}{Sakschewski B et al. 2015};
\citeproc{ref-Fisher2015}{Fisher RA et al. 2015};
\citeproc{ref-Sakschewski2016}{Sakschewski B et al. 2016};
\citeproc{ref-DantasdePaula2021}{Dantas de Paula M et al. 2021}) along
with demographic approaches capable of representing the dynamics of
diverse communities in ESMs (\citeproc{ref-Fisher2018}{Fisher RA et al.
2018}). The leaf economics spectrum (LES) has been interpreted as a
single dominant axis of global leaf functional variation
(\citeproc{ref-Wright2004a}{Wright IJ et al. 2004}), and this simple
...
correlation between these LMA components (Fig. S10). We therefore
...
structural leaf nitrogen components (\citeproc{ref-Dong2017}{Dong N et
al. 2017}, \citeproc{ref-Dong2022}{2022}), with over 20\% of total leaf
nitrogen in high-LMA leaves occurring in cell walls
(\citeproc{ref-Onoda2017}{Onoda Y et al. 2017}). Similarly, partitioning
...
A, Kitayama K 2011}). We suggest that future biogeochemical model
...
Bonan GB, Levis S, Kergoat L, Oleson KW (2002) Landscapes as patches of
plant functional types: {An} integrating concept for climate and
ecosystem models. Global Biogeochemical Cycles16:5-1-5-23.
...
Programming Language}. Journal of Statistical Software76:1--32.
\url{https://doi.org/10.18637/jss.v076.i01}.

\bibitem[\citeproctext]{ref-DantasdePaula2021}
Dantas de Paula M, Forrest M, Langan L, Bendix J, Homeier J, Velescu A,
Wilcke W, Hickler T (2021) Nutrient cycling drives plant community trait
assembly and ecosystem functioning in a tropical mountain biodiversity
hotspot. New Phytologist232:551--566.
\url{https://doi.org/10.1111/nph.17600}.

\bibitem[\citeproctext]{ref-Dong2017}
Dong N, Prentice IC, Evans BJ, Caddy-Retalic S, Lowe AJ, Wright IJ
(2017) Leaf nitrogen from first principles: Field evidence for adaptive
variation with climate. Biogeosciences14:481--495.
\url{https://doi.org/10.5194/bg-14-481-2017}.

\bibitem[\citeproctext]{ref-Dong2022}
Dong N, Prentice IC, Wright IJ, Wang H, Atkin OK, Bloomfield KJ,
Domingues TF, Gleason SM, Maire V, Onoda Y, Poorter H, Smith NG (2022)
Leaf nitrogen from the perspective of optimal plant function. Journal of
Ecology110:2585--2602. \url{https://doi.org/10.1111/1365-2745.13967}.

\bibitem[\citeproctext]{ref-Evans2009}
Evans JR, Kaldenhoff R, Genty B, Terashima I (2009) Resistances along
the {CO2} diffusion pathway inside leaves. Journal of Experimental
Botany60:2235--2248. \url{https://doi.org/10.1093/jxb/erp117}.
...
Falster DS, Reich PB, Ellsworth DS, Wright IJ, Westoby M, Oleksyn J, Lee
TD (2012) Lifetime return on investment increases with leaf lifespan
among 10 {Australian} woodland species. New Phytologist193:409--419.
...
Matheny AM, Medvigy D, Muller-Landau HC, Powell TL, Serbin SP, Sato H,
Shuman JK, Smith B, Trugman AT, Viskari T, Verbeeck H, Weng E, Xu C, Xu
X, Zhang T, Moorcroft PR (2018) Vegetation demographics in {Earth System
Models}: {A} review of progress and priorities. Global Change
Biology24:35--54. \url{https://doi.org/10.1111/gcb.13910}.
...
(2015) Taking off the training wheels: The properties of a dynamic
...
Hidaka A, Kitayama K (2011) Allocation of foliar phosphorus fractions
...
Huntingford C, Atkin OK, Martinez-de la Torre A, Mercado LM, Heskel MA,
Harper AB, Bloomfield KJ, O'Sullivan OS, Reich PB, Wythers KR, Butler
EE, Chen M, Griffin KL, Meir P, Tjoelker MG, Turnbull MH, Sitch S,
Wiltshire A, Malhi Y (2017) Implications of improved representations of
...
Kitajima K, Cordero RA, Wright SJ (2013) Leaf life span spectrum of
tropical woody seedlings: {Effects} of light and ontogeny and
consequences for survival. Annals of Botany112:685--699.
\url{https://doi.org/10.1093/aob/mct036}.

\bibitem[\citeproctext]{ref-Kitajima2012}
Kitajima K, Llorens AM, Stefanescu C, Timchenko MV, Lucas PW, Wright SJ
(2012) How cellulose-based leaf toughness and lamina density contribute
...
Kitajima K, Wright SJ, Westbrook JW (2016) Leaf cellulose density as the
key determinant of inter- and intra-specific variation in leaf fracture
toughness in a species-rich tropical forest. Interface Focus6:20150100.
\url{https://doi.org/10.1098/rsfs.2015.0100}.

\bibitem[\citeproctext]{ref-Landau2021}
Landau WM (2021) The targets {R} package: A dynamic {Make-like}
...
Lichstein JW, Peterson BT, Langebrake J, McKinley SA (2021) Leaf
...
Why are evergreen leaves so contrary about shade? Trends in Ecology and
Evolution23:299--303. \url{https://doi.org/10.1016/j.tree.2008.02.006}.

\bibitem[\citeproctext]{ref-Martinez-Vilalta2016}
Martínez-Vilalta J, Sala A, Asensio D, Galiano L, Hoch G, Palacio S,
Piper FI, Lloret F (2016) Dynamics of non-structural carbohydrates in
...
Ecological Monographs71:557--585. \url{https://doi.org/10.2307/3100036}.
...
\emph{Major}}: {A} conceptual approach. Annals of Botany101:727--736.
\url{https://doi.org/10.1093/aob/mcn013}.

\bibitem[\citeproctext]{ref-Onoda2015}
Onoda Y, Schieving F, Anten NPR (2015) A novel method of measuring leaf
...
Journal of Experimental Botany66:2487--2499.
...
Díaz S, Dominy NJ, Elgart A, Enrico L, Fine PVA, Howard JJ, Jalili A,
Kitajima K, Kurokawa H, McArthur C, Lucas PW, Markesteijn L,
Pérez-Harguindeguy N, Poorter L, Richards L, Santiago LS, Sosinski EE,
Van Bael SA, Warton DI, Wright IJ, Joseph Wright S, Yamashita N (2011)
Global patterns of leaf mechanical properties. Ecology
Letters14:301--312.
\url{https://doi.org/10.1111/j.1461-0248.2010.01582.x}.

\bibitem[\citeproctext]{ref-Onoda2017}
Onoda Y, Wright IJ, Evans JR, Hikosaka K, Kitajima K, Niinemets Ü,
Poorter H, Tosens T, Westoby M (2017) Physiological and structural
tradeoffs underlying the leaf economics spectrum. New
Phytologist214:1447--1463. \url{https://doi.org/10.1111/nph.14496}.
...
Poorter H, Niinemets Ü, Poorter L, Wright IJ, Villar R (2009) Causes and
consequences of variation in leaf mass per area ({LMA}): {A}
meta-analysis. New Phytologist182:565--588.
...
Russo SE, Kitajima K (2016) The {Ecophysiology} of {Leaf Lifespan} in
...
Sakschewski B, von Bloh W, Boit A, Poorter L, Peña-Claros M, Heinke J,
Joshi J, Thonicke K (2016) Resilience of {Amazon} forests emerges from
...
Peñuelas J, Thonicke K (2015) Leaf and stem economics spectra drive
...
Phytologist198:957--969. \url{https://doi.org/10.1111/nph.12210}.
...
Atkin OK, Farquhar GD, Cornic G (2017) Leaf day respiration: Low {CO2}
...
Terashima I, Hanba YT, Tholen D, Niinemets U (2011) Leaf {Functional
Anatomy} in {Relation} to {Photosynthesis}. Plant
Physiology155:108--116. \url{https://doi.org/10.1104/pp.110.165472}.
...
Verheijen LM, Brovkin V, Aerts R, Bönisch G, Cornelissen JHC, Kattge J,
Reich PB, Wright IJ, Bodegom PM van (2013) Impacts of trait variation
through observed trait--climate relationships on performance of an
{Earth} system model: A conceptual analysis.
Biogeosciences10:5497--5515.
\url{https://doi.org/10.5194/bg-10-5497-2013}.

\bibitem[\citeproctext]{ref-Villar2001}
Villar R, Merino J (2001) Comparison of leaf construction costs in woody
...
Wright SJ, Horlyck V, Basset Y, Barrios H, Bethancourt A, Bohlman S,
Gilbert G, Goldstein G, Graham EA, Kitajima K, Lerdau MT, Meinzer FC,
Ødegaard F, Reynolds DR, Roubik DW, Sakai S, Samaniego M, Sparks JP, Van
Bael S, Winter K, Zotz G (2003) Tropical {Canopy Biology Program},
{Republic} of {Panama}. Studying {Forest Canopies} from {Above}: {The
International Canopy Crane Network}:137--155.
...
ecosystems. Annals of Botany114:1--16.
...
carbohydrate pools in a tropical forest. Oecologia143:11--24.
\url{https://doi.org/10.1007/s00442-004-1773-2}.

\bibitem[\citeproctext]{ref-Xu2017}
Xu X, Medvigy D, Joseph Wright S, Kitajima K, Wu J, Albert LP, Martins
GA, Saleska SR, Pacala SW (2017) Variations of leaf longevity in
tropical moist forests predicted by a trait-driven carbon optimality
model. Ecology Letters20:1097--1106.
...
indicating purely area-dependence (\citeproc{ref-Osnas2018}{Osnas JLD et
...
(\citeproc{ref-Osnas2018}{Osnas JLD et al. 2018}). See Supplementary
