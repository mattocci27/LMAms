...
\begin{document}
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[frame hidden, boxrule=0pt, enhanced, borderline west={3pt}{0pt}{shadecolor}, sharp corners, interior hidden, breakable]}{\end{tcolorbox}}\fi
...
\protect\hyperlink{ref-Wright2004a}{Wright et al., 2004}) and in carbon
...
depend on leaf mass and area (\protect\hyperlink{ref-Lusk2008}{Lusk et
al., 2008}; \protect\hyperlink{ref-Osnas2018}{Osnas et al., 2018}).
These divergent patterns suggest the presence of multiple drivers of
trait variation.
...
2004}). On the other hand, because the lifetime return on investment
depends on LL (\protect\hyperlink{ref-Falster2012}{Falster et al.,
2012}; \protect\hyperlink{ref-Westoby2000}{Westoby et al., 2000}),
traits should be normalized by their annualized construction costs (or
mass/LL), which should be used as a normalizer in leaf economics
analyses (\protect\hyperlink{ref-Osnas2013}{Osnas et al., 2013}). In
global analyses, normalizing leaf traits by mass/LL yields similarly
weak correlations as area-normalization, because leaf area is roughly
...
randomized data to evaluate if our two-dimensional models were prone to
creating patterns from noise, which could lead to spurious conclusions.
These tests suggested that our two-dimensional modeling approach
revealed meaningful patterns in the observed trait data (Appendix S3).
...
mass-dependence of \emph{A}\textsubscript{max} based on the scaling
exponent of \emph{A}\textsubscript{max} with LMA (Appendix S4) following
Osnas et al. (\protect\hyperlink{ref-Osnas2013}{2013}). These
...
based on patterns in the data). See Appendix S1 for more details. The
...
(\protect\hyperlink{ref-Vehtari2017}{Vehtari et al., 2017})). PSIS-LOO
...
\hypertarget{decomposing-lma-into-metabolic-and-structural-components-leads-to-improved-predictions-of-aarea-rarea-and-ll.}{%
...
\hypertarget{nearly-all-leaf-dark-respiration-is-associated-with-metabolic-leaf-tissue-mass.}{%
...
(\protect\hyperlink{ref-Villar2001}{Villar and Merino, 2001};
\protect\hyperlink{ref-Williams1989}{Williams et al., 1989}), our
results suggest that leaf mass associated with structural function
(i.e., toughness and LL) has roughly zero maintenance cost.

\hypertarget{evergreen-leaves-have-greater-lmas-than-deciduous-leaves-and-sun-leaves-have-both-greater-lmam-and-lmas-than-shade-leaves.}{%
...
\hypertarget{lma-variance-components-affect-the-area--vs.-mass-dependence-of-leaf-photosynthetic-capacity-amax.}{%
...
\hypertarget{nitrogen-and-phosphorus-per-unit-leaf-area-are-strongly-correlated-with-lmam-and-cellulose-per-unit-leaf-area-is-strongly-correlated-with-total-lma.}{%
...
small LMA range (16-193 g m\textsuperscript{2} in Panama, compared to
21-776 g m\textsuperscript{2} in GLOPNET) or may be obscured by pooling
sun and shade leaves in a single analysis. In any case, an increase in
...
components (\protect\hyperlink{ref-Lichstein2021}{Lichstein et al.,
2021}; \protect\hyperlink{ref-Osnas2018}{Osnas et al., 2018};
...
global dataset (14--77\%, median 47\% of total leaf mass, with higher
values for shade than sun leaves; Onoda et al.~2011) and a Panama study
site (Barro Colorado Island, BCI: \textasciitilde50\% mean across
species, with higher values for shade leaves; Kitajima et al.~2016).
...
(\protect\hyperlink{ref-Lusk2008}{Lusk et al., 2008};
\protect\hyperlink{ref-Osnas2018}{Osnas et al., 2018};
\protect\hyperlink{ref-Russo2016}{Russo and Kitajima, 2016}). The
failure of LMAs to provide robust predictions of LL across canopy
positions may reflect factors unlreated to leaf toughness - e.g., how
optimal LL depends on light availability
...
species (\protect\hyperlink{ref-Wurth2005}{Würth et al., 2005}) and up
to 20\% of leaf mass in evergreen species
...
(\protect\hyperlink{ref-Dong2022}{Dong et al., 2022},
\protect\hyperlink{ref-Dong2017}{2017}), with over 20\% of total leaf
...
Tropical {Tree Physiology}. {Springer International Publishing}, {Cham},
pp. 357--383. \url{https://doi.org/10.1007/978-3-319-27422-5_17}
...
{\centering \includegraphics{/home/mattocci/LMAms/figs/hypo.png}
...
{\centering \includegraphics{/home/mattocci/LMAms/figs/gl_point.png}
...
{\centering \includegraphics{/home/mattocci/LMAms/figs/pa_point.png}
...
{\centering \includegraphics{/home/mattocci/LMAms/figs/pa_point_par_ll.png}
...
{\centering \includegraphics{/home/mattocci/LMAms/figs/vpart_intra.png}
...
{\centering \includegraphics{/home/mattocci/LMAms/figs/box_de.png}
...
{\centering \includegraphics{/home/mattocci/LMAms/figs/box_pa.png}
...
{\centering \includegraphics{/home/mattocci/LMAms/figs/mass_prop_mv.png}
...
See Appendices S4-S6 for details.}
...
{\centering \includegraphics{/home/mattocci/LMAms/figs/pa_point_npc.png}
