...
contribution from LMAs (Figures \ref{fig-box_pa} and S1). Thus, LMAs
...
S4-S5)). For example, although LMAs variance was relatively low in
GLOPNET (51\% of total LMA variance), variation in
...
variance in Panama (74\% and 100\% of total LMA variance for Panama sun
...
(Figure S6). Similarly, in the Panama dataset,
\emph{N}\textsubscript{area} and \emph{P}\textsubscript{area} had strong
...
leaves having higher LMAm than shade leaves (Figure S7).
...
small LMA range (15.6 - 193 g m\textsuperscript{2} in Panama, compared
to 21.4 - 776 g m\textsuperscript{2} in GLOPNET) or may be obscured by
...
species and \textasciitilde40\% for deciduous species (Figure S2), and
15-40\% for shade leaves and 50-70\% for sun leaves (Figure S3). These
...
shade to sun is due to LMAs (Figures \ref{fig-box_pa} and S1), which may
...
interspecific correlation between these LMA components (Figure S8). We
...
when all Panama species were included (Figure S1). Note that the
...
included (Figure S1). Details as for Figure~\ref{fig-box_de}.}
...
shade leaves in Panama. Solid lines indicate simulated medians and
shaded regions indicate 95\% CIs. Each point indicates the estimated
