...
directly state how the LMAm--LMAs partition can motivate new research.
In the revised text, we describe future biogeochemical model development
should consider multiple axes (i.e., LMAm and LMAs) of leaf functional
diversity, and models with coupled carbon-nutrient cycles should
consider how LMA, nitrogen, and phosphorus are allocated to different
functions (lines 516-528).
