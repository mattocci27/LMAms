...
R -e 'system.time(render("./ms/LMAps_main_re.rmd", "bookdown::pdf_document2"))' && echo "PDF file completed!"

nohup R -e 'system.time(render("./ms/LMAps_main_re.rmd", "bookdown::html_document2"))' && echo "html file completed!" &
