...
```{r GL-hypo, cache=FALSE, comment=NA}
...
```{r GL-letters, cache=FALSE, comment=NA}
...
```{r GL-NP, cache=FALSE, comment=NA}
...
```{r PAdat, cache=FALSE, comment=NA}
...
```{r, cache=FALSE, comment=NA, eval = F, echo = F}
pmat <- extract(res, "p")[[1]]
...
```{r PA-part, cache=FALSE, comment=NA}
pmat <- extract(res, "p")[[1]]
before <- proc.time()
N <- 4000
r_As <- numeric(N)
...
```{r PA-part-plt, cache=FALSE, comment=NA}
...
```{r PA-letters, cache=FALSE, comment=NA}
...
```{r, cache=FALSE, comment=NA, eval = TRUE}
...
```{r LL-pre, cache=FALSE, comment=NA, eval = T}
...
```{r mass-prop-big, cache=FALSE, comment=NA}
...
```{r mass-prop-ex, cache=FALSE, comment=NA}
...
```{r PA-box, cache=FALSE, comment=NA}
...
```{r fraction, cache=FALSE, comment=NA}
...
```{r frac2, cache=FALSE, comment=NA}
...
```{r box-cell, cache=FALSE, comment=NA}
...
```{r Frac-pair, cache=FALSE, comment=NA}
...
```{r mid-pair, cache=FALSE, comment=NA}
...
```{r LMAms, cache=FALSE, comment=NA}
