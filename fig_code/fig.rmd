...
LL_plot_sd <- ggplot(LL_dat, aes(x = preLL, y = LL,
                              fill = gr, col = gr)) +
  geom_segment(aes(x = preLL_lo2, xend = preLL_up2, y = LL, yend = LL), col = "grey60", size = 0.25) +
  geom_point(shape = 21) +
  scale_fill_manual(values = fills) +
  scale_colour_manual(values = cols) +
  scale_x_log10(breaks = my_breaks(), expand = c(0.1, 0),
...
GL_LMAms95 <- ggplot(GL, aes(x = LMAp, y = LMAs, 
                               fill = gr, 
                               col = gr)) +
  geom_segment(aes(x = LMAp_lo, xend = LMAp_up, y = LMAs_lo, yend = LMAp_up), col = "grey60", size = 0.25) +
  geom_point(shape = 21) +
  scale_fill_manual(values = fills1, guide = FALSE) +
  scale_colour_manual(values = cols1, guide = FALSE) +
  scale_x_log10(breaks = my_breaks_x(), expand = c(0.1, 0)) +
