...
list(
  ...
  #   mclapply(
  #     list(
  #       fit_1_mcmc_GL_Ap_LLs  = fit_1_mcmc_GL_Ap_LLs,
  #       fit_2_mcmc_GL_Aps_LLps = fit_2_mcmc_GL_Aps_LLps,
  #       fit_3_mcmc_GL_Ap_LLps = fit_3_mcmc_GL_Ap_LLps,
  #       fit_4_mcmc_GL_Aps_LLs = fit_4_mcmc_GL_Aps_LLs,
  #       fit_5_mcmc_PA_Ap_LLs  = fit_5_mcmc_PA_Ap_LLs,
  #       fit_6_mcmc_PA_Aps_LLps = fit_6_mcmc_PA_Aps_LLps,
  #       fit_7_mcmc_PA_Ap_LLps = fit_7_mcmc_PA_Ap_LLps,
  #       fit_8_mcmc_PA_Aps_LLs = fit_8_mcmc_PA_Aps_LLs,
  #       fit_9_mcmc_PA_Ap_LLs_opt = fit_9_mcmc_PA_Ap_LLs_opt,
  #       fit_10_mcmc_PA_Aps_LLps_opt= fit_10_mcmc_PA_Aps_LLps_opt,
  #       fit_11_mcmc_PA_Ap_LLps_opt = fit_11_mcmc_PA_Ap_LLps_opt,
  #       fit_12_mcmc_PA_Aps_LLs_opt = fit_12_mcmc_PA_Aps_LLs_opt,
  #       fit_13_mcmc_PA_Ap_LDs_opt_= fit_13_mcmc_PA_Ap_LDs_opt,
  #       fit_14_mcmc_PA_Aps_LDp_opt = fit_14_mcmc_PA_Aps_LDps_opt,
  #       fit_15_mcmc_PA_Ap_LDps_opt = fit_15_mcmc_PA_Ap_LDps_opt,
  #       fit_16_mcmc_PA_Aps_LDs_opt = fit_16_mcmc_PA_Aps_LDs_opt,
  #       fit_17_mcmc_GL_LMA    = fit_17_mcmc_GL_LMA,
  #       fit_18_mcmc_PA_LMA    = fit_18_mcmc_PA_LMA,
  #       fit_19_mcmc_PA_LMA_opt = fit_19_mcmc_PA_LMA_opt
  #       ),
