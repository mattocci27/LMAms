...
PAb <- lm(log(Aarea) ~ log(LMA), PA)$coefficients[2]
...
mean_PA <- apply(b_PA, 1, mean)
upr_PA <- apply(b_PA, 1, \(x)(quantile(x, 0.975)))
lwr_PA <- apply(b_PA, 1, \(x)(quantile(x, 0.025)))
