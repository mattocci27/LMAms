---
title: Panama results using normal distribution (Kikuzawa model)
...
\begin{align}
  ...
  &E[\mathrm{LL}_{i}] = \beta_{0} A_{\mathrm{area} \; i}^{\beta_p \theta} (\mathrm{LMAs}_i/\mathrm{LT}_i)^{\beta_s} \\
...
load("./data/PA_LMAm_LMAsLT6_obs.rda")
