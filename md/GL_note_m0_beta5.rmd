...
temp_LMAp <- rstan::extract(res, "log_LMAp")[[1]] %>% exp
temp_LMAs <- rstan::extract(res, "log_LMAs")[[1]] %>% exp
...
par(mfrow = c(1,2))
apply(log_LMAp, 1, function(x)cor(x, log(GL$Aarea))) %>% hist(main = "LMAp vs Aarea, R")
apply(log_LMAs, 1, function(x)cor(x, log(GL$Aarea))) %>% hist(main = "LMAs vs Aarea, R")
apply(log_LMAp, 1, function(x)cor(x, log(GL$Rarea))) %>% hist(main = "LMAp vs Rarea, R")
apply(log_LMAs, 1, function(x)cor(x, log(GL$Rarea))) %>% hist(main = "LMAs vs Rarea, R")
apply(log_LMAp, 1, function(x)cor(x, log(GL$LL))) %>% hist(main = "LMAp vs LL, R")
apply(log_LMAs, 1, function(x)cor(x, log(GL$LL))) %>% hist(main = "LMAs vs LL, R")
