...
load("../data/GL_m0_z_obs.rda")
#load("./data/PA_LMAm_LMAsLT2_obs.rda")
#summary_GL_LDL <- data.frame(summary(res)$summary)

#load("./data/GL_m0_beta3_obs.rda")

pairs(res, pars = c("beta[1]", "beta[2]", "lp__"))
traceplot(res, pars = c("beta[1]", "beta[2]", "lp__"))
#traceplot(res, pars = c("alpha1[1]", "alpha1[2]", "alpha1[3]","lp__"))
#traceplot(res, pars = c("tau[1]", "tau[2]", "tau[3]", "lp__"))
#traceplot(res, pars = c("mu_z[1]", "mu_z[2]", "mu_z[3]", "lp__"))
