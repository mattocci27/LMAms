---
title: GLOPNET results using MVN 
...
\begin{align}
  ...
  &E[\mathrm{LL}_{i}] = \beta_{0} A_{\mathrm{area} \; i}^{\beta_p} \mathrm{LMAs}_i^{\beta_s} \\
...
GL <- GL %>%
  mutate(pareto_K = moge$diagnostics[[1]])
...
# Posterior distributions of $\beta_p$ ~= 0
